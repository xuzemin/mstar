...
* Class : device_tuner
* File  : device_tuner_sony_sut_pex41_tsb.h
**********************************************************************/
/*@ <IncludeGuard> @*/
#ifndef device_tuner_sony_sut_pex41_H
#define device_tuner_sony_sut_pex41_H
/*@ </IncludeGuard> @*/
#ifdef device_tuner_sony_sut_pex41_H
#define INTERFACE
#else
#define INTERFACE extern
#endif
// [21:0], CR_RATE for 7.0 MHz, HEX((xxx/43.2) * (2^22))
// Ex. IFP = 7M, reg = (7.0/43.2)*pow(2,22)
// INVERT, picture carrier pos, high side:0, low side:1
#define VIF_TUNER_TYPE                  1                   // 0: RF Tuner; 1: Silicon Tuner

 // IFP_ANALOG_BG       7300 
#define VIF_CR_RATE_B                   0x000AD098 
#define VIF_CR_INVERT_B                 0
#define VIF_CR_RATE_GH                  0x000AD098 
#define VIF_CR_INVERT_GH                0
// IFP_ANALOG_IDK      7850
#define VIF_CR_RATE_DK                  0x000BA12F 
#define VIF_CR_INVERT_DK                0             
#define VIF_CR_RATE_I                   0x000BA12F 
#define VIF_CR_INVERT_I                 0 
// IFP_ANALOG_L        7850
#define VIF_CR_RATE_L                   0x000BA12F 
#define VIF_CR_INVERT_L                 0
// IFP_ANALOG_L_DASH   2200
#define VIF_CR_RATE_LL                  0x0003425F 
#define VIF_CR_INVERT_LL                1
// IFP_ANALOG_M        5750
#define VIF_CR_RATE_MN                  0x000884BE 
#define VIF_CR_INVERT_MN                0

#define VHF_LOWMIN_FREQ        43000L    // KHz
#define VHF_LOWMAX_FREQ        147250L    // KHz
#define VHF_HIGHMIN_FREQ    154250L    // KHz
#define VHF_HIGHMAX_FREQ    431250L    // KHz
...
#define TUNER_DTV_IQ_SWAP 1
#define TUNER_VIF_TAGC_ODMODE 2  // IF AGC OD MODE
#define TUNER_DVB_IF_AGC_MODE 1
...
INTERFACE BOOL MDrv_DVBS_Tuner_SetFreq(MS_U16 u16CenterFreq_MHz, MS_U32 u32SymbolRate_Ms);
INTERFACE BOOL MDrv_DVBS_Tuner_Initial(void);
INTERFACE BOOL MDrv_DVBS_Tuner_CheckLock(void);
