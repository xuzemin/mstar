...
#ifndef __PNL_BOE190WG01_WXGA
#define __PNL_BOE190WG01_WXGA

///////////////////////////////////////////////
// Common setting
///////////////////////////////////////////////
#define PANEL_NAME              "BOE 190WG1-101 WXGA"
#define PANEL_DOT_WIDTH         283     // unit: um
#define PANEL_DOT_HEIGHT        283     // unit: um
...
#define PANEL_ON_TIMING1        50  // time between panel & data while turn on power
#define PANEL_ON_TIMING2        250 // time between data & back light while turn on power
#define PANEL_OFF_TIMING1       250 // time between back light & data while turn off power
#define PANEL_OFF_TIMING2       50  // time between data & panel while turn off power

#define PANEL_HSYNC_WIDTH         30//104
#define PANEL_HSYNC_BACK_PORCH    50//24

#define PANEL_VSYNC_WIDTH        4
#define PANEL_VSYNC_BACK_PORCH   6
...
#define PANEL_HTOTAL             1600
#define PANEL_VTOTAL             926

#define PANEL_MAX_HTOTAL         2800
#define PANEL_MIN_HTOTAL         1504
#define PANEL_MAX_VTOTAL         1050
#define PANEL_MIN_VTOTAL         904

#define PANEL_DCLK              (((DWORD)PANEL_HTOTAL*PANEL_VTOTAL*60)/1000000)
#define PANEL_MAX_DCLK          130
#define PANEL_MIN_DCLK          83

#define PANEL_OUT_VFREQ_MIN     56  // min.
#define PANEL_OUT_VFREQ_TYPICAL 60  // typical
#define PANEL_OUT_VFREQ_MAX     76  // max.
