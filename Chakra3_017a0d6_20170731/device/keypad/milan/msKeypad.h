...
#define REG_SAR1_UPB                    (RIUBASE_PM_SAR + 0x05*2)
#define REG_SAR1_LOB                    (RIUBASE_PM_SAR + 0x05*2 + 1)
#define REG_SAR2_UPB                    (RIUBASE_PM_SAR + 0x06*2)
#define REG_SAR2_LOB                    (RIUBASE_PM_SAR + 0x06*2 + 1)
#define REG_SAR3_UPB                    (RIUBASE_PM_SAR + 0x07*2)
#define REG_SAR3_LOB                    (RIUBASE_PM_SAR + 0x07*2 + 1)
#define REG_SAR4_UPB                    (RIUBASE_PM_SAR + 0x08*2)
#define REG_SAR4_LOB                    (RIUBASE_PM_SAR + 0x08*2 + 1)
#define REG_SAR5_UPB                    (RIUBASE_PM_SAR + 0x09*2)
#define REG_SAR5_LOB                    (RIUBASE_PM_SAR + 0x09*2 + 1)
#define REG_SAR6_UPB                    (RIUBASE_PM_SAR + 0x0A*2)
#define REG_SAR6_LOB                    (RIUBASE_PM_SAR + 0x0A*2 + 1)
#define REG_SAR7_UPB                    (RIUBASE_PM_SAR + 0x0B*2)
#define REG_SAR7_LOB                    (RIUBASE_PM_SAR + 0x0B*2 + 1)
#define REG_SAR8_UPB                    (RIUBASE_PM_SAR + 0x0C*2)
#define REG_SAR8_LOB                    (RIUBASE_PM_SAR + 0x0C*2 + 1)
#define REG_SAR_ADCOUT1                 (RIUBASE_PM_SAR + 0x0D*2)
#define REG_SAR_ADCOUT2                 (RIUBASE_PM_SAR + 0x0D*2 + 1)
#define REG_SAR_ADCOUT3                 (RIUBASE_PM_SAR + 0x0E*2)
#define REG_SAR_ADCOUT4                 (RIUBASE_PM_SAR + 0x0E*2 + 1)
#define REG_SAR_ADCOUT5                 (RIUBASE_PM_SAR + 0x0F*2)
#define REG_SAR_ADCOUT6                 (RIUBASE_PM_SAR + 0x0F*2 + 1)
#define REG_SAR_ADCOUT7                 (RIUBASE_PM_SAR + 0x10*2)
#define REG_SAR_ADCOUT8                 (RIUBASE_PM_SAR + 0x10*2 + 1)
