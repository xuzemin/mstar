...
/// Panel lvds swing output ch
typedef enum
{
    E_APIPNL_OUTPUT_SWING_CH0 = 0,     ///
    E_APIPNL_OUTPUT_SWING_CH1,         ///LVB0
    E_APIPNL_OUTPUT_SWING_CH2,         ///LVB1
    E_APIPNL_OUTPUT_SWING_CH3,         ///LVB2
    E_APIPNL_OUTPUT_SWING_CH4,         ///
    E_APIPNL_OUTPUT_SWING_CH5,         ///LVB3
    E_APIPNL_OUTPUT_SWING_CH6,         ///
    E_APIPNL_OUTPUT_SWING_CH7,         ///LVA0
    E_APIPNL_OUTPUT_SWING_CH8,         ///LVA1
    E_APIPNL_OUTPUT_SWING_CH9,         ///LVA2
    E_APIPNL_OUTPUT_SWING_CH10,        ///LVACLK
    E_APIPNL_OUTPUT_SWING_CH11,        ///LVA3
    E_APIPNL_OUTPUT_SWING_CH12,        ///
    E_APIPNL_OUTPUT_SWING_CH13         ///
} APIPNL_OUTPUT_CH;
...
// MOD Ch Output  should between CH0~CH13
DLL_PUBLIC MS_BOOL MApi_PNL_Control_Ch_Out_Swing(APIPNL_OUTPUT_CH u8Swing_Ch,MS_U16 u16Swing_Level);
...
DLL_PUBLIC MS_U32 MApi_PNL_GetMiscStatus(void);
DLL_PUBLIC void MApi_PNL_MOD_OutputConfig_User(MS_U32 u32OutputCFG0_7, MS_U32 u32OutputCFG8_15, MS_U32 u32OutputCFG16_21);
DLL_PUBLIC APIPNL_Result MApi_PNL_PreSetModeOn(MS_BOOL bSetModeOn);
DLL_PUBLIC void MApi_PNL_MOD_OutputChannelOrder(MS_U8  u8OutputOrderType,
...
//-------------------------------------------------------------------------------------------------
/// Get HDE and VDE dummy line
//-------------------------------------------------------------------------------------------------
void MApi_PNL_TCON_GetDummyData(MS_U8 *u8HDE_Head, MS_U8 *u8HDE_Tail,MS_U8 *u8VDE_Head,MS_U8 *u8VDE_Tail);

//-------------------------------------------------------------------------------------------------
/// Set HDE and VDE dummy line
//-------------------------------------------------------------------------------------------------
MS_BOOL MApi_PNL_TCON_SetDummyData(MS_U8 u8HDE_Head, MS_U8 u8HDE_Tail,MS_U8 u8VDE_Head,MS_U8 u8VDE_Tail);
