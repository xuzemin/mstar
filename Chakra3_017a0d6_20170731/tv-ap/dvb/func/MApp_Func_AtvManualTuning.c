...
FUNC_ATV_MANUAL_TUNING_PAGE_STATUS MApp_FuncExec_AtvManualTuningPage(FUNC_ATV_MANUAL_TUNING_PAGE_TYPE func, void *para1)
{

    FUNC_ATV_MANUAL_TUNING_PAGE_STATUS enResult = EN_FUNC_ATV_MANUAL_TUNING_STATUS_FAIL;

    switch(func)
    {
        case EN_FUNC_ATV_MANUAL_TUNING_GET_VIDEO_STANDARD:
            {
                U16 *u16VideoStandard = (U16 *) para1;
                *u16VideoStandard = (U16) msAPI_AVD_GetVideoStandard();
                enResult = EN_FUNC_ATV_MANUAL_TUNING_STATUS_OK;
            }
            break;

        case EN_FUNC_ATV_MANUAL_TUNING_GET_USER_VIDEO_STANDARD:
            {
                U16 *u16VideoStandard = (U16 *) para1;
                ...
                {
                    *u16VideoStandard = EN_ATV_VideoStandard_AUTO;
                }
                else
                {
                    *u16VideoStandard = (EN_ATV_VIDEOSTANDARD_TYPE)(eAtvVideoStandardType);
                }
                enResult = EN_FUNC_ATV_MANUAL_TUNING_STATUS_OK;
            }
            break;

        case EN_FUNC_ATV_MANUAL_TUNING_SET_USER_VIDEO_STANDARD:
            {
                U16 u16VideoStandard = *((U16 *) para1);
                BYTE u8ChNum = msAPI_ATV_GetCurrentProgramNumber();
        ...
        case EN_FUNC_ATV_MANUAL_TUNING_SET_USER_VIDEO_STANDARD_BY_MAP:
            {
                U16 u16VideoStandard = *((U16 *) para1);
                BYTE u8ChNum = msAPI_ATV_GetCurrentProgramNumber();
                AVD_VideoStandardType eUserStd;
