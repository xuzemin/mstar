#ifndef _LED_PQ_CSOT_49INCH_DIRECT_60_C_
#define _LED_PQ_CSOT_49INCH_DIRECT_60_C_

#include "compen/Tbl_LD_Compensation_Gamma22.c"
#include "edge2d/Tbl_LD_Edge2D_CSOT49inch_Direct60.c"
#include "gamma/Tbl_LD_Gamma_CSOT49inch_Direct60.c"

StuDrvLdPQInfo s_DrvLdPQInfo_CSOT49 =
{
    ...
    Tbl_LD_Edge2D_CSOT49inch_Direct60, // const U8* pu8Edge2DTable; // Edge2D table  SIZE=(u8LEDWidth*u8LEDHeight)*(u8LDFWidth*u8LDFHeight)
