...
#define DTMB_TUNER_IF_FREQ_KHz                5000L //5000L
#define TN_FREQ_STEP                          FREQ_STEP_50KHz


#define QAM_6M     DTV_TUNER_IF_FREQ_KHz
#define QAM_8M     DTV_TUNER_IF_FREQ_KHz
#define ATSC_6M    DTV_TUNER_IF_FREQ_KHz
#define ISDBT_6M   DTV_TUNER_IF_FREQ_KHz
#define DVBT_1p7M  DTV_TUNER_IF_FREQ_KHz
#define DVBT_6M    DTV_TUNER_IF_FREQ_KHz
#define DVBT_7M    DTV_TUNER_IF_FREQ_KHz
#define DVBT_8M    DTV_TUNER_IF_FREQ_KHz
#define DVBT_10M   DTV_TUNER_IF_FREQ_KHz
#define DMBT_8M    DTMB_TUNER_IF_FREQ_KHz

// Analog picture carrier
#define ATV_TUNER_IF_FREQ_KHz  5000L
#define ATV_CENTER_P_SHIFT_B  2250 /*KHZ*/
#define ATV_CENTER_P_SHIFT_G  2750 /*KHZ*/
#define ATV_CENTER_P_SHIFT_DK 2750 /*KHZ*/
#define ATV_CENTER_P_SHIFT_I  2750 /*KHZ*/
#define ATV_CENTER_P_SHIFT_L  2750 /*KHZ*/
#define ATV_CENTER_P_SHIFT_M  1750 /*KHZ*/
#define ATV_CENTER_P_SHIFT_L1 2750 /*KHZ*/

#define ATV_VC_MN  (ATV_TUNER_IF_FREQ_KHz+ATV_CENTER_P_SHIFT_M)
#define ATV_VC_B   (ATV_TUNER_IF_FREQ_KHz+ATV_CENTER_P_SHIFT_B)
#define ATV_VC_GH  (ATV_TUNER_IF_FREQ_KHz+ATV_CENTER_P_SHIFT_G)
#define ATV_VC_I   (ATV_TUNER_IF_FREQ_KHz+ATV_CENTER_P_SHIFT_I)
#define ATV_VC_DK  (ATV_TUNER_IF_FREQ_KHz+ATV_CENTER_P_SHIFT_DK)
#define ATV_VC_L   (ATV_TUNER_IF_FREQ_KHz+ATV_CENTER_P_SHIFT_L)
#define ATV_VC_LL  (ATV_TUNER_IF_FREQ_KHz+ATV_CENTER_P_SHIFT_L1)
...
INTERFACE BOOLEAN mdev_GetSignalStrength(float* s16_strength);
#if ENABLE_MxL661_GPO
INTERFACE void MxL661_AMPMuteByConfigDevGPO(BOOLEAN bEnable);
#endif
