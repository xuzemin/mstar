...
INTERFACE void msAPI_XC_EnableMirrorMode(BOOL bEnableMirror);
...
INTERFACE void msAPI_Picture_CalculateAFDWindow(XC_SETWIN_INFO *pstXC_SetWin_Info,
...
INTERFACE void MApp_Image_SetMirror(void);
INTERFACE BOOLEAN MApp_Image_GetMirror(void);
//INTERFACE BOOLEAN MApp_SetFactoryImageMirror(void);  //same as MApp_SetDesignImageMirror
INTERFACE BOOLEAN MApp_SetDesignImageMirror(void);
