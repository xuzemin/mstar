...
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern void MDrv_AVD_MCUFreeze(MS_BOOL bEnable);
////////////////////////////////////////////////////////////////////////////////
/// Should be called when exit VD input source
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern void MDrv_AVD_Exit(void);
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern AVD_Result MDrv_AVD_Init(VD_INITDATA *pVD_InitData, MS_U32 u32InitDataLen);
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern MS_BOOL MDrv_AVD_McuReset(void);
////////////////////////////////////////////////////////////////////////////////
...
/// VD_STATUS_RDY                   (BIT(0))\n
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern MS_U16 MDrv_AVD_GetStatus(void);
//-------------------------------------------------------------------------------------------------
/// Get AVD driver version
/// when get ok, return the pointer to the driver version
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC extern AVD_Result MDrv_AVD_GetLibVer(const MSIF_Version **ppVersion);
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
DLL_PUBLIC extern MS_BOOL MDrv_AVD_SetDbgLevel(AVD_DbgLv u8DbgLevel);
//-------------------------------------------------------------------------------------------------
/// Get the information of AVD\n
/// @return the pointer to the driver information
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC extern const AVD_Info* MDrv_AVD_GetInfo(void);
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern MS_BOOL MDrv_AVD_IsSyncLocked(void);
...
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern MS_U16 MDrv_AVD_Scan_HsyncCheck(MS_U8 u8HtotalTolerance); //TODO should add delay between register read
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern MS_BOOL MDrv_AVD_IsSignalInterlaced(void);
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern MS_BOOL MDrv_AVD_IsColorOn(void);
...
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern AVD_VideoFreq MDrv_AVD_GetVerticalFreq(void);
////////////////////////////////////////////////////////////////////////////////
/// To get the total number of Vsync in one video frame.\n
/// MS_U16      : the total number of Vsync.
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern MS_U16 MDrv_AVD_GetVTotal(void);
////////////////////////////////////////////////////////////////////////////////
/// Get signal noise level
/// MS_U8      : noise level
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern MS_U8 MDrv_AVD_GetNoiseMag(void);
////////////////////////////////////////////////////////////////////////////////
/// To set input source.\n
...
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern MS_BOOL MDrv_AVD_SetInput(AVD_InputSourceType eSource, MS_U8 u8ScartFB);
////////////////////////////////////////////////////////////////////////////////
...
/// return TRUE on sucess, FALSE if failed
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern MS_BOOL MDrv_AVD_SetVideoStandard(AVD_VideoStandardType eStandard, MS_BOOL bIsInAutoTuning);
////////////////////////////////////////////////////////////////////////////////
/// VD has two modes to detect video standard, auto and force.\n
//   Using this function to enable auto detection.
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern void MDrv_AVD_StartAutoStandardDetection(void);
#if 0 // BY 20090403 unused function
...
/// return TRUE on sucess, FALSE if failed
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern MS_BOOL MDrv_AVD_ForceVideoStandard(AVD_VideoStandardType eVideoStandardType);
...
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern AVD_VideoStandardType MDrv_AVD_GetStandardDetection(MS_U16 *u16LatchStatus);
...
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern AVD_VideoStandardType MDrv_AVD_GetLastDetectedStandard(void);
#if 0 // BY 20090403 unused function
...
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern void MDrv_AVD_Set3dComb(MS_BOOL bEnable);
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern void MDrv_AVD_3DCombSpeedup(void);
////////////////////////////////////////////////////////////////////////////////
/// To set free run PLL of COMB filter.\n
/// eVideoFreq  : E_VIDEO_FQ_60Hz or E_VIDEO_FQ_50Hz
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern void MDrv_AVD_SetFreerunPLL(AVD_VideoFreq eVideoFreq);// 060508 chris
////////////////////////////////////////////////////////////////////////////////
/// To set free run vertical total lines.\n
/// eVideoFreq  : E_FREERUN_FQ_AUTO, E_FREERUN_FQ_50Hz or E_FREERUN_FQ_60Hz
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern void MDrv_AVD_SetFreerunFreq(AVD_FreeRunFreq eFreerunfreq);
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern void MDrv_AVD_SetRegFromDSP(void);
////////////////////////////////////////////////////////////////////////////////
/// Set function enable/disable Flag.\n
/// u32VDPatchFlag : Patch ID.
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern void MDrv_AVD_SetFlag(MS_U32  u32VDPatchFlag);
////////////////////////////////////////////////////////////////////////////////
/// Get function enable/disable Flag.\n
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern MS_U32 MDrv_AVD_GetFlag(void);
////////////////////////////////////////////////////////////////////////////////
/// Set VD Htotal.\n
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern void MDrv_AVD_Set_Htt_UserMD(MS_U16 u16Htt);
////////////////////////////////////////////////////////////////////////////////
/// Using this function to inform video decoder system is changing channel, video decoder will reset AGC and etc.
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern void MDrv_AVD_SetChannelChange(void);
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern void MDrv_AVD_SetHsyncDetectionForTuning(MS_BOOL bEnable);
...
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern void MDrv_AVD_SetRegValue(MS_U16 u16Addr,MS_U8 u8Value);
////////////////////////////////////////////////////////////////////////////////
/// To get AFEC's register  value, only for special purpose.\n
/// u16Addr       : the address of AFEC's register\n
/// return the value of AFEC's register\n
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern MS_U8 MDrv_AVD_GetRegValue(MS_U16 u16Addr);
...
/// len       : code length\n
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern void MDrv_AVD_LoadDSP(MS_U8 *pu8VD_DSP, MS_U32 len);

////////////////////////////////////////////////////////////////////////////////
/// To set vd registers after setting PQ table is finished.\n
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern void MDrv_AVD_SetPQFineTune(void);
DLL_PUBLIC extern void MDrv_AVD_Set3dCombSpeed(MS_U8 u8COMB57, MS_U8 u8COMB58);
DLL_PUBLIC extern void MDrv_AVD_GetCaptureWindow(void *stCapWin, AVD_VideoStandardType eVideoStandardType);
DLL_PUBLIC extern MS_U8 MDrv_AVD_MBX_ReadByteByVDMbox(MS_U8 u8Addr);
DLL_PUBLIC extern MS_U8 MDrv_AVD_GetHsyncEdge(void);
DLL_PUBLIC extern void MDrv_AVD_SetStillImageParam(AVD_Still_Image_Param param);
DLL_PUBLIC extern void MDrv_AVD_SetAFECD4Factory(MS_U8 u8Value);
DLL_PUBLIC extern void MDrv_AVD_Set2D3DPatchOnOff(MS_BOOL bEnable);
DLL_PUBLIC extern void MDrv_AVD_BackPorchWindowPositon(MS_BOOL bEnable , MS_U8 u8Value);
DLL_PUBLIC extern void MDrv_AVD_SetFactoryPara(AVD_Factory_Para FactoryPara,MS_U8 u8Value);
DLL_PUBLIC extern MS_U8 MDrv_AVD_SetAutoFineGainToFixed(void);
DLL_PUBLIC extern MS_U8 MDrv_AVD_GetDSPFineGain(void);
DLL_PUBLIC extern MS_U16 MDrv_AVD_GetDSPVersion(void);
DLL_PUBLIC extern void MDrv_AVD_ShiftClk(AVD_ATV_CLK_TYPE eShiftMode);
DLL_PUBLIC extern void MDrv_AVD_SetShiftClk(MS_BOOL bEnable,AVD_ATV_CLK_TYPE eShiftMode);
DLL_PUBLIC extern void MDrv_AVD_ShifClk_Monitor(void);
DLL_PUBLIC extern void MDrv_AVD_SCART_Monitor(void);
