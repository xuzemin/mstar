...
#include "ZUI_CHANNEL_INFO_ATSC_tables_c.inl"
#include "ZUI_CHANNEL_INFO_ATSC_alphatable_c.inl"
...
#include "ZUI_INSTALL_GUIDE_ATSC_tables_c.inl"
#include "ZUI_INSTALL_GUIDE_ATSC_alphatable_c.inl"
...
#include "ZUI_UPGRADE_tables_c.inl"
#include "ZUI_UPGRADE_alphatable_c.inl"
#include "ZUI_MENU_DISHSETUP_tables_c.inl"
#include "ZUI_MENU_DISHSETUP_alphatable_c.inl"
#include "ZUI_EPOP_tables_c.inl"
#include "ZUI_EPOP_alphatable_c.inl"
#include "ZUI_DESIGN_MENU_tables_c.inl"
#include "ZUI_DESIGN_MENU_alphatable_c.inl"
#include "ZUI_KEYSTONE_ANGLE_tables_c.inl"
#include "ZUI_KEYSTONE_ANGLE_alphatable_c.inl"
#include "ZUI_TEMP_DET_tables_c.inl"
#include "ZUI_TEMP_DET_alphatable_c.inl"
#include "ZUI_BAT_LOW_tables_c.inl"
#include "ZUI_BAT_LOW_alphatable_c.inl"
#include "ZUI_TEMP_OVERTOP_tables_c.inl"
#include "ZUI_TEMP_OVERTOP_alphatable_c.inl"
...
OSDPAGETABLE code OsdTables [] =
{
    ...
    {HWND_SCREEN_SAVER_MAX, _GUI_WindowList_Zui_Screen_Saver,
         ...
         CLRKEY_LO_R, CLRKEY_LO_G, CLRKEY_LO_B, CLRKEY_HI_R, CLRKEY_HI_G, CLRKEY_HI_B,
         0 },
    {HWND_CHANNEL_INFO_ATSC_MAX, _GUI_WindowList_Zui_Channel_Info_Atsc,
         //_GUI_WindowsDrawStyleList_Zui_Channel_Info_Atsc,
         _GUI_WindowsAlphaList_Zui_Channel_Info_Atsc,
         NULL,
         E_OSD_GWIN0, ZUI_CHANNEL_INFO_ATSC_XSTART, ZUI_CHANNEL_INFO_ATSC_YSTART, ZUI_CHANNEL_INFO_ATSC_WIDTH, ZUI_CHANNEL_INFO_ATSC_HEIGHT, 0, 56, 1,
         CLRKEY_LO_R, CLRKEY_LO_G, CLRKEY_LO_B, CLRKEY_HI_R, CLRKEY_HI_G, CLRKEY_HI_B,
         0 },
    ...
    {HWND_SUBTITLE_LANGUAGE_MAX, _GUI_WindowList_Zui_Subtitle_Language,
         ...
         CLRKEY_LO_R, CLRKEY_LO_G, CLRKEY_LO_B, CLRKEY_HI_R, CLRKEY_HI_G, CLRKEY_HI_B,
         0 },
    {HWND_INSTALL_GUIDE_ATSC_MAX, _GUI_WindowList_Zui_Install_Guide_Atsc,
         //_GUI_WindowsDrawStyleList_Zui_Install_Guide_Atsc,
         _GUI_WindowsAlphaList_Zui_Install_Guide_Atsc,
         NULL,
         E_OSD_GWIN0, ZUI_INSTALL_GUIDE_ATSC_XSTART, ZUI_INSTALL_GUIDE_ATSC_YSTART, ZUI_INSTALL_GUIDE_ATSC_WIDTH, ZUI_INSTALL_GUIDE_ATSC_HEIGHT, 0, 15, 1,
         CLRKEY_LO_R, CLRKEY_LO_G, CLRKEY_LO_B, CLRKEY_HI_R, CLRKEY_HI_G, CLRKEY_HI_B,
         0 },
    ...
    {HWND_EXPERT_MENU_MAX, _GUI_WindowList_Zui_Expert_Menu,
         ...
         CLRKEY_LO_R, CLRKEY_LO_G, CLRKEY_LO_B, CLRKEY_HI_R, CLRKEY_HI_G, CLRKEY_HI_B,
         0 },
    {HWND_UPGRADE_MAX, _GUI_WindowList_Zui_Upgrade,
         //_GUI_WindowsDrawStyleList_Zui_Upgrade,
         _GUI_WindowsAlphaList_Zui_Upgrade,
         NULL,
         E_OSD_GWIN0, ZUI_UPGRADE_XSTART, ZUI_UPGRADE_YSTART, ZUI_UPGRADE_WIDTH, ZUI_UPGRADE_HEIGHT, 0, 63, 1,
         CLRKEY_LO_R, CLRKEY_LO_G, CLRKEY_LO_B, CLRKEY_HI_R, CLRKEY_HI_G, CLRKEY_HI_B,
         0 },
    {HWND_MENU_DISHSETUP_MAX, _GUI_WindowList_Zui_Menu_Dishsetup,
         //_GUI_WindowsDrawStyleList_Zui_Menu_Dishsetup,
         _GUI_WindowsAlphaList_Zui_Menu_Dishsetup,
         NULL,
         E_OSD_GWIN0, ZUI_MENU_DISHSETUP_XSTART, ZUI_MENU_DISHSETUP_YSTART, ZUI_MENU_DISHSETUP_WIDTH, ZUI_MENU_DISHSETUP_HEIGHT, 0, 63, 1,
         CLRKEY_LO_R, CLRKEY_LO_G, CLRKEY_LO_B, CLRKEY_HI_R, CLRKEY_HI_G, CLRKEY_HI_B,
         0 },
    {HWND_EPOP_MAX, _GUI_WindowList_Zui_Epop,
         //_GUI_WindowsDrawStyleList_Zui_Epop,
         _GUI_WindowsAlphaList_Zui_Epop,
         NULL,
         E_OSD_GWIN0, ZUI_EPOP_XSTART, ZUI_EPOP_YSTART, ZUI_EPOP_WIDTH, ZUI_EPOP_HEIGHT, 0, 63, 1,
         CLRKEY_LO_R, CLRKEY_LO_G, CLRKEY_LO_B, CLRKEY_HI_R, CLRKEY_HI_G, CLRKEY_HI_B,
         0 },
    {HWND_DESIGN_MENU_MAX, _GUI_WindowList_Zui_Design_Menu,
         ...
         CLRKEY_LO_R, CLRKEY_LO_G, CLRKEY_LO_B, CLRKEY_HI_R, CLRKEY_HI_G, CLRKEY_HI_B,
         0 },
    {HWND_KEYSTONE_ANGLE_MAX, _GUI_WindowList_Zui_Keystone_Angle,
         //_GUI_WindowsDrawStyleList_Zui_Keystone_Angle,
         _GUI_WindowsAlphaList_Zui_Keystone_Angle,
         NULL,
         E_OSD_GWIN0, ZUI_KEYSTONE_ANGLE_XSTART, ZUI_KEYSTONE_ANGLE_YSTART, ZUI_KEYSTONE_ANGLE_WIDTH, ZUI_KEYSTONE_ANGLE_HEIGHT, 0, 63, 1,
         CLRKEY_LO_R, CLRKEY_LO_G, CLRKEY_LO_B, CLRKEY_HI_R, CLRKEY_HI_G, CLRKEY_HI_B,
         0 },
    {HWND_TEMP_DET_MAX, _GUI_WindowList_Zui_Temp_Det,
         //_GUI_WindowsDrawStyleList_Zui_Temp_Det,
         _GUI_WindowsAlphaList_Zui_Temp_Det,
         NULL,
         E_OSD_GWIN0, ZUI_TEMP_DET_XSTART, ZUI_TEMP_DET_YSTART, ZUI_TEMP_DET_WIDTH, ZUI_TEMP_DET_HEIGHT, 1, 63, 1,
         CLRKEY_LO_R, CLRKEY_LO_G, CLRKEY_LO_B, CLRKEY_HI_R, CLRKEY_HI_G, CLRKEY_HI_B,
         0 },
    {HWND_BAT_LOW_MAX, _GUI_WindowList_Zui_Bat_Low,
         //_GUI_WindowsDrawStyleList_Zui_Bat_Low,
         _GUI_WindowsAlphaList_Zui_Bat_Low,
         NULL,
         E_OSD_GWIN0, ZUI_BAT_LOW_XSTART, ZUI_BAT_LOW_YSTART, ZUI_BAT_LOW_WIDTH, ZUI_BAT_LOW_HEIGHT, 1, 63, 1,
         CLRKEY_LO_R, CLRKEY_LO_G, CLRKEY_LO_B, CLRKEY_HI_R, CLRKEY_HI_G, CLRKEY_HI_B,
         0 },
    {HWND_TEMP_OVERTOP_MAX, _GUI_WindowList_Zui_Temp_Overtop,
         //_GUI_WindowsDrawStyleList_Zui_Temp_Overtop,
         _GUI_WindowsAlphaList_Zui_Temp_Overtop,
         NULL,
         E_OSD_GWIN0, ZUI_TEMP_OVERTOP_XSTART, ZUI_TEMP_OVERTOP_YSTART, ZUI_TEMP_OVERTOP_WIDTH, ZUI_TEMP_OVERTOP_HEIGHT, 1, 63, 1,
         CLRKEY_LO_R, CLRKEY_LO_G, CLRKEY_LO_B, CLRKEY_HI_R, CLRKEY_HI_G, CLRKEY_HI_B,
         0 },
};
