...
typedef enum
{
	...
	INPUT_SOURCE_VGA2,          ///<41   VGA2 input
    INPUT_SOURCE_VGA3,          ///<42   VGA3 input
...
typedef enum
{
    ...
    E_XC_SUPPORT_DETECT3D_REGIONAL = 0x00002000, ///< return if support regional display window detect
}E_XC_CAPS;
...
typedef struct
{
    ...
    MS_U8 u8HDE_HeadDummy;
    MS_U8 u8HDE_TailDummy;
    MS_U8 u8VDE_HeadDummy;
    MS_U8 u8VDE_TailDummy;
} XC_PANEL_INFO;
...
typedef enum
{
    ...
    #if 1//fix compiling error (check for Macan)
    ...
    #if 0//fix compiling error (port from Macan)
...
/// @param  pstXC_VboxInfo     \b IN: get vbox info
/// @return E_APIXC_RET_OK or E_APIXC_RET_FAIL
//-------------------------------------------------------------------------------------------------
