...
typedef enum
{
    ...
    E_MVOP_CMD_SET_SEL_OP_FIELD,          ////<0x11C  Set mvop output filed (new for sub).
    E_MVOP_CMD_SET_SIZE_FROM_MVD,         ////<0x11D  Set mvop output h/w size from vdec (new for sub).
    E_MVOP_CMD_SET_CROP_START_POS,        ////<0x11E Set mvop crop start x/y (new for sub).
    E_MVOP_CMD_SET_IMAGE_WIDTH_HEIGHT,    ////<0x11F Set mvop crop  x/y size (new for sub).
    E_MVOP_CMD_SET_INV_OP_VS,             ////<0x120 Set mvop vsync inverse (new for sub).
    E_MVOP_CMD_SET_FORCE_TOP,             ////<0x121 Set mvop OP only top field (new for sub).
