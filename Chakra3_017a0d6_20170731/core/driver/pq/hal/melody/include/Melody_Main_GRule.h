...
typedef enum
{
    ...
    PQ_GRule_NR_Low_32_Main,
    PQ_GRule_NR_Middle_32_Main,
    PQ_GRule_NR_High_32_Main,
}
...
typedef enum
{
    ...
    PQ_GRule_OSD_BW_On_32_1920_Main,
    PQ_GRule_OSD_BW_On_32_1366_Main,
}
...
typedef enum
{
    ...
    PQ_GRule_Lvl_NR_Low_PIP_Main,
    PQ_GRule_Lvl_NR_Middle_PIP_Main,
    PQ_GRule_Lvl_NR_High_PIP_Main,
...
#define PQ_GRULE_NR_NUM_Main 19
...
#endif
#if PQ_GRULE_COLOR_FOR_VIVID_ENABLE
extern code U8 MST_GRule_1920_PIP_COLOR_FOR_VIVID_Main[PQ_GRULE_COLOR_FOR_VIVID_LVL_NUM_Main];
#endif
#if PQ_GRULE_PTP_ENABLE
...
#endif
#if PQ_GRULE_COLOR_FOR_VIVID_ENABLE
extern code U8 MST_GRule_1920_POP_COLOR_FOR_VIVID_Main[PQ_GRULE_COLOR_FOR_VIVID_LVL_NUM_Main];
#endif
#if PQ_GRULE_PTP_ENABLE
...
#endif
#if PQ_GRULE_COLOR_FOR_VIVID_ENABLE
extern code U8 MST_GRule_1366_PIP_COLOR_FOR_VIVID_Main[PQ_GRULE_COLOR_FOR_VIVID_LVL_NUM_Main];
#endif
#if PQ_GRULE_PTP_ENABLE
...
#endif
#if PQ_GRULE_COLOR_FOR_VIVID_ENABLE
extern code U8 MST_GRule_1366_POP_COLOR_FOR_VIVID_Main[PQ_GRULE_COLOR_FOR_VIVID_LVL_NUM_Main];
#endif
#if PQ_GRULE_PTP_ENABLE
...
#if PQ_GRULE_NR_ENABLE
extern code U8 MST_GRule_32_1920_NR_Main[PQ_GRULE_NR_LVL_NUM_Main];
#endif
#if PQ_GRULE_OSD_BW_ENABLE
extern code U8 MST_GRule_32_1920_OSD_BW_Main[PQ_GRULE_OSD_BW_LVL_NUM_Main];
#endif
#if PQ_GRULE_MPEG_NR_ENABLE
extern code U8 MST_GRule_32_1920_MPEG_NR_Main[PQ_GRULE_MPEG_NR_LVL_NUM_Main];
#endif
#if PQ_GRULE_FILM_MODE_ENABLE
extern code U8 MST_GRule_32_1920_FILM_MODE_Main[PQ_GRULE_FILM_MODE_LVL_NUM_Main];
#endif
#if PQ_GRULE_DYNAMIC_CONTRAST_ENABLE
extern code U8 MST_GRule_32_1920_DYNAMIC_CONTRAST_Main[PQ_GRULE_DYNAMIC_CONTRAST_LVL_NUM_Main];
#endif
#if PQ_GRULE_COLOR_FOR_VIVID_ENABLE
extern code U8 MST_GRule_32_1920_COLOR_FOR_VIVID_Main[PQ_GRULE_COLOR_FOR_VIVID_LVL_NUM_Main];
#endif
#if PQ_GRULE_PTP_ENABLE
extern code U8 MST_GRule_32_1920_PTP_Main[PQ_GRULE_PTP_LVL_NUM_Main];
#endif

#if PQ_GRULE_NR_ENABLE
extern code U8 MST_GRule_32_1366_NR_Main[PQ_GRULE_NR_LVL_NUM_Main];
#endif
#if PQ_GRULE_OSD_BW_ENABLE
extern code U8 MST_GRule_32_1366_OSD_BW_Main[PQ_GRULE_OSD_BW_LVL_NUM_Main];
#endif
#if PQ_GRULE_MPEG_NR_ENABLE
extern code U8 MST_GRule_32_1366_MPEG_NR_Main[PQ_GRULE_MPEG_NR_LVL_NUM_Main];
#endif
#if PQ_GRULE_FILM_MODE_ENABLE
extern code U8 MST_GRule_32_1366_FILM_MODE_Main[PQ_GRULE_FILM_MODE_LVL_NUM_Main];
#endif
#if PQ_GRULE_DYNAMIC_CONTRAST_ENABLE
extern code U8 MST_GRule_32_1366_DYNAMIC_CONTRAST_Main[PQ_GRULE_DYNAMIC_CONTRAST_LVL_NUM_Main];
#endif
#if PQ_GRULE_COLOR_FOR_VIVID_ENABLE
extern code U8 MST_GRule_32_1366_COLOR_FOR_VIVID_Main[PQ_GRULE_COLOR_FOR_VIVID_LVL_NUM_Main];
#endif
#if PQ_GRULE_PTP_ENABLE
extern code U8 MST_GRule_32_1366_PTP_Main[PQ_GRULE_PTP_LVL_NUM_Main];
#endif
