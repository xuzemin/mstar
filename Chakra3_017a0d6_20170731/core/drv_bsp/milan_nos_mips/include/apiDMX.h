...
DLL_PUBLIC DMX_FILTER_STATUS MApi_DMX_SetPacketMode(DMX_FLOW DmxFlow, DMX_PacketMode ePktMode);
DLL_PUBLIC DMX_FILTER_STATUS MApi_DMX_SetMergeStrSyncByte(MS_U32 u32SrcID, MS_U8 u8SyncByte);
DLL_PUBLIC DMX_FILTER_STATUS MApi_DMX_DropScmbPkt(DMX_FILTER_TYPE pDmxFltType, MS_BOOL bEnable);
...
DLL_PUBLIC DMX_FILTER_STATUS MApi_DMX_GetCap_Ex(char* pstrQueryType, int inStrlen, void* pOutput, int* pOutSize);
...
DLL_PUBLIC DMX_FILTER_STATUS MApi_DMX_Flow_DscmbEng(DMX_TSIF eTsIf, MS_U32* pu32EngId, MS_BOOL bSet);
DLL_PUBLIC DMX_FILTER_STATUS MApi_DMX_TsOutputPadCfg(DMX_FLOW_OUTPUT_PAD eOutPad, DMX_FLOW_INPUT eInSrcPad, MS_BOOL bInParallel, MS_U32 u32ResvNum, MS_U32 *pu32Resv);
DLL_PUBLIC DMX_FILTER_STATUS MApi_DMX_TsS2POutputClkPhase(MS_U16 u16Val, MS_BOOL bEnable, MS_U32 u32Reserved);
...
DLL_PUBLIC DMX_FILTER_STATUS MApi_DMX_Pvr_Eng_IsStart(DMX_PVR_ENG Eng, MS_BOOL *pbIsStart);
...
DLL_PUBLIC DMX_FILTER_STATUS MApi_DMX_MMFI_TimeStampClk(DMX_MMFI_PATH ePath, DMX_TimeStamp_Clk eClk);
//-------------------------------------------------------------
...
DLL_PUBLIC DMX_FILTER_STATUS MApi_DMX_TSO_Filein_CMDQ_Reset(MS_U8 u8Eng);
...
DLL_PUBLIC DMX_FILTER_STATUS MApi_DMX_TSO_Filein_GetReadAddr(MS_U8 u8Eng, MS_U32* pu32Read);
...
DLL_PUBLIC DMX_FILTER_STATUS MApi_DMX_TSO_SetOutClk(MS_U8 u8Eng, DMX_TSO_OutClk eTsOutClk, DMX_TSO_OutClkSrc eTsOutClkSrc, MS_U16 u16DivNum, MS_BOOL bClkInv);
DLL_PUBLIC DMX_FILTER_STATUS MApi_DMX_TSO_OutputEnable(MS_U8 u8Eng, MS_BOOL bEnable);

//TSO2 API
DLL_PUBLIC DMX_FILTER_STATUS MApi_DMX_TSO_LocalStreamId(MS_U8 u8Eng, DMX_TSIF eIf, MS_U8* pu8StrId, MS_BOOL bSet);
DLL_PUBLIC DMX_FILTER_STATUS MApi_DMX_TSO_SVQBuf_Set(MS_U8 u8Eng, MS_PHYADDR u32Addr, MS_U32 u32BufSize);
DLL_PUBLIC DMX_FILTER_STATUS MApi_DMX_TSO_Flow_InputCfg(DMX_TSO_InputCfg* pstInputCfg);
DLL_PUBLIC DMX_FILTER_STATUS MApi_DMX_TSO_Flow_OutputCfg(DMX_TSO_OutputCfg* pstOutputCfg);
DLL_PUBLIC DMX_FILTER_STATUS MApi_DMX_TSO_Pid_Open(MS_U8 u8Eng, DMX_TSIF eTSOInSrc, MS_U16 u16Pid, MS_U16* pu16DmxId);
DLL_PUBLIC DMX_FILTER_STATUS MApi_DMX_TSO_Pid_Close(MS_U8 u8Eng, MS_U16 u16DmxId);
//----------------------------------------------------------
...
//-----------------------------------------------------
// Merge stream API
DLL_PUBLIC DMX_FILTER_STATUS MApi_DMX_MStr_SyncByte(DMX_TSIF eIf, MS_U8 u8StrId, MS_U8* pu8SyncByte, MS_BOOL bSet);
//-----------------------------------------------------
