...
/* Si2158 ATV_IR property definition */
#define   Si2158_ATV_IR_PROP 0x0622

#ifdef    Si2158_ATV_IR_PROP
  #define Si2158_ATV_IR_PROP_CODE 0x000622


    typedef struct { /* Si2158_ATV_IR_PROP_struct */
      unsigned char   filter;
      unsigned char   gear;
   } Si2158_ATV_IR_PROP_struct;

   /* ATV_IR property, FILTER field definition (NO TITLE)*/
   #define  Si2158_ATV_IR_PROP_FILTER_LSB         8
   #define  Si2158_ATV_IR_PROP_FILTER_MASK        0x01
   #define  Si2158_ATV_IR_PROP_FILTER_DEFAULT    1
    #define Si2158_ATV_IR_PROP_FILTER_HW_FILTERS      0
    #define Si2158_ATV_IR_PROP_FILTER_CUSTOM_FILTERS  1

   /* ATV_IR property, GEAR field definition (NO TITLE)*/
   #define  Si2158_ATV_IR_PROP_GEAR_LSB         0
   #define  Si2158_ATV_IR_PROP_GEAR_MASK        0xff
   #define  Si2158_ATV_IR_PROP_GEAR_DEFAULT    8
    #define Si2158_ATV_IR_PROP_GEAR_IR_GEAR_MIN  0
    #define Si2158_ATV_IR_PROP_GEAR_IR_GEAR_MAX  255

#endif /* Si2158_ATV_IR_PROP */

/* Si2158 ATV_IRCAL_DRIFT property definition */
#define   Si2158_ATV_IRCAL_DRIFT_PROP 0x061d

#ifdef    Si2158_ATV_IRCAL_DRIFT_PROP
  #define Si2158_ATV_IRCAL_DRIFT_PROP_CODE 0x00061d


    typedef struct { /* Si2158_ATV_IRCAL_DRIFT_PROP_struct */
      unsigned char   dead_zone;
      unsigned char   step_limit;
   } Si2158_ATV_IRCAL_DRIFT_PROP_struct;

   /* ATV_IRCAL_DRIFT property, DEAD_ZONE field definition (NO TITLE)*/
   #define  Si2158_ATV_IRCAL_DRIFT_PROP_DEAD_ZONE_LSB         8
   #define  Si2158_ATV_IRCAL_DRIFT_PROP_DEAD_ZONE_MASK        0xff
   #define  Si2158_ATV_IRCAL_DRIFT_PROP_DEAD_ZONE_DEFAULT    25
    #define Si2158_ATV_IRCAL_DRIFT_PROP_DEAD_ZONE_DEAD_ZONE_MIN  0
    #define Si2158_ATV_IRCAL_DRIFT_PROP_DEAD_ZONE_DEAD_ZONE_MAX  255

   /* ATV_IRCAL_DRIFT property, STEP_LIMIT field definition (NO TITLE)*/
   #define  Si2158_ATV_IRCAL_DRIFT_PROP_STEP_LIMIT_LSB         0
   #define  Si2158_ATV_IRCAL_DRIFT_PROP_STEP_LIMIT_MASK        0xff
   #define  Si2158_ATV_IRCAL_DRIFT_PROP_STEP_LIMIT_DEFAULT    10
    #define Si2158_ATV_IRCAL_DRIFT_PROP_STEP_LIMIT_STEP_LIMIT_MIN  0
    #define Si2158_ATV_IRCAL_DRIFT_PROP_STEP_LIMIT_STEP_LIMIT_MAX  255

#endif /* Si2158_ATV_IRCAL_DRIFT_PROP */

/* Si2158 ATV_IRCAL_MON property definition */
#define   Si2158_ATV_IRCAL_MON_PROP 0x061b

#ifdef    Si2158_ATV_IRCAL_MON_PROP
  #define Si2158_ATV_IRCAL_MON_PROP_CODE 0x00061b


    typedef struct { /* Si2158_ATV_IRCAL_MON_PROP_struct */
      unsigned char   disable_threshold;
      unsigned char   expiration_fields;
   } Si2158_ATV_IRCAL_MON_PROP_struct;

   /* ATV_IRCAL_MON property, DISABLE_THRESHOLD field definition (NO TITLE)*/
   #define  Si2158_ATV_IRCAL_MON_PROP_DISABLE_THRESHOLD_LSB         8
   #define  Si2158_ATV_IRCAL_MON_PROP_DISABLE_THRESHOLD_MASK        0xff
   #define  Si2158_ATV_IRCAL_MON_PROP_DISABLE_THRESHOLD_DEFAULT    255
    #define Si2158_ATV_IRCAL_MON_PROP_DISABLE_THRESHOLD_DISABLE_THRESHOLD_MIN  0
    #define Si2158_ATV_IRCAL_MON_PROP_DISABLE_THRESHOLD_DISABLE_THRESHOLD_MAX  255

   /* ATV_IRCAL_MON property, EXPIRATION_FIELDS field definition (NO TITLE)*/
   #define  Si2158_ATV_IRCAL_MON_PROP_EXPIRATION_FIELDS_LSB         0
   #define  Si2158_ATV_IRCAL_MON_PROP_EXPIRATION_FIELDS_MASK        0xff
   #define  Si2158_ATV_IRCAL_MON_PROP_EXPIRATION_FIELDS_DEFAULT    120
    #define Si2158_ATV_IRCAL_MON_PROP_EXPIRATION_FIELDS_EXPIRATION_FIELDS_MIN  0
    #define Si2158_ATV_IRCAL_MON_PROP_EXPIRATION_FIELDS_EXPIRATION_FIELDS_MAX  255
...
/* Si2158 ATV_MIN_LVL_LOCK property definition */
#define   Si2158_ATV_MIN_LVL_LOCK_PROP 0x060f

#ifdef    Si2158_ATV_MIN_LVL_LOCK_PROP
  #define Si2158_ATV_MIN_LVL_LOCK_PROP_CODE 0x00060f


    typedef struct { /* Si2158_ATV_MIN_LVL_LOCK_PROP_struct */
      unsigned char   thrs;
   } Si2158_ATV_MIN_LVL_LOCK_PROP_struct;

   /* ATV_MIN_LVL_LOCK property, THRS field definition (NO TITLE)*/
   #define  Si2158_ATV_MIN_LVL_LOCK_PROP_THRS_LSB         0
   #define  Si2158_ATV_MIN_LVL_LOCK_PROP_THRS_MASK        0xff
   #define  Si2158_ATV_MIN_LVL_LOCK_PROP_THRS_DEFAULT    34
...
#define   Si2158_DTV_CONFIG_IF_PORT_PROP 0x0702
  ...
  #define Si2158_DTV_CONFIG_IF_PORT_PROP_CODE 0x000702
   ...
   #define  Si2158_DTV_CONFIG_IF_PORT_PROP_DTV_OUT_TYPE_DEFAULT    0
...
/* _properties_struct_insertion_start */
  ...
  typedef struct {
    ...
    #endif /* Si2158_ATV_INT_SENSE_PROP */
    #ifdef    Si2158_ATV_IR_PROP
              Si2158_ATV_IR_PROP_struct                        atv_ir;
    #endif /* Si2158_ATV_IR_PROP */
    #ifdef    Si2158_ATV_IRCAL_DRIFT_PROP
              Si2158_ATV_IRCAL_DRIFT_PROP_struct               atv_ircal_drift;
    #endif /* Si2158_ATV_IRCAL_DRIFT_PROP */
    #ifdef    Si2158_ATV_IRCAL_MON_PROP
              Si2158_ATV_IRCAL_MON_PROP_struct                 atv_ircal_mon;
    #endif /* Si2158_ATV_IRCAL_MON_PROP */
    #ifdef    Si2158_ATV_LIF_FREQ_PROP
    ...
    #endif /* Si2158_ATV_LIF_OUT_PROP */
    #ifdef    Si2158_ATV_MIN_LVL_LOCK_PROP
              Si2158_ATV_MIN_LVL_LOCK_PROP_struct              atv_min_lvl_lock;
    #endif /* Si2158_ATV_MIN_LVL_LOCK_PROP */
    #ifdef    Si2158_ATV_PGA_TARGET_PROP
