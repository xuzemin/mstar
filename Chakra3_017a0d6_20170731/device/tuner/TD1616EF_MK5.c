...
#ifndef TD1616EF_MK5_C
#define TD1616EF_MK5_C
...
void devTunerSetPLLData(WORD wPLLData, RFBAND eBand)
{
    ...
    cTunerData[2] = 0x98 |DIVIDER_RATIO;

    if(eBand == E_RFBAND_VHF_LOW)
    {
            cTunerData[3] = 0x00|TN_LOW_BAND;
    }
    else if(eBand == E_RFBAND_VHF_HIGH)
    {
            cTunerData[3] = 0x40|TN_MID_BAND;
    }
    else
    {
        if ( u16Freq < 742 )
        {
            cTunerData[3] = 0x80|TN_HIGH_BAND;
        }
        else
        {
            cTunerData[3] = 0xC0|TN_HIGH_BAND;
...
#define IF_OUT_LEVEL_117_112        (0<<3)
#define IF_OUT_LEVEL_114_109        (1<<3)
#define IF_OUT_LEVEL_111_106        (2<<3)
#define IF_OUT_LEVEL_108_103        (3<<3)
#define IF_OUT_LEVEL_105_100       (4<<3)
#define IF_OUT_LEVEL_102_97         (5<<3)
#define IF_OUT_LEVEL_99_94         (6<<3)
...
//Freq = 666;
    ...
    CONFIG[2] = 0x80 | IF_OUT_LEVEL_117_112 | DIVIDER_62_5K; // CB1
    ...
    else if ( Freq  <= 443 ) // VHF high
    {
        CONFIG[3] |= CHARGE_PUMP_140uA;
