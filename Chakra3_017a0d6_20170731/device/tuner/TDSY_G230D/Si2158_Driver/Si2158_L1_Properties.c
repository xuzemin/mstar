...
unsigned char Si2158_L1_SetProperty2(L1_Si2158_Context *api, unsigned int prop_code) {
    ...
    switch (prop_code) {
     ...
     case         Si2158_ATV_IR_PROP_CODE:
       if(api->rsp->part_info.romid == 0x31) return NO_Si2158_ERROR; //lgit
	   data = (api->prop->atv_ir.gear   & Si2158_ATV_IR_PROP_GEAR_MASK  ) << Si2158_ATV_IR_PROP_GEAR_LSB  |
              (api->prop->atv_ir.filter & Si2158_ATV_IR_PROP_FILTER_MASK) << Si2158_ATV_IR_PROP_FILTER_LSB ;
     break;
    #endif /*     Si2158_ATV_IR_PROP */
    #ifdef        Si2158_ATV_IRCAL_DRIFT_PROP
     case         Si2158_ATV_IRCAL_DRIFT_PROP_CODE:
       data = (api->prop->atv_ircal_drift.step_limit & Si2158_ATV_IRCAL_DRIFT_PROP_STEP_LIMIT_MASK) << Si2158_ATV_IRCAL_DRIFT_PROP_STEP_LIMIT_LSB  |
              (api->prop->atv_ircal_drift.dead_zone  & Si2158_ATV_IRCAL_DRIFT_PROP_DEAD_ZONE_MASK ) << Si2158_ATV_IRCAL_DRIFT_PROP_DEAD_ZONE_LSB ;
     break;
    #endif /*     Si2158_ATV_IRCAL_DRIFT_PROP */
    #ifdef        Si2158_ATV_IRCAL_MON_PROP
     case         Si2158_ATV_IRCAL_MON_PROP_CODE:
       data = (api->prop->atv_ircal_mon.expiration_fields & Si2158_ATV_IRCAL_MON_PROP_EXPIRATION_FIELDS_MASK) << Si2158_ATV_IRCAL_MON_PROP_EXPIRATION_FIELDS_LSB  |
              (api->prop->atv_ircal_mon.disable_threshold & Si2158_ATV_IRCAL_MON_PROP_DISABLE_THRESHOLD_MASK) << Si2158_ATV_IRCAL_MON_PROP_DISABLE_THRESHOLD_LSB ;
     break;
     ...
     case         Si2158_ATV_MIN_LVL_LOCK_PROP_CODE:
       data = (api->prop->atv_min_lvl_lock.thrs & Si2158_ATV_MIN_LVL_LOCK_PROP_THRS_MASK) << Si2158_ATV_MIN_LVL_LOCK_PROP_THRS_LSB ;
     break;
...
unsigned char Si2158_L1_GetProperty2(L1_Si2158_Context *api, unsigned int prop_code) {
    ...
    #ifdef        Si2158_ATV_IR_PROP
     case         Si2158_ATV_IR_PROP_CODE:
               api->prop->atv_ir.gear   = (data >> Si2158_ATV_IR_PROP_GEAR_LSB  ) & Si2158_ATV_IR_PROP_GEAR_MASK;
               api->prop->atv_ir.filter = (data >> Si2158_ATV_IR_PROP_FILTER_LSB) & Si2158_ATV_IR_PROP_FILTER_MASK;
     break;
    #endif /*     Si2158_ATV_IR_PROP */
    #ifdef        Si2158_ATV_IRCAL_DRIFT_PROP
     case         Si2158_ATV_IRCAL_DRIFT_PROP_CODE:
               api->prop->atv_ircal_drift.step_limit = (data >> Si2158_ATV_IRCAL_DRIFT_PROP_STEP_LIMIT_LSB) & Si2158_ATV_IRCAL_DRIFT_PROP_STEP_LIMIT_MASK;
               api->prop->atv_ircal_drift.dead_zone  = (data >> Si2158_ATV_IRCAL_DRIFT_PROP_DEAD_ZONE_LSB ) & Si2158_ATV_IRCAL_DRIFT_PROP_DEAD_ZONE_MASK;
     break;
    #endif /*     Si2158_ATV_IRCAL_DRIFT_PROP */
    #ifdef        Si2158_ATV_IRCAL_MON_PROP
     case         Si2158_ATV_IRCAL_MON_PROP_CODE:
               api->prop->atv_ircal_mon.expiration_fields = (data >> Si2158_ATV_IRCAL_MON_PROP_EXPIRATION_FIELDS_LSB) & Si2158_ATV_IRCAL_MON_PROP_EXPIRATION_FIELDS_MASK;
               api->prop->atv_ircal_mon.disable_threshold = (data >> Si2158_ATV_IRCAL_MON_PROP_DISABLE_THRESHOLD_LSB) & Si2158_ATV_IRCAL_MON_PROP_DISABLE_THRESHOLD_MASK;
     break;
    #endif /*     Si2158_ATV_IRCAL_MON_PROP */
    #ifdef        Si2158_ATV_LIF_FREQ_PROP
     case         Si2158_ATV_LIF_FREQ_PROP_CODE:
    ...
    #ifdef        Si2158_ATV_MIN_LVL_LOCK_PROP
     case         Si2158_ATV_MIN_LVL_LOCK_PROP_CODE:
               api->prop->atv_min_lvl_lock.thrs = (data >> Si2158_ATV_MIN_LVL_LOCK_PROP_THRS_LSB) & Si2158_ATV_MIN_LVL_LOCK_PROP_THRS_MASK;
     break;
    #endif /*     Si2158_ATV_MIN_LVL_LOCK_PROP */
    #ifdef        Si2158_ATV_PGA_TARGET_PROP
     case         Si2158_ATV_PGA_TARGET_PROP_CODE:
...
void          Si2158_L1_FillPropertyStringText(L1_Si2158_Context *api, unsigned int prop_code, char *separator, char *msg) {
    switch (prop_code) {
     ...
     case         Si2158_ATV_IR_PROP_CODE:
      sprintf(msg,"ATV_IR");
       strcat(msg,separator); strcat(msg,"-GEAR "); sprintf(msg,"%s%d", msg, api->prop->atv_ir.gear);
       strcat(msg,separator); strcat(msg,"-FILTER ");
           if  (api->prop->atv_ir.filter ==     0) strcat(msg,"HW_FILTERS     ");
      else if  (api->prop->atv_ir.filter ==     1) strcat(msg,"CUSTOM_FILTERS ");
      else                                        sprintf(msg,"%s%d", msg, api->prop->atv_ir.filter);
     break;
    #endif /*     Si2158_ATV_IR_PROP */
    #ifdef        Si2158_ATV_IRCAL_DRIFT_PROP
     case         Si2158_ATV_IRCAL_DRIFT_PROP_CODE:
      sprintf(msg,"ATV_IRCAL_DRIFT");
       strcat(msg,separator); strcat(msg,"-STEP_LIMIT "); sprintf(msg,"%s%d", msg, api->prop->atv_ircal_drift.step_limit);
       strcat(msg,separator); strcat(msg,"-DEAD_ZONE "); sprintf(msg,"%s%d", msg, api->prop->atv_ircal_drift.dead_zone);
     break;
    #endif /*     Si2158_ATV_IRCAL_DRIFT_PROP */
    #ifdef        Si2158_ATV_IRCAL_MON_PROP
     case         Si2158_ATV_IRCAL_MON_PROP_CODE:
      sprintf(msg,"ATV_IRCAL_MON");
       strcat(msg,separator); strcat(msg,"-EXPIRATION_FIELDS "); sprintf(msg,"%s%d", msg, api->prop->atv_ircal_mon.expiration_fields);
       strcat(msg,separator); strcat(msg,"-DISABLE_THRESHOLD "); sprintf(msg,"%s%d", msg, api->prop->atv_ircal_mon.disable_threshold);
     break;
    #endif /*     Si2158_ATV_IRCAL_MON_PROP */
    #ifdef        Si2158_ATV_LIF_FREQ_PROP
     case         Si2158_ATV_LIF_FREQ_PROP_CODE:
    ...
    #ifdef        Si2158_ATV_MIN_LVL_LOCK_PROP
     case         Si2158_ATV_MIN_LVL_LOCK_PROP_CODE:
      sprintf(msg,"ATV_MIN_LVL_LOCK");
       strcat(msg,separator); strcat(msg,"-THRS "); sprintf(msg,"%s%d", msg, api->prop->atv_min_lvl_lock.thrs);
     break;
    #endif /*     Si2158_ATV_MIN_LVL_LOCK_PROP */
    #ifdef        Si2158_ATV_PGA_TARGET_PROP
     case         Si2158_ATV_PGA_TARGET_PROP_CODE:
