#ifndef _LED_PQ_INNO_75INCH_24X1_C_
#define _LED_PQ_INNO_75INCH_24X1_C_
...
StuDrvLdPQInfo s_DrvLdPQInfo_INNO75_24X1 =
{
    ...
    24, 1, // U8 u8LEDWidth, u8LEDHeight; // LED width & height
    24, 1, // U8 u8LSFWidth, u8LSFHeight; // LSF width & height
