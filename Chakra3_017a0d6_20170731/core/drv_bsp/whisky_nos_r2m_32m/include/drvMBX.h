...
INTERFACE DLL_PUBLIC MBX_Result  MDrv_MBX_Init(MBX_CPU_ID eHKCPU, MBX_ROLE_ID eHostRole, MS_U32 u32TimeoutMillSecs);
INTERFACE DLL_PUBLIC MBX_Result  MDrv_MBX_DeInit(MS_BOOL bForceDiscardPendingMsg);
INTERFACE DLL_PUBLIC MBX_Result  MDrv_MBX_RegisterMSG(MBX_Class eMsgClass, MS_U16 u16MsgQueueSize);
...
INTERFACE DLL_PUBLIC MBX_Result  MDrv_MBX_RegisterMSGWithCallBack(MBX_Class eMsgClass, MS_U16 u16MsgQueueSize, MBX_MAIL_ARRIVE_NOTIFY_FUNC notifier);
INTERFACE DLL_PUBLIC MBX_Result  MDrv_MBX_UnRegisterMSG(MBX_Class eMsgClass, MS_BOOL bForceDiscardMsgQueue);
INTERFACE DLL_PUBLIC MBX_Result  MDrv_MBX_ClearMSG(MBX_Class eMsgClass);
INTERFACE DLL_PUBLIC MBX_Result  MDrv_MBX_SendMsg(MBX_Msg *pMsg);
INTERFACE DLL_PUBLIC MBX_Result  MDrv_MBX_GetMsgQueueStatus(MBX_Class eTargetClass, MBX_MSGQ_Status *pMsgQueueStatus);
INTERFACE DLL_PUBLIC MBX_Result  MDrv_MBX_RecvMsg(MBX_Class eTargetClass, MBX_Msg *pMsg, MS_U32 u32WaitMillSecs, MS_U32 u32Flag);
INTERFACE DLL_PUBLIC MBX_Result  MDrv_MBX_CheckMsg(MBX_Class eTargetClass, MBX_Msg *pMsg, MS_U32 u32WaitMillSecs, MS_U32 u32Flag);
INTERFACE DLL_PUBLIC MBX_Result  MDrv_MBX_SendMsgLoopback(MBX_Msg *pMsg, MBX_ROLE_ID eSrcRoleId);
INTERFACE DLL_PUBLIC MBX_Result  MDrv_MBX_Enable(MS_BOOL bEnable);//Enable receiving regisited messages in kernel
INTERFACE DLL_PUBLIC MBX_Result  MDrv_MBX_RemoveLatestMsg(void);

// For Application Set/Get Information API:
INTERFACE DLL_PUBLIC MBX_Result  MDrv_MBX_SetInformation(MBX_ROLE_ID eTargetRole, MS_U8 *pU8Info, MS_U8 u8Size);
INTERFACE DLL_PUBLIC MBX_Result  MDrv_MBX_GetInformation(MBX_ROLE_ID eTargetRole, MS_U8 *pU8Info, MS_U8 u8Size);

// For Debug & Version Control:
INTERFACE DLL_PUBLIC void        MDrv_MBX_SetDbgLevel(MS_U8 u8DbgLevel);
INTERFACE DLL_PUBLIC MS_BOOL     MDrv_MBX_GetLibVer(const MSIF_Version **ppVersion);
INTERFACE DLL_PUBLIC MS_BOOL     MDrv_MBX_GetInfo(MBX_DrvInfo *pMbxDrvInfo);
INTERFACE DLL_PUBLIC MS_BOOL     MDrv_MBX_GetStatus(MBX_DrvStatus *pMbxDrvStatus);
