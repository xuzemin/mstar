...
#else
    #define DYNAMIC_MMAP_FOR_BEON       FALSE
#endif
...
#define MMAP_ID_MAD_BASE_BUF             0x0B
...
#define MMAP_ID_M5FONT_BUF              0x30
#define MMAP_ID_M5FONT_HD_BUF           0x31
#define MMAP_ID_M5FONT_RM               0x32
#endif
...
#define ENABLE_API_MMAP_GET_BUF 1
...
typedef enum
{
    ...
    E_BUFID_VDEC_BITSTREAM,
    E_BUFID_VDEC_FRAMEBUFFER,
