...
void devDigitalTuner_SetFreq ( double Freq, RF_CHANNEL_BANDWIDTH eBandWidth)
{
    ...
    {
        if ( ( Freq + DIGITAL_TUNER_IF ) < 144 )
        {
    		CONFIG[3] = 0xbc;
        	CONFIG[4] = 0x01;
			CONFIG[5] = 0x9c;
        }
        else if ( ( Freq + DIGITAL_TUNER_IF ) < 160 )
        {
    		CONFIG[3] = 0xf4;
        	CONFIG[4] = 0x01;
			CONFIG[5] = 0xdc;
        }
        else if ( ( Freq + DIGITAL_TUNER_IF ) < 330 )
        {
    		CONFIG[3] = 0xbc;
        	CONFIG[4] = 0x02;
			CONFIG[5] = 0x9c;
        }
        else if ( ( Freq + DIGITAL_TUNER_IF ) < 446 )
        {
    		CONFIG[3] = 0xf4;
        	CONFIG[4] = 0x02;
			CONFIG[5] = 0xdc;
        }
        else if ( ( Freq + DIGITAL_TUNER_IF ) < 610 )
        {
    		CONFIG[3] = 0xbc;
        	CONFIG[4] = 0x04;
			CONFIG[5] = 0x9c;
        }
        else if ( ( Freq + DIGITAL_TUNER_IF ) < 754 )
        {
    		CONFIG[3] = 0xf4;
        	CONFIG[4] = 0x04;
			CONFIG[5] = 0xdc;
