...
/* Si2158_APPLY_SAMPLE_FREQ command definition */
#define   Si2158_APPLY_SAMPLE_FREQ_CMD 0x46

#ifdef    Si2158_APPLY_SAMPLE_FREQ_CMD
  #define Si2158_APPLY_SAMPLE_FREQ_CMD_CODE 0x010046

    typedef struct { /* Si2158_APPLY_SAMPLE_FREQ_CMD_struct */
         unsigned char   nothing;   } Si2158_APPLY_SAMPLE_FREQ_CMD_struct;


    typedef struct { /* Si2158_APPLY_SAMPLE_FREQ_CMD_REPLY_struct */
       Si2158_COMMON_REPLY_struct * STATUS;
   }  Si2158_APPLY_SAMPLE_FREQ_CMD_REPLY_struct;
...
/* _commands_struct_insertion_start */
  ...
  typedef struct { /* Si2158_CmdObj struct */
    ...
    #endif /* Si2158_AGC_OVERRIDE_CMD */
    #ifdef    Si2158_APPLY_SAMPLE_FREQ_CMD
              Si2158_APPLY_SAMPLE_FREQ_CMD_struct  apply_sample_freq;
    #endif /* Si2158_APPLY_SAMPLE_FREQ_CMD */
    #ifdef    Si2158_ATV_CW_TEST_CMD
...
/* _commands_reply_struct_insertion_start */
  ...
  typedef struct { /* Si2158_CmdReplyObj struct */
    ...
    #endif /* Si2158_AGC_OVERRIDE_CMD */
    #ifdef    Si2158_APPLY_SAMPLE_FREQ_CMD
              Si2158_APPLY_SAMPLE_FREQ_CMD_REPLY_struct  apply_sample_freq;
    #endif /* Si2158_APPLY_SAMPLE_FREQ_CMD */
    #ifdef    Si2158_ATV_CW_TEST_CMD
