...
#include "Maya_Main_HSDRule.h"      // table config parameter
#include "Maya_Main_VSDRule.h"      // table config parameter
#include "Maya_Main_HSPRule.h"      // table config parameter
#include "Maya_Main_VSPRule.h"      // table config parameter
#include "Maya_Main_CSCRule.h"      // table config parameter
#include "Maya_Main_GRule.h"        // table config parameter
#include "Maya_Main_Ex.h"           // table config parameter

/*#include "Eden_Sub.h"               // table config parameter
#include "Eden_Sub_HSDRule.h"       // table config parameter
#include "Eden_Sub_VSDRule.h"       // table config parameter
#include "Eden_Sub_HSPRule.h"       // table config parameter
#include "Eden_Sub_VSPRule.h"       // table config parameter
#include "Eden_Sub_CSCRule.h"       // table config parameter
#include "Eden_Sub_GRule.h"         // table config parameter
#include "Eden_Sub_Ex.h"            // table config parameter
*/
...
#include "Maya_Main_Color.h"       // table config parameter
#include "Maya_Main_Color_GRule.h" // table config parameter
#endif
