...
//-----------------------------------------------------------------------------
// FILE NAME:    tmddTDA18273Instance.c
//
...
/* default instance */
tmddTDA18273Object_t gddTDA18273Instance[] = 
{
    {
...
/*-----------------------------------------------------------------------------
// FUNCTION:    ddTDA18273AllocInstance:
//
...
*/
tmErrorCode_t
ddTDA18273AllocInstance
(
 tmUnitSelect_t          tUnit,      /* I: Unit number */
 pptmddTDA18273Object_t    ppDrvObject /* I: Device Object */
 )
{ 
    tmErrorCode_t       err = ddTDA18273_ERR_BAD_UNIT_NUMBER;
    ...
    {
        pObj = &gddTDA18273Instance[uLoopCounter];
        if(pObj->init == False)
        {
            pObj->tUnit = tUnit;
            pObj->tUnitW = tUnit;
...
/*-----------------------------------------------------------------------------
// FUNCTION:    ddTDA18273DeAllocInstance:
//
...
/*-----------------------------------------------------------------------------
// FUNCTION:    ddTDA18273GetInstance:
//
...
*/
tmErrorCode_t
ddTDA18273GetInstance
(
 tmUnitSelect_t          tUnit,      /* I: Unit number */
 pptmddTDA18273Object_t    ppDrvObject /* I: Device Object */
 )
{     
    tmErrorCode_t           err = ddTDA18273_ERR_NOT_INITIALIZED;
    ptmddTDA18273Object_t     pObj = Null;
    UInt32                  uLoopCounter = 0;    
