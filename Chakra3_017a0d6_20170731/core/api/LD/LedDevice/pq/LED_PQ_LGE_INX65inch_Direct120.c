#ifndef _LED_PQ_LGE_INX_65INCH_DIRECT_120_C_
#define _LED_PQ_LGE_INX_65INCH_DIRECT_120_C_

#include "compen/Tbl_LD_Compensation_Gamma22.c"
#include "edge2d/Tbl_LD_Edge2D_LGE_INX65inch_Direct120.c"
#include "gamma/Tbl_LD_Gamma_LGE_INX65inch_Direct120.c"

StuDrvLdPQInfo s_DrvLdPQInfo_LGE_INX65 =
{
    HAL_LD_EDGE_TB_TYPE, // EnuLD_LED_TYPE eLEDType;

    // PANEL
    24, 48, // U8 u8LDFWidth, u8LDFHeight; // Statistic width & height  24,48,
    6, 1, // U8 u8LEDWidth, u8LEDHeight; // LED width & height
    ...
    TRUE, // BOOL bEdge2DEn; // Edge2D enble
    LD_COEF_PERCEPTUAL, // EnuLD_COEF_ENCODING eEnc; // Edge2D encoding scheme
    Tbl_LD_Edge2D_LGE_INX65inch_Direct120, // const U8* pu8Edge2DTable; // Edge2D table  SIZE=(u8LEDWidth*u8LEDHeight)*(u8LDFWidth*u8LDFHeight)
    ...
    0x5C, //U8 u8SFStrength1; // spatial filter strength
    ...
    0x0F, //U8 u8InGamma; // gamma at SW begin
    0x02, //U8 u8OutGamma; // gamma at SW end
