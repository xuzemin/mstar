#ifndef _LED_PQ_LG_65INCH_DIRECT_120_C_
#define _LED_PQ_LG_65INCH_DIRECT_120_C_

#include "compen/Tbl_LD_Compensation_Gamma22.c"
#include "edge2d/Tbl_LD_Edge2D_LG65inch_Direct120.c"
#include "gamma/Tbl_LD_Gamma_LG65inch_Direct120.c"

StuDrvLdPQInfo s_DrvLdPQInfo_LG65 =
{
    ...
    Tbl_LD_Edge2D_LG65inch_Direct120, // const U8* pu8Edge2DTable; // Edge2D table  SIZE=(u8LEDWidth*u8LEDHeight)*(u8LDFWidth*u8LDFHeight)
