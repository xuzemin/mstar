...
//MIU group priority
//----------------------------------------------------------
#define  MIU0_GROUP0_PRIORITY     1
#define  MIU0_GROUP1_PRIORITY     0
#define  MIU0_GROUP2_PRIORITY     2
...
#define  MAU0_RW                   0
#define  MAU1_RW                   0
#define  PM51_XD2MIU_RW            0
#define  VD_MHEG5_RW               0
#define  TSP_W                     0
#define  TSP_R                     0
#define  MVD_RW                    0
#define  VD_TTXSL_W                0
...
#define  NONE_RW                   0
#define  NONE_RW                   0
#define  NONE_RW                   0   // MIU assignment   0: MIU0, 1: MIU1  2:IP_ASSIGN
#define  NONE_RW                   0

#define  ClientGruop0_in_MIU1     ((( VIVALDI9_DSP_DECODER == 1)? 0x0002 : 0  )| \
                                   (( USB_RW               == 1)? 0x0004 : 0  )| \
                                   (( AESDMA_RW            == 1)? 0x0008 : 0  )| \
                                   (( MIPS_RW              == 1)? 0x0010 : 0  )| \
                                   (( MAU0_RW              == 1)? 0x0020 : 0  )| \
                                   (( MAU1_RW              == 1)? 0x0040 : 0  )| \
                                   (( PM51_XD2MIU_RW       == 1)? 0x0080 : 0  )| \
                                   (( VD_MHEG5_RW          == 1)? 0x0100 : 0  )| \
                                   (( TSP_W                == 1)? 0x0200 : 0  )| \
                                   (( TSP_R                == 1)? 0x0400 : 0  )| \
                                   (( MVD_RW               == 1)? 0x0800 : 0  )| \
                                   (( VD_TTXSL_W           == 1)? 0x1000 : 0  )| \
                                   (( TSP_ORZ_W            == 1)? 0x2000 : 0  )| \
                                   (( TSP_ORZ_RW           == 1)? 0x4000 : 0  )| \
                                   (( ADCDVIPLL_RW         == 1)? 0x8000 : 0  )  )

#define  ClientGruop1_in_MIU1     (((VIVALDI9_MAD         == 1)? 0x0001 : 0  )| \
                                   ((VIVALDI9_DMA         == 1)? 0x0002 : 0  )| \
                                   ((EVD_BBU_R            == 1)? 0x0004 : 0  )| \
                                   ((MVOP_R               == 1)? 0x0008 : 0  )| \
                                   ((GOP_W                == 1)? 0x0010 : 0  )| \
                                   ((GOP0_R               == 1)? 0x0020 : 0  )| \
                                   ((GOP1_R               == 1)? 0x0040 : 0  )| \
                                   ((SC_OP_R              == 1)? 0x0080 : 0  )| \
                                   ((SC_IP_MIAN_R         == 1)? 0x0100 : 0  )| \
                                   ((SC_IP_MIAN_W         == 1)? 0x0200 : 0  )| \
                                   ((SC_IPS_R             == 1)? 0x0400 : 0  )| \
                                   ((SC_OP_W              == 1)? 0x0800 : 0  )| \
...
#define  ClientGruop2_in_MIU1     (((EVD_RW               == 1)? 0x0001 : 0 )| \
                                   ((GE_RW                == 1)? 0x0002 : 0 )| \
                                   ((VD_TTX_RW            == 1)? 0x0004 : 0 )| \
                                   ((HVD_RW               == 1)? 0x0008 : 0 )| \
                                   ((HVD_ENG_RW           == 1)? 0x0010 : 0 )| \
                                   ((HVD_BBU_R            == 1)? 0x0020 : 0 )| \
                                   ((UHC0_RW              == 1)? 0x0040 : 0 )| \
                                   ((TSP_JPD_RW           == 1)? 0x0080 : 0 )| \
                                   ((DEMOD_W              == 1)? 0x0100 : 0 )| \
                                   ((DEMOD_R              == 1)? 0x0200 : 0 )| \
                                   ((BDMA_RW              == 1)? 0x0400 : 0 )| \
                                   ((USB_RW               == 1)? 0x0800 : 0 )| \
                                   ...
                                   ((FCIE_RW              == 1)? 0x2000 : 0 )| \
                                   ((SWCD_RW              == 1)? 0x4000 : 0 )| \
                                   ((DEMOD_ADC_DMA_W      == 1)? 0x8000 : 0 ))

#define  ClientGruop3_in_MIU1     (((NONE_RW              == 1)? 0x0001 : 0  )| \
                                   ((NONE_RW              == 1)? 0x0002 : 0  )| \
                                   ((NONE_RW              == 1)? 0x0004 : 0  )| \
                                   ((NONE_RW              == 1)? 0x0008 : 0  )| \
                                   ((NONE_RW              == 1)? 0x0010 : 0  )| \
...
#define  ClientGruop1_in_IP     (((VIVALDI9_MAD          == 2)? 0x0001 : 0 )| \
                                 ...
                                 ((SC_OP_R               == 2)? 0x0080 : 0 )| \
                                 ((SC_IP_MIAN_R          == 2)? 0x0100 : 0 )| \
                                 ((SC_IP_MIAN_W          == 2)? 0x0200 : 0 ))

#define  ClientGruop2_in_IP      ((  GE_RW               == 2)? 0x0002 : 0 | \
                                  (  UHC0_RW             == 2)? 0x0040 : 0 | \
                                  (  EMAC_RW             == 2)? 0x1000 : 0 )

#define  ClientGruop3_in_IP      ((  NONE_RW             == 2)? 0x0100 : 0 | \
                                  (  NONE_RW             == 2)? 0x0200 : 0 | \
                                  (  NONE_RW             == 2)? 0x1000 : 0 | \
                                  (  NONE_RW             == 2)? 0x2000 : 0 | \
                                  (  NONE_RW             == 2)? 0x4000 : 0 )
