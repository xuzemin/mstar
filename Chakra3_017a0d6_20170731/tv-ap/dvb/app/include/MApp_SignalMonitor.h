...
#if (ENABLE_ATSC)
INTERFACE U8 fSignalLockStatus;
//INTERFACE U8 fEnableSignalCheck;
#endif
...
INTERFACE BOOLEAN MApp_Is_SignalLostLock(void);
INTERFACE void MApp_Reset_SignalLostLockStatus(void);
#endif

#if (ENABLE_ATSC)
INTERFACE void MApp_SignalCheck_Init(void);
INTERFACE void MApp_SignalCheckMonitor(void);
INTERFACE BOOLEAN MApp_GetSignalLockStatus(void);
#endif
...
#endif // #ifndef MAPP_SIGNAL_MONITOR_H
