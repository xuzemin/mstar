...
DLL_PUBLIC DRVAESDMA_RESULT MDrv_AESDMA_IsSecretKeyInNormalBank(void);
DLL_PUBLIC DRVAESDMA_RESULT MDrv_AESDMA_NormalReset(void);
DLL_PUBLIC DRVAESDMA_RESULT MDrv_HDCP_ProcessCipher(MS_U8 u8Idx, MS_U8* pu8Riv, MS_U8 *pu8ContentKey);
