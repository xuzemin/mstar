...
//#include "x_typedef_.h"
#include <stdio.h>
#include "MsTypes.h"
#if 0
    /* C99 defined data types.  */

typedef unsigned char  uint8_si;
typedef unsigned short uint16_si;
typedef unsigned long  uint32_si;
