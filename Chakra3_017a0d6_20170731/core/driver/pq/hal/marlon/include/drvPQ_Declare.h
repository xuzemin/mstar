...
#include "Marlon_Main.h"              // table config parameter
#include "Marlon_Main_HSDRule.h"      // table config parameter
#include "Marlon_Main_VSDRule.h"      // table config parameter
#include "Marlon_Main_HSPRule.h"      // table config parameter
#include "Marlon_Main_VSPRule.h"      // table config parameter
#include "Marlon_Main_CSCRule.h"      // table config parameter
#include "Marlon_Main_GRule.h"        // table config parameter
#include "Marlon_Main_Ex.h"           // table config parameter

/*#include "Marlon_Sub.h"               // table config parameter
#include "Marlon_Sub_HSDRule.h"       // table config parameter
#include "Marlon_Sub_VSDRule.h"       // table config parameter
#include "Marlon_Sub_HSPRule.h"       // table config parameter
#include "Marlon_Sub_VSPRule.h"       // table config parameter
#include "Marlon_Sub_CSCRule.h"       // table config parameter
#include "Marlon_Sub_GRule.h"         // table config parameter
#include "Marlon_Sub_Ex.h"            // table config parameter
*/
...
//Here must be the same order as MST_GRule_Index_Main_Color
//add samll qmap GRule IP here and add table in MDrv_PQ_Set_DisplayType_Main()
...
#if ENABLE_PQ_CUSTOMER_MAIN_GRULE
DECLARE_PQ_FUNCTIONS(MAINCOLOR)    // table config parameter

#include "Marlon_Main_Color.h"       // table config parameter
#include "Marlon_Main_Color_GRule.h" // table config parameter
#endif
