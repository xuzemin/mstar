...
#define PQ_GRULE_RULE_NUM_Main 6
...
#if PQ_GRULE_OSD_BW_ENABLE
#define PQ_GRULE_OSD_BW_IP_NUM_Main 8
...
#if PQ_GRULE_NR_ENABLE
extern code U8 MST_GRule_1920_32M_NR_Main[PQ_GRULE_NR_LVL_NUM_Main];
#endif
#if PQ_GRULE_OSD_BW_ENABLE
extern code U8 MST_GRule_1920_32M_OSD_BW_Main[PQ_GRULE_OSD_BW_LVL_NUM_Main];
#endif
#if PQ_GRULE_MPEG_NR_ENABLE
extern code U8 MST_GRule_1920_32M_MPEG_NR_Main[PQ_GRULE_MPEG_NR_LVL_NUM_Main];
#endif
#if PQ_GRULE_FILM_MODE_ENABLE
extern code U8 MST_GRule_1920_32M_FILM_MODE_Main[PQ_GRULE_FILM_MODE_LVL_NUM_Main];
#endif
#if PQ_GRULE_DYNAMIC_CONTRAST_ENABLE
extern code U8 MST_GRule_1920_32M_DYNAMIC_CONTRAST_Main[PQ_GRULE_DYNAMIC_CONTRAST_LVL_NUM_Main];
#endif
#if PQ_GRULE_PTP_ENABLE
extern code U8 MST_GRule_1920_32M_PTP_Main[PQ_GRULE_PTP_LVL_NUM_Main];
#endif
...
#if PQ_GRULE_NR_ENABLE
extern code U8 MST_GRule_1366_32M_NR_Main[PQ_GRULE_NR_LVL_NUM_Main];
#endif
#if PQ_GRULE_OSD_BW_ENABLE
extern code U8 MST_GRule_1366_32M_OSD_BW_Main[PQ_GRULE_OSD_BW_LVL_NUM_Main];
#endif
#if PQ_GRULE_MPEG_NR_ENABLE
extern code U8 MST_GRule_1366_32M_MPEG_NR_Main[PQ_GRULE_MPEG_NR_LVL_NUM_Main];
#endif
#if PQ_GRULE_FILM_MODE_ENABLE
extern code U8 MST_GRule_1366_32M_FILM_MODE_Main[PQ_GRULE_FILM_MODE_LVL_NUM_Main];
#endif
#if PQ_GRULE_DYNAMIC_CONTRAST_ENABLE
extern code U8 MST_GRule_1366_32M_DYNAMIC_CONTRAST_Main[PQ_GRULE_DYNAMIC_CONTRAST_LVL_NUM_Main];
#endif
#if PQ_GRULE_PTP_ENABLE
extern code U8 MST_GRule_1366_32M_PTP_Main[PQ_GRULE_PTP_LVL_NUM_Main];
#endif
