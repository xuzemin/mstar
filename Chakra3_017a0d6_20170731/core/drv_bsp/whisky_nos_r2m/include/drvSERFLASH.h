...
typedef MS_BOOL (*ms_Flash_FreeResource_CB)(MS_U8 u8SemID, MS_U16 u16ResId);
//-------------------------------------------------------------------------------------------------
//  Function and Variable
//-------------------------------------------------------------------------------------------------

DLL_PUBLIC void MDrv_FLASH_Assign_FlashType(E_SPI_DrvDeviceID  DrvFlashType);
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function \b Name: MDrv_SERFLASH_Low_WriteStatus()
/// @brief \b Function \b Description: This function is used to lower Write Status
/// @param <IN>        \b bLowWriteStatus    : Enable for Lower WriteStatus (Optional) Disable (Default)
/// @param <OUT>       \b NONE    :
/// @param <RET>       \b NONE
/// @param <GLOBAL>    \b NONE    :
/// @param <NOTE>    \b : _bLowMode make System descrease Write Status command
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC void MDrv_SERFLASH_Low_WriteStatus(MS_BOOL bLowWriteStatus);
...
#endif
DLL_PUBLIC MS_BOOL MDrv_SERFLASH_General_Access(MS_U16 writecnt, MS_U8 *writebuffer,  MS_U16 readcnt, MS_U8 *readbuffer);
...
extern ms_Flash_FreeResource_CB FlashFreeResourceCB;
#ifdef __cplusplus
}
#endif
