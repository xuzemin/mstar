...
DLL_PUBLIC void    MApi_AUDIO_DigitalOut_SetDeviceCapability(DIGITAL_OUTPUT_TYPE ePath, AUDIO_FORMAT_CODE eType, Digital_Out_Device_Capability_t *p_codecCapability);
