...
#ifndef __MSAPI_MLE_GRAPHIC_H__
#define __MSAPI_MLE_GRAPHIC_H__
 ...
 * 
 */
void msAPI_MLE_makeRect(Rect_t *, S32, S32, S32, S32);
#define MakeRect(pDst, _X, _Y, _W, _H)  msAPI_MLE_makeRect((pDst), (_X), (_Y), (_W), (_H));
