...
//=======================================
/// structure for Audio analog HW control
typedef enum
{
    E_GAIN_0dB ,        /// Gain = 0dB
    E_GAIN_N18dB ,     /// Gain = -18dB
    E_GAIN_N15dB ,     /// Gain = -15dB
    E_GAIN_N12dB ,     /// Gain = -12dB
    E_GAIN_N9dB ,      /// Gain = -9dB
    E_GAIN_N6dB ,      /// Gain = -6dB
    E_GAIN_N3dB ,      /// Gain = -3dB
    E_GAIN_P3dB ,      /// Gain = +3dB
    E_GAIN_P6dB ,      /// Gain = +6dB
    E_GAIN_P9dB ,      /// Gain = +9dB
    E_GAIN_P12dB ,      /// Gain = +12dB
    E_GAIN_P15dB ,      /// Gain = +15dB
    E_GAIN_P18dB ,      /// Gain = +18dB
    E_GAIN_P21dB ,      /// Gain = +21dB
} Analog_Gain_Type;

typedef struct
{
    MS_BOOL bEnSwap;                      /// 1: Swap L & R channel
    Analog_Gain_Type eGain;      /// ADC Gain setting
} LineInConfig_t;
...
typedef struct
{
    LineInConfig_t     LineIn[6];     /// LineIn[5:0]
    LineInConfig_t     MicIn;           /// Microphone in
    LineOutConfig_t   LineOut[4];   /// LineOut[3:0] , HP ==> LineOut[1]
} AnalogConfig_t;
