#ifndef _LED_PQ_SHARP_70INCH_DIRECT_120_C_
#define _LED_PQ_SHARP_70INCH_DIRECT_120_C_

#include "compen/Tbl_LD_Compensation_Gamma22.c"
#include "edge2d/Tbl_LD_Edge2D_SHARP70inch_Direct120.c"
#include "gamma/Tbl_LD_Gamma_SHARP70inch_Direct120.c"

StuDrvLdPQInfo s_DrvLdPQInfo_SHARP70 =
{
    HAL_LD_EDGE_TB_TYPE, // EnuLD_LED_TYPE eLEDType;

    // PANEL
    24, 48, // U8 u8LDFWidth, u8LDFHeight; // Statistic width & height  24,24,//
    12, 1, // U8 u8LEDWidth, u8LEDHeight; // LED width & height
    ...
    Tbl_LD_Edge2D_SHARP70inch_Direct120, // const U8* pu8Edge2DTable; // Edge2D table  SIZE=(u8LEDWidth*u8LEDHeight)*(u8LDFWidth*u8LDFHeight)
