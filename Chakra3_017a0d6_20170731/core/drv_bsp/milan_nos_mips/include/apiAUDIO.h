...
DLL_PUBLIC void    MApi_AUDIO_SIF_SetThreshold(THR_TBL_TYPE *ThrTbl);
...
DLL_PUBLIC MS_BOOL MApi_AUDIO_SPDIF_GetMute_Status(void);
...
DLL_PUBLIC MS_BOOL MApi_AUDIO_DigitalOut_SetDeviceCapability(DIGITAL_OUTPUT_TYPE eoutType, AUDIO_FORMAT_CODE ecodecType, Digital_Out_Device_Capability_t *p_codecCapability);
...
AUDIO_DSP_CODE_TYPE MApi_AUDIO_ReadDspCodeType(void);
