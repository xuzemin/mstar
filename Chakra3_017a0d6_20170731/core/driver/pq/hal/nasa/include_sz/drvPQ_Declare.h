...
/*
#include "Euler_Main.h"              // table config parameter
#include "Euler_Main_HSDRule.h"      // table config parameter
#include "Euler_Main_VSDRule.h"      // table config parameter
#include "Euler_Main_HSPRule.h"      // table config parameter
#include "Euler_Main_VSPRule.h"      // table config parameter
#include "Euler_Main_CSCRule.h"      // table config parameter
#include "Euler_Main_GRule.h"        // table config parameter
#include "Euler_Main_Ex.h"           // table config parameter
*/
/*#include "Euler_Sub.h"               // table config parameter
#include "Euler_Sub_HSDRule.h"       // table config parameter
#include "Euler_Sub_VSDRule.h"       // table config parameter
#include "Euler_Sub_HSPRule.h"       // table config parameter
#include "Euler_Sub_VSPRule.h"       // table config parameter
#include "Euler_Sub_CSCRule.h"       // table config parameter
#include "Euler_Sub_GRule.h"         // table config parameter
#include "Euler_Sub_Ex.h"            // table config parameter
*/
...
DECLARE_PQ_FUNCTIONS(SUBCOLOR)      // table config parameter
#endif

 //for customer Main PQ support Grule
#if ENABLE_PQ_CUSTOMER_MAIN_GRULE
#include "6180_Main_Color.h"       // table config parameter
#include "6180_Main_Color_GRule.h" // table config parameter
#endif

 //for customer Sub PQ support Grule
#if ENABLE_PQ_CUSTOMER_SUB_GRULE
#if PQ_ENABLE_PIP
#include "6180_Sub_Color.h"       // table config parameter
#endif
#endif
