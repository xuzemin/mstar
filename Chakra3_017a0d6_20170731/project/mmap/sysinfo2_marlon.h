...
//------------------------------------------------------------------------------
    ...
    //#include "MMAP_DTVMM_MARLON_128_MIPS_ALL.h"
    #include MMAP_FILE
...
#if(MHEG5_ENABLE)
 #if( (MHEG5_JPEG_ADR + MHEG5_JPEG_LEN) >= EVENTDB_SDRAM_ADR )
    #error "MHEG buffer is overlay with EVENTDB_SDRAM_ADR"
 #endif
#endif

#elif (MEMORY_MAP == MMAP_64MB)
    //#include "MMAP_DTVMM_MARLON_64_MIPS_ALL.h"
    #include MMAP_FILE

    #if SUBTITLE_MM_ADR != SCALER_DNR_BUF_PREV_ADR
    #error "Error! SUBTITLE_MM_ADR != SCALER_DNR_BUF_PREV_ADR"
    #endif
	...
	#include "MIUSEL_MARLON_MIU.h"

// Check
#if( ENABLE_MIU_1 )
    #error "Marlon has no MIU1"
#endif
