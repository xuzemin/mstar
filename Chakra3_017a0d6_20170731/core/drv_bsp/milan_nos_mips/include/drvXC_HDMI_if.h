...
typedef enum
{
    E_PACKAGE_TYPE_QFP128_FHD = 0,
    E_PACKAGE_TYPE_QFP156_P2P,
    E_PACKAGE_TYPE_QFP156_UHD,
    E_PACKAGE_TYPE_QFP156_H5BN2,
	E_PACKAGE_TYPE_QFP176_UHD,
} E_PACKAGE_TYPE;
...
//HDMI
DLL_PUBLIC INTERFACE void Mdrv_HDMI_SetPackageType(E_PACKAGE_TYPE ucPackageType);
...
DLL_PUBLIC INTERFACE void MDrv_HDMI_Switch_YUV422to444(MS_BOOL btrue);
...
DLL_PUBLIC INTERFACE void MDrv_HDMI_StablePolling(void);
//#endif
DLL_PUBLIC INTERFACE MS_BOOL MDrv_HDMI_GetDEStableStatus(E_MUX_INPUTPORT enInputPortType);
DLL_PUBLIC INTERFACE MS_BOOL MDrv_HDMI_GetHDRMetaData(sHDR_METADATA *pstHDRMetadata);
