...
// (!!!OMStar Confidential Information!!L) by the recipient.
...
//
// File Name: PNL_CMO216H1_L01_HD.h
...
#ifndef __CMO216H1_L01_HD_H
#define __CMO216H1_L01_HD_H

///////////////////////////////////////////////
// Common setting
///////////////////////////////////////////////
#define PANEL_NAME      "CMO216H1_L01_HD"
#define PANEL_DOT_WIDTH     248       // unit: um
#define PANEL_DOT_HEIGHT    248       // unit: um
...
#define PANEL_DUAL_PORT       _PNL_FUNC_EN_
...
#define PANEL_ON_TIMING1          60// 080202_kimhw_02 -- lee jun hyung. 10  // time between panel & data while turn on power
#define PANEL_ON_TIMING2          600 // time between data & back light while turn on power
#define PANEL_OFF_TIMING1         300  // time between back light & data while turn off power
#define PANEL_OFF_TIMING2         30// 080202_kimhw_02 -- lee jun hyung. 10  // time between data & panel while turn off power

#define PANEL_HSYNC_WIDTH         32
#define PANEL_HSYNC_BACK_PORCH    80

#define PANEL_VSYNC_WIDTH         8
#define PANEL_VSYNC_BACK_PORCH    12 // 16
...
#define PANEL_HTOTAL_ADJ_FOR_OSD_FULL_SCREEN    (30) //(0)

//lachesis just for compile
#define PANEL_MAX_HTOTAL         PANEL_HTOTAL+160  //=2400     //2360
#define PANEL_HTOTAL             1040*2 + 80*2     //=2240     //2200
#define PANEL_MIN_HTOTAL         PANEL_HTOTAL -180 //=2060     //2020

#define PANEL_MAX_VTOTAL         PANEL_VTOTAL+70   //=1189       //1200
#define PANEL_VTOTAL             1080+20+19        //=1119       //1130
#define PANEL_MIN_VTOTAL         PANEL_VTOTAL-30   //=1089         //1090

#define PANEL_MIN_DCLK           58*2 // 50
#define PANEL_DCLK               (((U32)PANEL_HTOTAL*PANEL_VTOTAL*60)/1000000)
#define PANEL_MAX_DCLK           85*2 // 83

#define PANEL_OUT_VFREQ_MIN      50 // 40   // min.
#define PANEL_OUT_VFREQ_TYPICAL  60       //typical
#define PANEL_OUT_VFREQ_MAX      75 // 63   // max.
...
//LACHESIS_070605
#define SSC_LVDS_USE                ENABLE
#define SSC_MIU_USE                    ENABLE
#define SSC_SPAN_PERIOD                350
#define SSC_STEP_PERCENT            100

//#define ENABLE_VDIM
#define PANEL_DIMMING_CTL_MIN            0x00
//lachesis_070717
#define PANEL_DIMMING_CTL                0x7D
#define PANEL_DIMMING_CTL_STOREMODE     0x7D
#define PANEL_MAX_PWM_DIM                0xFF // 080103_kimhw_02 // 080102_kimhw_01 0x40
#define PANEL_MIN_PWM_DIM                0x20//0x00//20080319_PARKYS_3 : DFC  0x0C // 080107_kimhw_01 0x17 // 080102_kimhw_01 0x00
