...
#define PQ_ENABLE_FPLL_THRESH_MODE  FALSE
...
#define PQ_FILM_DRIVER_VER      1

//osd bw ver 1: One ddr, or two ddr
//osd bw ver 2: ddr2 or ddr3, mirror or non-mirror
#define PQ_OSD_BW_VER       1   // 2
#define PQ_DDR_SELECT_VER   2
