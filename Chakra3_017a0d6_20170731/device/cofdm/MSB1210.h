...
#define     DEMOD_DYNAMIC_SLAVE_ID_MSB_1210_1          0x32
#define     DEMOD_DYNAMIC_SLAVE_ID_MSB_1210_2          0x72
#define     DEMOD_DYNAMIC_SLAVE_ID_MSB_1210_3          0xB2
#define     DEMOD_DYNAMIC_SLAVE_ID_MSB_1210_4          0xF2
...
#define MSB1210_IIC_CONTROL                 0x8400
#define MSB1210_IIC_SCL_CLK                 0x8401
#define MSB1210_IIC_READ_DATA               0x8402
#define MSB1210_IIC_STATUS                  0x8403
#define MSB1210_IIC_WRITE_DATA              0x8404
...
#define MSB1210_REG_INVERSION              0x8024
#define BOOL    BOOLEAN

#if  DTV_SCAN_AUTO_FINE_TUNE_ENABLE
    //MSB1210 Capture Range fix to 500K
...
//--------------------------------------------------------------------
EXTSEL BOOLEAN MSB1210_Reset ( void );
EXTSEL BOOLEAN MSB1210_Active(BOOLEAN bEnable);
EXTSEL BOOLEAN MSB1210_Cmd_Packet_Send(S_CMDPKTREG* pCmdPacket, U8 param_cnt);
EXTSEL BOOLEAN MSB1210_Get_TPS_Parameter_Const( WORD * TSP_parameter);
