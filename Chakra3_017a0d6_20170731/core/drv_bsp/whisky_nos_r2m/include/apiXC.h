...
//-------------------------------------------------------------------------------------------------
/// Un freeze Refrigerator by Timer
//-------------------------------------------------------------------------------------------------
void MApi_SC_UnFreezeByTimer(void);


//-------------------------------------------------------------------------------------------------
/// Set XC freeze Refrigerator function
/// @return TRUE if it is success, FALSE if it is fail
//-------------------------------------------------------------------------------------------------
MS_BOOL MApi_SC_FastSetFreeze(void);
...
// test pattern patch start
//-------------------------------------------------------------------------------------------------
/// To set YUV to RGB Bypass,you should follow the following example
/// Ex:
/// bEnable = TRUE;
/// MApi_XC_SetYUVTORGBBypass(TRUE);
/// you can bypass YUV to RGB and set FALSE to disable YUVTORGBBypass
//-------------------------------------------------------------------------------------------------
void  MApi_XC_SetYUVTORGBBypass(MS_BOOL bEnable);
//-------------------------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------------------
/// Enable 2 frame mirror  mode
/// @param  bEnable                \b IN: True: Enable 2 frame mirror mode.
/// @eWindow                 \b IN: The window (main or sub) which need to be controled.
/// @return @ref E_APIXC_ReturnValue          TRUE: eWindow is in 2 frame mirror mode.  FALSE: eWindow is not in auto no signal mode
//-------------------------------------------------------------------------------------------------
E_APIXC_ReturnValue MApi_XC_Enable2FrameMirror(MS_BOOL bEnable, SCALER_WIN eWindow );
