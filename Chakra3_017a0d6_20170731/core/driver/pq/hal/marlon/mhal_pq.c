...
//  Global Variables
//-------------------------------------------------------------------------------------------------
#if 0//MARLON : fix compiling error
...
MS_U16 Hal_PQ_get_madi_idx(MS_BOOL bMainWin, MS_MADI_TYPE etype)
{
    ...
    switch(etype)
    {
        ...
        case MS_MADI_25_6F_4R_MC_Yonly:
            u16ret = PQ_IP_MADi_25_6F_4R_MC_Yonly_Main;
            break;

        case MS_MADI_25_8F_4R_MC_Yonly:
            u16ret = PQ_IP_MADi_25_8F_4R_MC_Yonly_Main;
            break;
...
MS_U8 Hal_PQ_get_madi_fbl_mode(MS_BOOL bMemFmt422,MS_BOOL bInterlace)
{
    ...
    if(bMemFmt422)
    {
        return MS_MADI_P_MODE_MOT10_NO_DNR;
    }
    else
    {
