...
#endif
#define NXP18275_I2C_ADDR (((U16)TUNER_IIC_BUS<<8)| _TUNER_I2C_ID)
...
UInt32 ReadLen, UInt8* pData)
{
    ...
    UNUSED(tUnit);
    if(MDrv_IIC_ReadBytes(NXP18275_I2C_ADDR, (U8) AddrSize, pAddr, (U16) ReadLen, pData))
	{
	    err = TM_OK;
	/*
...
UInt32 WriteLen, UInt8* pData)
{
	...
	printf("\n");
	*/
    if(MDrv_IIC_WriteBytes(NXP18275_I2C_ADDR, (U8) AddrSize, pAddr, (U16) WriteLen, pData))
    {
	    err = TM_OK;
    }
    else 
