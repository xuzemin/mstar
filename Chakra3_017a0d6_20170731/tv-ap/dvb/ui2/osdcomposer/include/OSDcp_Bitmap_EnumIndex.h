...
//NOTE: modify for ZUI...
    ...
    #include "../../res960x540x565/osdcomposer/include/ZUI_bitmap_EnumIndex.h"
#elif (UI_SKIN_SEL==UI_SKIN_960X540XI8)
#include "../../res960x540xI8/osdcomposer/include/ZUI_bitmap_EnumIndex.h"
#elif (UI_SKIN_SEL==UI_SKIN_1920X1080X565)
#include "../../res1920x1080x565/osdcomposer/include/ZUI_bitmap_EnumIndex.h"
#else
