...
**
**  Parameters:    	
**					DeviceAddr	- MxL Tuner Device address
...
{	
	if(MDrv_IIC_WriteBytes((U16)(MxL_I2CBUS_ADDR|(DeviceAddr<<1)), 0, NULL, (U16) count, pArray))
	return MxL_OK;	
	else
...
UINT32 MxL_I2C_Read(UINT8 DeviceAddr, UINT8 Addr, UINT8* mData)
{
	UINT8 u8addr=0xFB;
      ...
      if(!MDrv_IIC_WriteBytes((U16)(MxL_I2CBUS_ADDR|(DeviceAddr<<1)),1, &u8addr,1,&Addr))	
		return MxL_ERR_GET_REG;	
	if(MDrv_IIC_ReadBytes((U16)(MxL_I2CBUS_ADDR|(DeviceAddr<<1)),0,NULL,1,mData))
		return MxL_OK;
