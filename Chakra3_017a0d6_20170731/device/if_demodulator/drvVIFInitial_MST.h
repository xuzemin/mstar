...
#if (CHIP_FAMILY_TYPE == CHIP_FAMILY_EULER)     // Euler
...
#elif (CHIP_FAMILY_TYPE == CHIP_FAMILY_MARLON)    // Marlon
    #include "drvVIFInitial_MST_MARLON.h"

#elif (CHIP_FAMILY_TYPE == CHIP_FAMILY_MAZDA)    // Mazda
    #include "drvVIFInitial_MST_MAZDA.h"
