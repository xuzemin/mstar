...
#ifndef MAPP_SDT_MONITOR_H
#define MAPP_SDT_MONITOR_H
...
#if(ENABLE_DTV_CERTIFICATION_TNT)
    #define SDT_AUTO_CHANGE_CH_TO_ORIGINAL  1
#else
    #define SDT_AUTO_CHANGE_CH_TO_ORIGINAL  0
#endif
...
#if ENABLE_SDT_OTHER_MONITOR
    extern U32 g_SDT_u32CheckMovServieTimer;
#endif
