...
enum MS_HDMI_AUDIO_MUTE_EVENT
{
    MS_HDMI_MUTE_EVENT_DISABLE              = 0x0000,    ///< Disable mute event
    MS_HDMI_MUTE_EVENT_CTSN_OVER_RANGE      = 0x0001,    ///< HDMI CTS/N over limited range
    MS_HDMI_MUTE_EVENT_CLK_BIG_CHANGE       = 0x0002,    ///< HDMI video clock frequency big change
    MS_HDMI_MUTE_EVENT_AVMUTE               = 0x0004,    ///< AVMute
    MS_HDMI_MUTE_EVENT_NO_INPUT             = 0x0008,    ///< hdmi no input
    MS_HDMI_MUTE_EVENT_AUD_SAMPLE_FLAT      = 0x0010,    ///< audio sample with flat bit
};
...
typedef enum
{
    E_PACKAGE_TYPE_QFP156 = 0,
    E_PACKAGE_TYPE_QFP128,
    E_PACKAGE_TYPE_QFP80,
} E_PACKAGE_TYPE;
...
//HDMI
INTERFACE void Mdrv_HDMI_SetPackageType(E_PACKAGE_TYPE ucPackageType);
...
INTERFACE void MDrv_HDMI_Switch_YUV422to444(MS_BOOL btrue);
...
INTERFACE MS_BOOL MDrv_HDMI_CheckHDCP14(void);
