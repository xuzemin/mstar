...
* File  : device_tuner_si_2190.h
**********************************************************************/

#ifndef __SILAB_2190_H__
#define __SILAB_2190_H__

#ifdef __SILAB_2190_C__
#define INTERFACE
#else
...
#define C_Si2190_IF_FREQUENCY          ((U16)  6000)  /* kHz */

// Digital IF
#define QAM_6M     C_Si2190_IF_FREQUENCY
#define QAM_8M     C_Si2190_IF_FREQUENCY
#define ATSC_6M    C_Si2190_IF_FREQUENCY
#define ISDBT_6M   C_Si2190_IF_FREQUENCY
#define DVBT_1p7M  C_Si2190_IF_FREQUENCY
#define DVBT_6M    C_Si2190_IF_FREQUENCY
#define DVBT_7M    C_Si2190_IF_FREQUENCY
#define DVBT_8M    C_Si2190_IF_FREQUENCY
#define DVBT_10M   C_Si2190_IF_FREQUENCY
#define DMBT_8M    C_Si2190_IF_FREQUENCY
...
#define UHF_MAX_FREQ                887250L    // KHz
...
INTERFACE void devTuner_SetFineTune(S8 step);
INTERFACE S8 devTuner_GetFineTune(void);

#undef INTERFACE

#if 0
class device_tuner_si_2190 : public mapi_tuner
{
private:
