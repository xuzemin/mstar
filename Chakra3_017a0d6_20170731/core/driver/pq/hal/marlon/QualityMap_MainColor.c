...
#include "Marlon_Main_Color.c"                  // table config parameter
#include "Marlon_Main_Color_1920.c"             // table config parameter

#include "Marlon_Main_Color_GRule.c"            // table config parameter
#include "Marlon_Main_Color_1920_GRule.c"       // table config parameter
#endif
