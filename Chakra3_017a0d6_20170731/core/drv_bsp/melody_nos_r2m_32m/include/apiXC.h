...
#define PANEL_INFO_EX_VERSION                          3
...
#define PANEL_INFO_EX_LIMITATION_SETTING  0xFFFE
//-------------------------------------------------------------------------------------------------
//  Type and Structure
//-------------------------------------------------------------------------------------------------
...
typedef struct
{
    ...
    MS_U16  u16VSyncStartPoint;
    MS_BOOL   bVSyncStartPointValid;
    MS_U16  u16VSyncEndPoint;
    MS_BOOL   bVSyncEndPointValid;
    MS_U16  u16HDE_FrontDummyPixels;
    MS_BOOL   bHDE_FrontDummyPixelsValid;
    MS_U16  u16HDE_RearDummyPixels;
    MS_BOOL   bHDE_RearDummyPixelsValid;
    MS_U16  u16VDE_FrontDummyLines;
    MS_BOOL   bVDE_FrontDummyLinesValid;
    MS_U16  u16VDE_RearDummyLines;
    MS_BOOL   bVDE_RearDummyLinesValid;
    MS_U16  u16Htt_EvenWhenDividedByPair;
    MS_BOOL   bHtt_EvenWhenDividedByPairValid;
    MS_U16  u16HDE_EvenWhenDividedByPair;
    MS_BOOL   bHDE_EvenWhenDividedByPairValid;
    MS_U16  u16VTT_OddWhenDividedByNum;
    MS_BOOL   bVTT_OddWhenDividedByNumValid;
}XC_PANEL_INFO_EX;
...
//-------------------------------------------------------------------------------------------------
/// MApi_XC_Set_FixCustomizedVBackPorch
/// @param  bEnable               \b IN: Enable Fixed Vbackporch property
/// @param  u16vbackporch      \b IN: VbackPorch alue, sould not be ZERO
//-------------------------------------------------------------------------------------------------
MS_BOOL MApi_XC_SetFixedCustomizedVBackPorch(MS_BOOL bEnable, MS_U16 u16VBackPorch);
...
void MApi_XC_EnablePixelShift(MS_BOOL bEnable, MS_U16 u16HPixelShiftRange, MS_U16 u16VPixelShiftRange);
void MApi_XC_SetHPixelShiftNum(MS_S16 s16HPSNum);
void MApi_XC_SetVPixelShiftNum(MS_S16 s16VPSNum);
