...
//    Not Used                            = E_INT_FIQ_0xF0_START + 10,
    ...
    E_INT_IRQ_EVD                        = E_INT_FIQ_0x100_START + 0,
    E_INT_IRQ_SHA_RSA                    = E_INT_FIQ_0x100_START + 1,
    E_INT_IRQ_SCDC_INT_PM                = E_INT_FIQ_0x100_START + 2,
    E_INT_IRQ_PAS_PTS_COMBINE            = E_INT_FIQ_0x100_START + 3,
    E_INT_IRQ_DISP_FE                    = E_INT_FIQ_0x100_START + 4,
    E_INT_IRQ_D2B                        = E_INT_FIQ_0x100_START + 5,
    E_INT_IRQ_LDM_DMA_DONE1              = E_INT_FIQ_0x100_START + 6,
    E_INT_IRQ_MHL_CBUS                   = E_INT_FIQ_0x100_START + 7,
    E_INT_IRQ_SECU_ERROR_RESP            = E_INT_FIQ_0x100_START + 8,
    E_INT_IRQ_AESDMA                     = E_INT_FIQ_0x100_START + 9,
    E_INT_FIQ_R2TOMCU_INT2               = E_INT_FIQ_0x100_START + 10,
    E_INT_FIQ_R2TOMCU_INT3               = E_INT_FIQ_0x100_START + 11,
    E_INT_FIQ_VE_VBI_F0                  = E_INT_FIQ_0x100_START + 12,
    E_INT_FIQ_VE_VBI_F1                  = E_INT_FIQ_0x100_START + 13,
    E_INT_FIQ_IN                         = E_INT_FIQ_0x100_START + 14,
    E_INT_FIQ_DIV_CK_DET                 = E_INT_FIQ_0x100_START + 15,
	E_INT_FIQ_0x100_END                  = 0x10F,

	E_INT_FIQ_0x110_START                = 0x110,
	E_INT_FIQ_HST0TO1                    = E_INT_FIQ_0x110_START + 0,
	E_INT_FIQ_HST0TO2                    = E_INT_FIQ_0x110_START + 1,
	E_INT_FIQ_HST0TO3                    = E_INT_FIQ_0x110_START + 2,
	E_INT_FIQ_HST1TO0                    = E_INT_FIQ_0x110_START + 3,
	E_INT_FIQ_HST1TO2                    = E_INT_FIQ_0x110_START + 4,
	E_INT_FIQ_HST1TO3                    = E_INT_FIQ_0x110_START + 5,
	E_INT_FIQ_HST2TO0                    = E_INT_FIQ_0x110_START + 6,
	E_INT_FIQ_HST2TO1                    = E_INT_FIQ_0x110_START + 7,
	E_INT_FIQ_HST2TO3                    = E_INT_FIQ_0x110_START + 8,
	E_INT_FIQ_HST3TO0                    = E_INT_FIQ_0x110_START + 9,
	E_INT_FIQ_HST3TO1                    = E_INT_FIQ_0x110_START + 10,
	E_INT_FIQ_HST3TO2                    = E_INT_FIQ_0x110_START + 11,
	E_INT_FIQ_SECU_XIU_TIME_OUT          = E_INT_FIQ_0x110_START + 12,
	E_INT_IRQ_MHL_ECBUS_INT              = E_INT_FIQ_0x110_START + 13,
