...
#ifndef __AU315_T315HW02_HD_H
#define __AU315_T315HW02_HD_H

///////////////////////////////////////////////
// Common setting
///////////////////////////////////////////////
#define PANEL_NAME      "AU32 T315HW02 HD"
...
#define PANEL_ON_TIMING2          200 // time between data & back light while turn on power
#define PANEL_OFF_TIMING1         200  // time between back light & data while turn off power
...
#define PANEL_VSYNC_BACK_PORCH    16
...
#define PANEL_HTOTAL             2200
#define PANEL_VTOTAL             1125

#define PANEL_MAX_HTOTAL         2600
#define PANEL_MIN_HTOTAL         2060
#define PANEL_MAX_VTOTAL         1480
...
#define SSC_STEP_PERCENT        300

#define PANEL_DIMMING_CTL       0x6D
#define PANEL_MAX_PWM_DIM       0x1B0//0xDD
#define PANEL_MIN_PWM_DIM       0x20

//------------------------------------------------------------------------------
// GAMMA
//------------------------------------------------------------------------------
#define GAMMA_LUT_12BIT         ENABLE
