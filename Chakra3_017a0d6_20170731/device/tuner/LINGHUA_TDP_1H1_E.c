...
#ifndef LINGHUA_TDP_1H1_E_C
#define LINGHUA_TDP_1H1_E_C
...
#define DIVIDER_RATIO_50KHz     0x00//0x04 //0x00
...
void devTunerSetPLLData(WORD wPLLData, RFBAND eBand)
{
    ...
    cTunerData[2] = 0xCE;  // 0xce;
    #elif ( TN_FREQ_STEP == FREQ_STEP_31_25KHz )
    cTunerData[2] = 0xCA;  //0xca;
    #else  //default 50Khz
    cTunerData[2] = 0xC8 | DIVIDER_RATIO;  //0xC8;
    #endif
    ...
    if(devCOFDM_PassThroughI2C_WriteBytes(_TUNER_I2C_ID, 0, NULL, 4, cTunerData) == FALSE)
    	printf("\t >>Write Tuner IIC Failed\n");
}
...
#endif  //end of LINGHUA_TDP_1H1_E_C
