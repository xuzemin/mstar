#ifndef _LED_PQ_INNO_65INCH_2X8_C_
#define _LED_PQ_INNO_65INCH_2X8_C_
...
StuDrvLdPQInfo s_DrvLdPQInfo_INNO65_2X8 =
{
    ...
    2, 8, // U8 u8LEDWidth, u8LEDHeight; // LED width & height
    2, 8, // U8 u8LSFWidth, u8LSFHeight; // LSF width & height
