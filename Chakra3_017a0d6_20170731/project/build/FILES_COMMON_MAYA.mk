...
#ifeq ($(CHIP_FAMILY),MAYA)
    PQDIR ?= maya
#endif

#include  device/mhl/MHL.mk
...
DRV_FILES += \
        ...
        $(ROOT)/core/driver/pq/hal/$(PQDIR)/QualityMap_MainColor.c          \
        $(ROOT)/core/driver/pq/hal/$(PQDIR)/mhal_pq.c                       \
        $(ROOT)/core/driver/pq/hal/$(PQDIR)/mhal_pq_adaptive.c		        \
        $(ROOT)/core/api/SecurityR2/core/SecurityR2_Init.c                  \
        $(ROOT)/core/api/SecurityR2/core/hal/$(chip_name)/SecurityR2_App.c  \
        $(ROOT)/core/api/SecurityR2/msAPI_SecurityR2.c                      \
        $(ROOT)/core/api/SecurityR2/HDCP22/mhal_combo.c                     \
        $(ROOT)/core/api/SecurityR2/HDCP22/mhal_tmds.c                      \
        $(ROOT)/core/api/SecurityR2/HDCP22/drvHDCPMbx.c                     \
        $(ROOT)/core/api/SecurityR2/HDCP22/drvHDCPRx.c                      \
        $(ROOT)/core/api/SecurityR2/HDCP22/mapi_combo.c                     \
        $(ROOT)/core/api/SecurityR2/HDCP22/mapi_tmds.c                      \
        $(ROOT)/core/api/SecurityR2/HDCP22/mdrv_combo.c                     \
        $(ROOT)/core/api/SecurityR2/HDCP22/mdrv_tmds.c          
...
INC_DIR  += \
        ...
        -I$(ROOT)/core/driver/pq/hal/$(PQDIR)/include/small_qmap        \
        -I$(ROOT)/core/api/SecurityR2/core                    		    \
        -I$(ROOT)/core/api/SecurityR2/core/hal/$(chip_name)             \
        -I$(ROOT)/core/api/SecurityR2/HDCP22 						    \
        -I$(ROOT)/core/api/SecurityR2
...
ifneq ($(BUILD_TARGET),BLOADER_SYSTEM)
  ...
  LD_FILES = \
    $(ROOT)/core/api/LD/msAPI_LD.c                  \
    $(ROOT)/core/api/LD/msAPI_LD_PWM.c              \
    $(ROOT)/core/api/LD/LedDevice/leddevice.c       \
    $(ROOT)/core/api/LD/LD_Drv/mdrv_ld.c            \
    $(ROOT)/core/api/LD/LD_Drv/mdrv_ldalgo.c        \
    $(ROOT)/core/api/LD/LD_Drv/mdrv_ldm_dma.c       \
    $(ROOT)/core/api/LD/LD_Drv/mdrv_mfc_spi.c       \
    $(ROOT)/core/api/LD/LD_Drv/mhal_ld.c            \
    


  LD_INC = \
    -I$(ROOT)/core/api/LD/            \
    -I$(ROOT)/core/api/LD/LD_Drv      \
    -I$(ROOT)/core/api/LD/LedDevice   \
...
UTIL_FILES += $(ROOT)/core/api/utl/Utl.c                         
...
LINT_INC  += \
          ...
          $(ROOT)/core/api/SecurityR2/core/hal/$(chip_name)     \
          $(ROOT)/core/api/SecurityR2/HDCP22					\
          $(ROOT)/core/api/SecurityR2
