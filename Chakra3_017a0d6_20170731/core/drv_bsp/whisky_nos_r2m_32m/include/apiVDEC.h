...
typedef enum
{
    ...
    VDEC_USER_CMD_RM_FORCE_MCU_MODE_ES,             // Param: 0(Disable), 1(Enable) //johnny.ko
    VDEC_USER_CMD_PVR_TIMESHIFT_SEAMLESS_MODE,      // Param: 0(disable), 1(pause decode), 2(reset HW), 3(seek to I if target frame not found after resume)
