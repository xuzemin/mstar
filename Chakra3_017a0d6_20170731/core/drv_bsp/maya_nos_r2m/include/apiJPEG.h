...
#endif
 DLL_PUBLIC void MApi_JPEG_EnableOJPD(MS_BOOL bOnOff);
 DLL_PUBLIC JPEG_Result MApi_JPEG_Init_UsingOJPD(JPEG_InitParam *pInitParam);
...
#endif
 DLL_PUBLIC void MApi_JPEG_SetNJPDInstance(MS_U8 JPDNum);    // wrapper only
 DLL_PUBLIC MS_BOOL MApi_JPEG_IsNJPD(void);
