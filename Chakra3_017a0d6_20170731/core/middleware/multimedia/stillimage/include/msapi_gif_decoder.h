...
#ifndef _MSAPI_GIF_DECODER_H_
#define _MSAPI_GIF_DECODER_H_
...
///-----------------------------------------------------------------------------
INTERFACE EN_STILLIMAGE_RET msAPI_GifDecoder_Probe(void);
...
#endif  // #ifndef _MSAPI_GIF_DECODER_H_
