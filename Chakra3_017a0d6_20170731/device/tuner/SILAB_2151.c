...
#include "si2151/Si2151_L2_API.h"               /* Include file for this code */
...
#endif
#include "si2151/Si2151_L2_API.c"
#include "si2151/Si2151_Properties_strings.c"
#include "si2151/Si2151_L1_Properties.c"
#include "si2151/Si2151_L1_API.c"
#include "si2151/Si2151_L1_Commands.c"
#include "si2151/Silabs_L0_Connection.c"
#include "si2151/si2151_i2c_api.c"
#include "si2151/Si2151_User_Properties.c"

#define DBG_TUNER(x)   //x

#define C_Si2151_LO_ADDRESS           ((U8)  0xC0)
#define SILAB_2151_I2C_ADDR (((U16)TUNER_IIC_BUS<<8)| C_Si2151_LO_ADDRESS)
    ...
    )
{
    ...
    if(MDrv_IIC_ReadBytes(SILAB_2151_I2C_ADDR, (U8) subadrlen, subadrptr, (U16) datalen, dataptr) == false)
    {
        bRet = 0;
        printf("\nTuner_IIC read  fail\n");
    }
    ...
    )
{
    ...
    if(MDrv_IIC_WriteBytes(SILAB_2151_I2C_ADDR, (U8) subadrlen, subadrptr, (U16) datalen, dataptr) == false)
    {
        bRet = 0;
        printf("\nTuner_IIC read  fail\n");
    }
