...
{
    /// lock
    E_MSB_1233C_DEMOD_LOCK,
    /// is checking
    E_MSB_1233C_DEMOD_CHECKING,
    /// after checking
    _MSB_1233CE_DEMOD_CHECKEND,
    /// unlock
    E_MSB_1233C_DEMOD_UNLOCK,
    /// NULL state
    E_MSB_1233C_DEMOD_NULL,
} EN_MSB_1233C_LOCK_STATUS;
...
/*@ <Definitions> @*/
	...
	#define DEMOD_DYNAMIC_SLAVE_ID_MSB_1233_1	(((U16)DEMOD_IIC_BUS<<8) | 0xF2)
	#define DEMOD_DYNAMIC_SLAVE_ID_MSB_1233_2	(((U16)DEMOD_IIC_BUS<<8) | 0xA2)
  #elif(CHIP_FAMILY_TYPE == CHIP_FAMILY_EULER)
    #define DEMOD_DYNAMIC_SLAVE_ID_MSB_1233_1    0xD2
    #define DEMOD_DYNAMIC_SLAVE_ID_MSB_1233_2    0xA2
  #else
	#define DEMOD_DYNAMIC_SLAVE_ID_MSB_1233_1	0xD2
	#define DEMOD_DYNAMIC_SLAVE_ID_MSB_1233_2	0xA2
  #endif
...
//    #define DEMOD_DYNAMIC_SLAVE_ID_4    0xF2
    #define DEMOD_SLAVE_ID              DEMOD_DYNAMIC_SLAVE_ID_MSB_1233_1
