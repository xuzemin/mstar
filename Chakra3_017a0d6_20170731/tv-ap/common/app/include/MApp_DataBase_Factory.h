...
#ifndef _MAPP_DATABASE_FACTORY_H
#define _MAPP_DATABASE_FACTORY_H
...
#define MApp_SaveFactorySetting()   MApp_DB_Factory_SaveData()
#define MApp_SaveDesignSetting()    MApp_DB_Factory_SaveData()
