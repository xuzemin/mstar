...
typedef enum _IrCommandType
{
...
#ifdef ENABLE_FME_REMOTE
	IRKEY_POWER 			= 0x4a,
	IRKEY_INPUT_SOURCE		= 0x45,
	IRKEY_MENU				= 0x1e,
	IRKEY_UP				= 0x12, 
	IRKEY_LEFT				= 0x06,
	IRKEY_SELECT			= 0x0e,
    ...
    IRKEY_PICTURE           = 0xD8,//0x40,
    IRKEY_ZOOM              = 0x4C,
    IRKEY_DASH              = 0xD5,//0x0B,
...
#else
    IRKEY_BACKWARD          = 0x02,
    IRKEY_FORWARD           = 0xD3,//0x1E,
    //IRKEY_PLAY              = 0x01,
    IRKEY_RECORD            = 0x0D,
    //IRKEY_STOP              = 0x11,
    IRKEY_PAUSE             = 0xDC,//0x1D,
    ...
    IRKEY_S_CHECK           = 0x5b,
      ...
      IRKEY_MIX               = 0x1C,
    IRKEY_INDEX             = 0xDA,//0x18,
    IRKEY_HOLD              = 0xDB,//0x00,
