...
typedef enum
{
 ...
 DLL_PUBLIC MS_BOOL MApi_VDEC_EX_TEE_GetControl(VDEC_EX_TEE_USER_CMD cmd,void* param);
 DLL_PUBLIC MS_BOOL MApi_VDEC_EX_TEE_SetControl(VDEC_EX_TEE_USER_CMD cmd,void* param);
 DLL_PUBLIC MS_BOOL MApi_VDEC_EX_Create_Tee_System(void);
