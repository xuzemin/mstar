...
void          Si2157_storeUserProperties    (Si2157_PropObj   *prop) {
  ...
  prop->atv_config_if_port.atv_agc_source    = Si2157_ATV_CONFIG_IF_PORT_PROP_ATV_AGC_SOURCE_AGC2_3DB     ; /* (default 'INTERNAL') */
  ...
  prop->atv_lif_out.amp                      =   80; /* (default   100) */
  ...
  prop->dtv_config_if_port.dtv_out_type      = Si2157_DTV_CONFIG_IF_PORT_PROP_DTV_OUT_TYPE_LIF_IF1    ; /* (default 'LIF_IF2') */
  prop->dtv_config_if_port.dtv_agc_source    = Si2157_DTV_CONFIG_IF_PORT_PROP_DTV_AGC_SOURCE_AGC2_3DB ; /* (default 'INTERNAL') */
  ...
  prop->dtv_internal_zif.atsc                = Si2157_DTV_INTERNAL_ZIF_PROP_ATSC_LIF   ; /* (default 'ZIF') */
  prop->dtv_internal_zif.qam_us              = Si2157_DTV_INTERNAL_ZIF_PROP_QAM_US_LIF ; /* (default 'ZIF') */
  prop->dtv_internal_zif.dvbt                = Si2157_DTV_INTERNAL_ZIF_PROP_DVBT_LIF   ; /* (default 'ZIF') */
  prop->dtv_internal_zif.dvbc                = Si2157_DTV_INTERNAL_ZIF_PROP_DVBC_LIF   ; /* (default 'ZIF') */
  prop->dtv_internal_zif.isdbt               = Si2157_DTV_INTERNAL_ZIF_PROP_ISDBT_LIF  ; /* (default 'ZIF') */
  prop->dtv_internal_zif.isdbc               = Si2157_DTV_INTERNAL_ZIF_PROP_ISDBC_LIF  ; /* (default 'ZIF') */
  prop->dtv_internal_zif.dtmb                = Si2157_DTV_INTERNAL_ZIF_PROP_DTMB_LIF   ; /* (default 'ZIF') */
