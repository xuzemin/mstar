...
#ifndef MAPP_PLAYBACK_H
#define MAPP_PLAYBACK_H
#if ENABLE_PVR
#include "datatype.h"
#ifndef S3PLUS
...
typedef enum
{
    E_PLAYBACK_STATE_WAIT,
    E_PLAYBACK_STATE_OPEN,
    E_PLAYBACK_STATE_PLAYBACKING,
    E_PLAYBACK_STATE_PAUSE,
    E_PLAYBACK_STATE_FASTFORWARD,
    E_PLAYBACK_STATE_FASTBACKWARD,
    E_PLAYBACK_STATE_SLOWFORWARD,
    E_PLAYBACK_STATE_STOP
} enPlaybackState;

//<<playback state machine input>>===============================================================//
typedef enum
{
    E_PLAYBACK_INPUT_NONE                      = E_PVR_INPUT_NONE,

    E_PLAYBACK_INPUT_PLAYBACK_OPEN             = E_PVR_INPUT_PLAYBACK_OPEN,
    E_PLAYBACK_INPUT_PLAYBACK_PAUSE            = E_PVR_INPUT_PLAYBACK_PAUSE,
    E_PLAYBACK_INPUT_PLAYBACK_RESUME           = E_PVR_INPUT_PLAYBACK_RESUME,
    E_PLAYBACK_INPUT_PLAYBACK_STEP_IN           = E_PVR_INPUT_PLAYBACK_STEP_IN,
    E_PLAYBACK_INPUT_PLAYBACK_JUMP_TO_TIME     = E_PVR_INPUT_PLAYBACK_JUMP_TO_TIME,
    E_PLAYBACK_INPUT_PLAYBACK_JUMP_FORWARD     = E_PVR_INPUT_PLAYBACK_JUMP_FORWARD,
    E_PLAYBACK_INPUT_PLAYBACK_JUMP_BACKWARD    = E_PVR_INPUT_PLAYBACK_JUMP_BACKWARD,
    E_PLAYBACK_INPUT_PLAYBACK_SLOW_FORWARD     = E_PVR_INPUT_PLAYBACK_SLOW_FORWARD,
    E_PLAYBACK_INPUT_PLAYBACK_FAST_FORWARD     = E_PVR_INPUT_PLAYBACK_FAST_FORWARD,
    E_PLAYBACK_INPUT_PLAYBACK_FAST_BACKWARD    = E_PVR_INPUT_PLAYBACK_FAST_BACKWARD,
    E_PLAYBACK_INPUT_PLAYBACK_CLOSE            = E_PVR_INPUT_PLAYBACK_CLOSE
} enPlaybackInput;

/*function ======================================================================================*/
#ifdef MAPP_PLAYBACK_C
#define INTERFACE
#else
#define INTERFACE extern
#endif

INTERFACE U32             MApp_Playback_GetRecordStartTimeSec(void);
INTERFACE U32             MApp_Playback_GetRecordEndTimeSec(void);
INTERFACE U32             MApp_Playback_GetRecordValidPeriodSec(void);
INTERFACE U32             MApp_Playback_GetTotalTimeSec(void);
INTERFACE U32             MApp_Playback_GetPlaybackTimeSec(void);
INTERFACE U32             MApp_Playback_GetStartSysTime(void);
INTERFACE enPvrEncryptType MApp_Playback_GetEncryptionType(void);
INTERFACE void             MApp_Playback_GetCurrentFileName(U16 * u16NameBuffer);
INTERFACE enPlaySpeed     MApp_Playback_GetPlaybackSpeed(void);

INTERFACE BOOLEAN         MApp_Playback_StopRecordLinkage(void);

INTERFACE U8              MApp_Playback_AudioGetLanguageSelection(void);
INTERFACE U8              MApp_Playback_AudioGetLanguageTotal(void);
INTERFACE BYTE            MApp_Playback_AudioGetLanguageInfo(void);
INTERFACE BOOLEAN         MApp_Playback_AudioGetStreamInfo(AUD_INFO* pstAudioStreamInfo, U8 u8Idx);
INTERFACE void            MApp_Playback_AudioSelectLanguage(U8 u8AudSelectedIndex);
INTERFACE void            MApp_Playback_AudioStopLanguage(U8 u8AudSelectedIndex);

#ifndef S3PLUS
INTERFACE void            MApp_Playback_AdAudioSelectLanguage(U8 u8AudSelectedIndex);
INTERFACE void            MApp_Playback_AdAudioStopLanguage(U8 u8AudSelectedIndex);
#endif

INTERFACE void            MApp_Playback_Subtitle_LoadServices(U8* pu8SelIdx, U8* pu8Num, DVB_SUBTITLE_SERVICE* options);
INTERFACE void            MApp_Playback_Subtitle_LoadMenu(U8* pu8SelIdx, U8* pu8Num, SUBTITLE_MENU* options, U8* pu8fEnableSubtitle, U8* pu8fEnableTTXSubtitle);
INTERFACE void            MApp_Playback_TTXSubtitle_GetNum(U8* pu8Num);

INTERFACE void            MApp_Playback_ABLoop_SetA(void);
INTERFACE void            MApp_Playback_ABLoop_SetB(void);
INTERFACE void            MApp_Playback_ABLoop_Off(void);

INTERFACE void            MApp_Playback_StateMachineRunning(void);
INTERFACE void            MApp_Playback_StateMachineInput(enPlaybackInput enSMInput, U32 u32ExtParameter);
INTERFACE enPlaybackState MApp_Playback_StateMachineGet(void);
INTERFACE enPvrApiStatus  MApp_Playback_StatusGet(void);
INTERFACE U8  MApp_Playback_GetParentRating(void);
