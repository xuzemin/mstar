...
typedef enum
{
    ...
    PQ_GRule_NR_Low_4K2K_Main_Color,
    PQ_GRule_NR_Middle_4K2K_Main_Color,
    PQ_GRule_NR_High_4K2K_Main_Color,
}
...
typedef enum
{
    ...
    PQ_GRule_Lvl_NR_Low_4K2K_Main_Color,
    PQ_GRule_Lvl_NR_Middle_4K2K_Main_Color,
    PQ_GRule_Lvl_NR_High_4K2K_Main_Color,
}
...
#define PQ_GRULE_NR_NUM_Main_Color 16
