#ifndef _LED_PQ_INNO_50INCH_DIRECT_60_C_
#define _LED_PQ_INNO_50INCH_DIRECT_60_C_

//#include "compen/Tbl_LD_Compensation_SEC75inch_Direct180.c"
//#include "edge2d/Tbl_LD_Edge2D_SEC75inch_Direct180.c"
#include "gamma/Tbl_LD_Gamma_IN8925.c"

StuDrvLdPQInfo s_DrvLdPQInfo_INNO50 =
{
    HAL_LD_EDGE_LR_TYPE, // EnuLD_LED_TYPE eLEDType;

    // PANEL
    32, 32, // U8 u8LDFWidth, u8LDFHeight; // Statistic width & height
    1, 8, // U8 u8LEDWidth, u8LEDHeight; // LED width & height
    1, 8, // U8 u8LSFWidth, u8LSFHeight; // LSF width & height
    ...
    //TO DO
    NULL,//Tbl_LD_Edge2D_SEC75inch_Direct180, // const U8* pu8Edge2DTable; // Edge2D table  SIZE=(u8LEDWidth*u8LEDHeight)*(u8LDFWidth*u8LDFHeight)
    ...
    0x0, //U8 u8SFStrength4; // spatial filter strength 4
    0x0, //U8 u8SFStrength5; // spatial filter strength 5
