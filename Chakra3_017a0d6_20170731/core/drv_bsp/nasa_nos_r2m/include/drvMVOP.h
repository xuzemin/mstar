...
typedef enum
{
    ...
    E_MVOP_CMD_SET_EVD_BASE_ADD,          ///< 0x112 Set 10bits or 8bits base addresss for EVD.
    E_MVOP_CMD_SET_EVD_FEATURE,          ///< 0x113 Set EVD Mode and 10bits or 8 bits Enable.
    E_MVOP_CMD_SET_MVD_LATE_REPEAT,      ////<0x114 Set repeat previous frame if HVD/MVD can not finish vsync.
