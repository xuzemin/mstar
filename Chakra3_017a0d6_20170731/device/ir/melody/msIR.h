...
#define IR_TYPE_SWFIFO_MODE 15
#define IR_TYPE_SWDECODE_NEC_MODE 16
#define IR_TYPE_SWDECODE_CH_MODE            17
#define IR_TYPE_SWDECODE_MITSUBISHI_MODE    18
#define IR_TYPE_SWDECODE_PIONEER            19
...
#elif(IR_TYPE_SEL == IR_TYPE_HIS_NEC_EDEN)
#include "../include/IR_HIS_NEC_EDEN.h"
#elif(IR_TYPE_SEL == IR_TYPE_CUS_KITKING)
#include "../include/IR_CUS_KITKING.h"
#elif(IR_TYPE_SEL == IR_TYPE_SANYO_NEC)
#include "../include/IR_SANYO_NEC.h"
