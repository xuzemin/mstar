...
#define  SIMULATOR_SCOPE 1 //0xffff
...
const char*   L0_InterfaceType     (L0_Context* i2c) {
  ...
  #ifdef USB_Capability
    case USB:
      return (const char *)"USB";
      break;
  #endif /* USB_Capability */
    case SIMU:
      return (const char *)"SIMU";
      break;
    case CUSTOMER:
      return (const char *)"CUST";
      break;
    default:
      return (const char *)"?";
      break;
...
const char*   Si_I2C_TAG_TEXT  (void) { return (const char *)"V3.4.1"; }
/************************************************************************************************************************
  L0_FastI2C  function
