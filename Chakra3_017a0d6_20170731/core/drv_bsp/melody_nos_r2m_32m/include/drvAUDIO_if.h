...
typedef enum
{
    ...
    AU_SIF_CMD_FM_RADIO_SET_SCAN_MODE   = 0x12,
    ...
    AU_SIF_CMD2_ADC_VIA_SIF_PIN = 0x02
} AU_SIF_CMD;
...
{   //info Type name                      //Attibtue      //Parameter
    ...
    Audio_AAC_mm_single_frame_mode        //W             //0: maybe multi-frame  > 0: only single frame
} Audio_AAC_infoType;
...
{
    AU_AUDYSSEY_ENABLE,
    AU_AUDYSSEY_DYNAMICVOL,
    AU_AUDYSSEY_DYNAMICEQ,
    AU_AUDYSSEY_EQ,
    AU_AUDYSSEY_ABX,
    AU_AUDYSSEY_DYNAMICVOL_COMPRESS_MODE,
    AU_AUDYSSEY_DYNAMICVOL_GC,
    AU_AUDYSSEY_DYNAMICVOL_VOLSETTING,
    AU_AUDYSSEY_DYNAMICEQ_EQOFFSET,
    AU_AUDYSSEY_ABX_GWET,
    AU_AUDYSSEY_ABX_GDRY,
    AU_AUDYSSEY_ABX_FILSET,
    AU_AUDYSSEY_DYNAMICVOL_CHCALBGAIN_0,
    AU_AUDYSSEY_DYNAMICVOL_CHCALBGAIN_1,
    AU_AUDYSSEY_VOLUME_MAX,
    AU_AUDYSSEY_MAIN_VOLUME,

} AU_AUDYSSEY;

typedef enum
{
    AU_SONICEMOTION_ABS3D_SET_PARAMS,
} AU_SONICEMOTION_ABS3D_TYPE;
...
typedef enum
{
    ...
    AUDYSSEY_ABX_GDRY,
    AUDYSSEY_ABX_FILSET,
    AUDYSSEY_DYNAMICVOL_CHCALBGAIN_0,
    AUDYSSEY_DYNAMICVOL_CHCALBGAIN_1,
    AUDYSSEY_VOLUME_MAX,
    AUDYSSEY_RESERVE4,
    AUDYSSEY_RESERVE5,
    AUDYSSEY_RESERVE6,
