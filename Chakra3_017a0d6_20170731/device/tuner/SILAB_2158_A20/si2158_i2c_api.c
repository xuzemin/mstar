...
U8 SI215X_ucI2cReadOnly(U8 aSlaveAddr, U8 *apData, U16 aDataSize)
{
    ...
    if(MDrv_IIC_ReadBytes((U16)((SILAB_2158_I2C_ADDR&0xff00)|aSlaveAddr), 0, NULL, (U16)aDataSize, apData) == FALSE)
    {
...
U8 SI215X_ucI2cWriteOnly(U8 aSlaveAddr, U8 *apData, U16 aDataSize)
{
    ...
    if(MDrv_IIC_WriteBytes((U16)((SILAB_2158_I2C_ADDR&0xff00)|aSlaveAddr), 0, NULL, (U16)aDataSize, apData) == FALSE)
    {
