...
#define MS_USB3_CONNECTED           BIT2
#define MS_USB4_CONNECTED           BIT3
...
/*===============================================================================================*/
MASSSTORAGE_INTERFACE U32 MApp_MassStorage_GetValidDevice(void);
MASSSTORAGE_INTERFACE BOOLEAN MApp_MassStorage_IsGetUnsupportUsbDevice(void);
