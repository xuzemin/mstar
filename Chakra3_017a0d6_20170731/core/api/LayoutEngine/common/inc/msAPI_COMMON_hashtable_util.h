...
#ifndef __MSAPI_COMMON_HASHTABLE_UTIL_H__
#define __MSAPI_COMMON_HASHTABLE_UTIL_H__
...
unsigned int msAPI_COMMON_hashtable_wstr_int(unsigned short *pKey, unsigned short u16ClusterLen);
unsigned int msAPI_COMMON_hashtable_wstr_inverse_int(unsigned short *pKey, unsigned short u16ClusterLen);
...
#endif /* __MSAPI_COMMON_HASHTABLE_UTIL_H__ */
