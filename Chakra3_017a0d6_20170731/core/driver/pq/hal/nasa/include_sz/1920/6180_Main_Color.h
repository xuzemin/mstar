...
#ifndef _6180_MAIN_COLOR_H_
#define _6180_MAIN_COLOR_H_
...
typedef enum
{
    ...
    #endif
    #if PQ_QM_HMDI
    QM_HDMI_720p_50hz_Main_Color, //60
    #endif
    #if PQ_QM_HMDI
    QM_HDMI_720p_60hz_Main_Color, //61
    #endif
    #if PQ_QM_HMDI
    QM_HDMI_FP_720p_Main_Color, //62
    #endif
    #if PQ_QM_HMDI
    ...
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_SD_interlace_Main_Color, //123
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_SD_progressive_Main_Color, //124
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_SD_progressive_24hz_Main_Color, //125
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_HD_interlace_Main_Color, //126
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_HD_progressive_Main_Color, //127
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_HD_progressive_24hz_Main_Color, //128
    #endif
    #if PQ_QM_MM_PHOTO
    QM_Multimedia_photo_SD_progressive_Main_Color, //129
    #endif
    #if PQ_QM_MM_PHOTO
    QM_Multimedia_photo_HD_progressive_Main_Color, //130
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_SD_interlace_Main_Color, //131
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_SD_progressive_Main_Color, //132
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_SD_progressive_24hz_Main_Color, //133
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_HD_interlace_Main_Color, //134
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_HD_progressive_Main_Color, //135
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_HD_progressive_24hz_Main_Color, //136
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_SD_interlace_Main_Color, //137
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_SD_progressive_Main_Color, //138
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_HD_interlace_Main_Color, //139
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_HD_progressive_Main_Color, //140
    #endif
    #if PQ_QM_MM_VIDEO
    QM_3D_Video_interlace_Main_Color, //141
    #endif
    #if PQ_QM_MM_VIDEO
    QM_3D_Video_progressive_Main_Color, //142
    #endif
    QM_INPUTTYPE_NUM_Main_Color, // 143
...
PQ_IP_VIP_FCC_T1_S3_Main_Color,
...
PQ_IP_VIP_FCC_T2_SC_Main_Color,
...
PQ_IP_VIP_FCC_T8_S3_Main_Color,
...
PQ_IP_VIP_IHC_SETTING_YPBPR_480i_Main_Color,
PQ_IP_VIP_IHC_SETTING_YPBPR_576i_Main_Color,
PQ_IP_VIP_IHC_SETTING_YPBPR_720p_Main_Color,
PQ_IP_VIP_IHC_SETTING_YPBPR_1080i_Main_Color,
PQ_IP_VIP_IHC_SETTING_HDMI_480i_Main_Color,
PQ_IP_VIP_IHC_SETTING_HDMI_576i_Main_Color,
PQ_IP_VIP_IHC_SETTING_HDMI_720p_Main_Color,
PQ_IP_VIP_IHC_SETTING_HDMI_1080i_Main_Color,
...
PQ_IP_VIP_ICC_Ymode_RF_PAL_Main_Color,
PQ_IP_VIP_ICC_Ymode_RF_NTSC_Main_Color,
PQ_IP_VIP_ICC_Ymode_AV_PAL_Main_Color,
PQ_IP_VIP_ICC_Ymode_AV_NTSC_Main_Color,
PQ_IP_VIP_ICC_Ymode_YPBPR_480i_Main_Color,
PQ_IP_VIP_ICC_Ymode_YPBPR_576i_Main_Color,
PQ_IP_VIP_ICC_Ymode_YPBPR_720p_Main_Color,
PQ_IP_VIP_ICC_Ymode_YPBPR_1080i_Main_Color,
PQ_IP_VIP_ICC_Ymode_HDMI_480i_Main_Color,
PQ_IP_VIP_ICC_Ymode_HDMI_576i_Main_Color,
PQ_IP_VIP_ICC_Ymode_HDMI_720p_Main_Color,
PQ_IP_VIP_ICC_Ymode_HDMI_1080i_Main_Color,
...
PQ_IP_VIP_ICC_SETTING_YPBPR_480i_Main_Color,
PQ_IP_VIP_ICC_SETTING_YPBPR_576i_Main_Color,
PQ_IP_VIP_ICC_SETTING_YPBPR_720p_Main_Color,
PQ_IP_VIP_ICC_SETTING_YPBPR_1080i_Main_Color,
PQ_IP_VIP_ICC_SETTING_HDMI_480i_Main_Color,
PQ_IP_VIP_ICC_SETTING_HDMI_576i_Main_Color,
PQ_IP_VIP_ICC_SETTING_HDMI_720p_Main_Color,
PQ_IP_VIP_ICC_SETTING_HDMI_1080i_Main_Color,
...
PQ_IP_VIP_Peaking_band_MM_SD_1_Main_Color,
PQ_IP_VIP_Peaking_band_MM_HD_1_Main_Color,
