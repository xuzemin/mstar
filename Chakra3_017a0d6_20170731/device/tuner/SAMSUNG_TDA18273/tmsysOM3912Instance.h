...
extern tmErrorCode_t OM3912DeAllocInstance (tmUnitSelect_t tUnit);
extern tmErrorCode_t OM3912GetInstance (tmUnitSelect_t tUnit, pptmOM3912Object_t ppDrvObject);
