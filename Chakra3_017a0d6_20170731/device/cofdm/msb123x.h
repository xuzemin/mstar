...
/*@ <IncludeGuard> @*/
#ifndef device_demodulator_msb123x_I2b28dd03m121c8cf959bmm7254_H
#define device_demodulator_msb123x_I2b28dd03m121c8cf959bmm7254_H
/*@ </IncludeGuard> @*/
...
{
    /// lock
    E_MSB_123X_DEMOD_LOCK,
    /// is checking
    E_MSB_123X_DEMOD_CHECKING,
    /// after checking
    E_MSB_123X_DEMOD_CHECKEND,
    /// unlock
    E_MSB_123X_DEMOD_UNLOCK,
    /// NULL state
    E_MSB_123X_DEMOD_NULL,
} EN_MSB_123X_LOCK_STATUS;
...
/*@ <Definitions> @*/
    ...
    //-------------------------MSB122x.h jeff.chu ------------------------
    //--------------------------------------------------------------------
#define     DEMOD_SLAVE_ID          DEMOD_DYNAMIC_SLAVE_ID_MSB_123X_1
#define IIC_CH_MSB123X                      TUNER_IIC_BUS

    #define DEMOD_DYNAMIC_SLAVE_ID_MSB_123X_1    0xD2 // 0x32
    #define DEMOD_DYNAMIC_SLAVE_ID_MSB_123X_2    0xA2 // 0x72
...
typedef struct
{
    float    power_db;
    MAPI_U8  agc_val;
}S_MSB_123X_IFAGC_SSI;

typedef struct
{
    float    power_db;
    MAPI_U8  sar3_val;
}S_MSB_123X_RFAGC_SSI;
