#ifndef _LED_PQ_INNO_50INCH_TB_16_C_
#define _LED_PQ_INNO_50INCH_TB_16_C_

//#include "compen/Tbl_LD_Compensation_Gamma22.c"
//#include "edge2d/Tbl_LD_Edge2D_INNO50inch_TB16.c"
#include "gamma/Tbl_LD_Gamma_IN8925.c"

StuDrvLdPQInfo s_DrvLdPQInfo_INNO50_TB_16 =
{
    ...
    //TO DO
    NULL,   //Tbl_LD_Edge2D_INNO50inch_TB16, // const U8* pu8Edge2DTable; // Edge2D table  SIZE=(u8LEDWidth*u8LEDHeight)*(u8LDFWidth*u8LDFHeight)
