...
//                   Define                                            //
//----------------------------------------------------------//
#define VERSION   "R840_v2.9I"    
#define VER_NUM   9
#define R840_CHIP_ID     0x96
...
//----------------------------------------------------------//
#define R840_Delay_MS	msAPI_Timer_Delayms	
...
//For GUI initial use. When initial, set these two flags to FALSE and call R840_Init()
