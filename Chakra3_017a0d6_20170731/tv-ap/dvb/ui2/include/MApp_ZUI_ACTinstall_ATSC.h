...
#ifndef _MAPP_ZUI_ACTINSTALL_ATSC_H
#define _MAPP_ZUI_ACTINSTALL_ATSC_H
...
#ifdef MAPP_ZUI_ACTINSTALL_ATSC_C
#define INTERFACE
#else
#define INTERFACE extern
#endif

INTERFACE void MApp_ZUI_ACT_AppShowInstallGuide_ATSC(void);
INTERFACE BOOLEAN MApp_ZUI_ACT_HandleInstallGuideKey_ATSC(VIRTUAL_KEY_CODE key);
INTERFACE void MApp_ZUI_ACT_TerminateInstallGuide_ATSC(void);
INTERFACE BOOLEAN MApp_ZUI_ACT_ExecuteInstallGuideAction_ATSC(U16 act);
INTERFACE LPTSTR MApp_ZUI_ACT_GetInstallGuideDynamicText_ATSC(HWND hwnd);
INTERFACE S16 MApp_ZUI_ACT_GetInstallGuideDynamicValue_ATSC(HWND hwnd);
INTERFACE BOOLEAN MApp_ZUI_ACT_HandleInstallGuideKey_ATSC(VIRTUAL_KEY_CODE key);
INTERFACE void MApp_ZUI_ACT_TerminateInstallGuide_ATSC(void);
INTERFACE S32 MApp_ZUI_ACT_InstallGuideWinProc_ATSC(HWND,PMSG);
#define INSTALL_GUIDE_WINPROC_ATSC  MApp_ZUI_ACT_InstallGuideWinProc_ATSC
...
#if ENABLE_S2
    PAGE_INSTALL_SELECT_HOME_SHOP_MODE,
#endif
