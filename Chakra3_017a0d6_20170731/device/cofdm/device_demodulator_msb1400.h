...
#define     DEMOD_DYNAMIC_SLAVE_ID_MSB1400_1          0x01
#define     DEMOD_DYNAMIC_SLAVE_ID_MSB1400_2          0x02
#define     DEMOD_DYNAMIC_SLAVE_ID_MSB1400_3          0x03
#define     DEMOD_DYNAMIC_SLAVE_ID_MSB1400_4          0xD2
...
{
    /// lock
    E_MSB_1400_DEMOD_LOCK,
    /// is checking
    E_MSB_1400_DEMOD_CHECKING,
    /// after checking
    E_MSB_1400_DEMOD_CHECKEND,
    /// unlock
    E_MSB_1400_DEMOD_UNLOCK,
    /// NULL state
    E_DEMOD_NULL,
} EN_MSB_1400_LOCK_STATUS;
...
typedef struct
{
    float    power_db;
    MAPI_U8  agc_val;
}S_MSB_1400_IFAGC_SSI;

typedef struct
{
    float    power_db;
    MAPI_U8  sar3_val;
}S_MSB_1400_RFAGC_SSI;
