...
Si2158_optionStruct    Si2158_XOUT_PROP_AMP[] =
{
  {"HIGH",     0},
  {"LOW",      1},
};
Si2158_fieldDicoStruct Si2158_XOUT_PROP_FIELDS[] =
{
  {"AMP", Si2158_UNSIGNED_CHAR, &Si2158_prop.xout.amp, sizeof(Si2158_XOUT_PROP_AMP)/sizeof(Si2158_optionStruct), Si2158_XOUT_PROP_AMP},
};
...
Si2158_propertyInfoStruct Si2158_propertyDictionary[] =
{
  ...
  {Si2158_COMMON, "XOUT"                        , sizeof(Si2158_XOUT_PROP_FIELDS                        )/sizeof(Si2158_fieldDicoStruct), Si2158_XOUT_PROP_FIELDS                         , Si2158_XOUT_PROP                         },
...
void Si2158_setupATVDefaults        (L1_Si2158_Context *api)
{
  ...
  api->prop->atv_config_if_port.atv_agc_source    = Si2158_ATV_CONFIG_IF_PORT_PROP_ATV_AGC_SOURCE_AGC2_3DB     ; /* (default 'INTERNAL') */
  ...
  api->prop->atv_lif_out.amp                      =   80; /* (default   100) */
...
void Si2158_setupCOMMONDefaults     (L1_Si2158_Context *api)
{
  ...
  api->prop->crystal_trim.xo_cap                  = Si2158_CRYSTAL_TRIM_PROP_XO_CAP_15 ; /* (default '8') */
  ...
  api->prop->xout.amp                             = Si2158_XOUT_PROP_AMP_HIGH ; /* (default 'HIGH') */
...
void Si2158_setupDTVDefaults        (L1_Si2158_Context *api)
{
  ...
  api->prop->dtv_config_if_port.dtv_out_type      = Si2158_DTV_CONFIG_IF_PORT_PROP_DTV_OUT_TYPE_LIF_IF1; /* (default 'LIF_IF2') */
  api->prop->dtv_config_if_port.dtv_agc_source    = Si2158_DTV_CONFIG_IF_PORT_PROP_DTV_AGC_SOURCE_AGC2_3DB; /* (default     0) */
  ...
  api->prop->dtv_lif_out.amp                      =    40; /* (default    27) */
  ...
  api->prop->dtv_rf_top.dtv_rf_top                = Si2158_DTV_RF_TOP_PROP_DTV_RF_TOP_0DB ; /* (default 'AUTO') */
...
int  Si2158_downloadCOMMONProperties(L1_Si2158_Context *api)
{
  ...
  if (Si2158_L1_SetProperty2(api, Si2158_XOUT_PROP_CODE                        ) != NO_Si2158_ERROR) {return ERROR_Si2158_SENDING_COMMAND;}
