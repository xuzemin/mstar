...
#ifndef _NXP_TH2603_TUNER_H_
#define _NXP_TH2603_TUNER_H_


#ifdef NXP_TH2603_TUNER_C
#define INTERFACE
#else
#define INTERFACE extern
#endif

#define TN_FREQ_STEP                FREQ_STEP_62_5KHz

#define _TUNER_I2C_ID               0xC0

#define VHF_LOWMIN_FREQ             48250L  // KHz
#define VHF_LOWMAX_FREQ             157000L // KHz

#define VHF_HIGHMIN_FREQ            157000L // KHz
#define VHF_HIGHMAX_FREQ            443000L // KHz

#define UHF_MIN_FREQ                443000L // KHz
#define UHF_MAX_FREQ                863250L // KHz

#define TUNER_IF_FREQ_KHz           38875L  // KHz
#define TUNER_L_PRIME_IF_FREQ_KHz   33400L  // KHz
...
#define IF_OUT_LEVEL_115            0//(0<<3)
#define IF_OUT_LEVEL_112            1//(1<<3)
#define IF_OUT_LEVEL_109            2//(2<<3)
#define IF_OUT_LEVEL_106            3//(3<<3)
#define IF_OUT_LEVEL_103            4//(4<<3)
#define IF_OUT_LEVEL_100            5//(5<<3)
#define IF_OUT_LEVEL_EXT_AGC        6//(6<<3)
#define IF_OUT_LEVEL_Disable        7//(7<<3)
