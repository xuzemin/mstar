...
#define GFXFONT_FLAG_ARABIC             0x100
...
#define GFXDRAW_FLAG_DST_MIRROR_X       0x10
#define GFXDRAW_FLAG_DST_MIRROR_Y       0x20 
...
// GE Driver Function
//=============================================================================
extern DLL_PUBLIC  void MApi_GFX_Init(GFX_Config *geConfig);
extern DLL_PUBLIC GFX_Result MApi_GFX_DrawBitmap(MS_S32 handle, GFX_DrawBmpInfo *pbmpfmt);
extern DLL_PUBLIC GFX_Result MApi_GFX_GetFontInfo(MS_S32 handle, GFX_FontInfo* pinfo);
extern DLL_PUBLIC GFX_Result MApi_GFX_GetBitmapInfo(MS_S32 handle, GFX_BitmapInfo* pinfo);
extern DLL_PUBLIC GFX_Result MApi_GFX_GetFrameBufferInfo(MS_U32 *width, MS_U32 *height, MS_U32 *pitch, MS_U32 *fbFmt, MS_PHYADDR *addr);
extern DLL_PUBLIC GFX_Result MApi_GFX_DrawLine(GFX_DrawLineInfo *pline);
extern DLL_PUBLIC GFX_Result MApi_GFX_RectFill(GFX_RectFillInfo *pfillblock);
extern DLL_PUBLIC GFX_Result MApi_GFX_TrapezoidFill(GFX_RectFillInfo *pGfxFillInfo);
extern DLL_PUBLIC GFX_Result MApi_GFX_EnableTrapezoidAA(MS_BOOL bEnable);
extern DLL_PUBLIC GFX_Result MApi_GFX_EnableTrapSubPixCorr(MS_BOOL bEnable);
extern DLL_PUBLIC GFX_Result MApi_GFX_SetClip(GFX_Point* v0, GFX_Point* v1);
extern DLL_PUBLIC GFX_Result MApi_GFX_GetClip(GFX_Point* v0, GFX_Point* v1);
extern DLL_PUBLIC GFX_Result MApi_GFX_SetItalic(MS_BOOL enable,MS_U8 ini_line, MS_U8 ini_dis, MS_U8 delta);
extern DLL_PUBLIC GFX_Result MApi_GFX_SetDither(MS_BOOL enable);
extern DLL_PUBLIC GFX_Result MApi_GFX_SetOnePixelMode(MS_BOOL enable);
extern DLL_PUBLIC GFX_Result MApi_GFX_SetSrcBufferInfo(GFX_BufferInfo *bufInfo, MS_U32 offsetofByte);
extern DLL_PUBLIC GFX_Result MApi_GFX_SetDstBufferInfo(GFX_BufferInfo *bufInfo, MS_U32 offsetofByte);
extern DLL_PUBLIC GFX_Result MApi_GFX_SetNearestMode(MS_BOOL enable);
extern DLL_PUBLIC GFX_Result MApi_GFX_SetMirror(MS_BOOL isMirrorX, MS_BOOL isMirrorY);
extern DLL_PUBLIC GFX_Result MApi_GFX_SetDstMirror(MS_BOOL isMirrorX, MS_BOOL isMirrorY);
extern DLL_PUBLIC GFX_Result MApi_GFX_SetROP2(MS_BOOL enable, GFX_ROP2_Op eRopMode);
extern DLL_PUBLIC GFX_Result MApi_GFX_SetRotate(GFX_RotateAngle angle);
extern DLL_PUBLIC GFX_Result MApi_GFX_SetSrcColorKey(MS_BOOL enable, GFX_ColorKeyMode opMode,
                                      GFX_Buffer_Format fmt, void *ps_color,
                                      void *pe_color);
extern DLL_PUBLIC GFX_Result MApi_GFX_SetDstColorKey(MS_BOOL enable, GFX_ColorKeyMode opMode,
                                      GFX_Buffer_Format fmt, void *ps_color,
                                      void *pe_color);
extern DLL_PUBLIC GFX_Result MApi_GFX_TextOut(MS_S32 fhandle, MS_U8 *pindex, MS_U32 strwidth, GFX_TextOutInfo *pfmt);
extern DLL_PUBLIC GFX_Result MApi_GFX_QueryTextDispLength(MS_S32 fhandle, MS_U8 *pu8index, MS_U32 u32strwidth,
                                               GFX_TextOutInfo *pfmt, MS_U32* pu32DispLength);
extern DLL_PUBLIC GFX_Result MApi_GFX_CharacterOut(GFX_CharInfo*  pChar, GFX_TextOutInfo *pfmt);
extern DLL_PUBLIC GFX_Result MApi_GFX_SetAlphaSrcFrom(GFX_AlphaSrcFrom eMode);
extern DLL_PUBLIC GFX_Result MApi_GFX_SetAlphaBlending(GFX_BlendCoef blendcoef, MS_U8 blendfactor);
extern DLL_PUBLIC GFX_Result MApi_GFX_EnableAlphaBlending(MS_BOOL enable);
extern DLL_PUBLIC GFX_Result MApi_GFX_QueryDFBBldCaps(MS_U16 *pU16SupportedBldFlags);
extern DLL_PUBLIC GFX_Result MApi_GFX_EnableDFBBlending(MS_BOOL enable);
extern DLL_PUBLIC GFX_Result MApi_GFX_SetDFBBldFlags(MS_U16 u16DFBBldFlags);
extern DLL_PUBLIC GFX_Result MApi_GFX_SetDFBBldOP(GFX_DFBBldOP gfxSrcBldOP, GFX_DFBBldOP gfxDstBldOP);
extern DLL_PUBLIC GFX_Result MApi_GFX_SetDFBBldConstColor(GFX_RgbColor gfxRgbColor);
extern DLL_PUBLIC GFX_Result MApi_GFX_SetDFBBldSrcColorMask(GFX_RgbColor gfxRgbColor);
extern DLL_PUBLIC GFX_Result MApi_GFX_Line_Pattern_Reset(void);
extern DLL_PUBLIC GFX_Result MApi_GFX_Set_Line_Pattern(MS_BOOL enable, MS_U8 linePattern, MS_U8 repeatFactor);
extern DLL_PUBLIC GFX_Result MApi_GFX_BitBlt(GFX_DrawRect *drawbuf,MS_U32 drawflag);
extern DLL_PUBLIC GFX_Result MApi_GFX_BitBltEx(GFX_DrawRect * drawbuf, MS_U32 drawflag, GFX_ScaleInfo * ScaleInfo);
extern DLL_PUBLIC GFX_Result MApi_GFX_SetIntensity(MS_U32 id, GFX_Buffer_Format fmt, MS_U32 *pColor);
extern DLL_PUBLIC GFX_Result MApi_GFX_GetIntensity(MS_U32 idx, MS_U32 *color);
extern DLL_PUBLIC GFX_Result MApi_GFX_BeginDraw(void);
extern DLL_PUBLIC GFX_Result MApi_GFX_EndDraw(void);
extern DLL_PUBLIC GFX_Result MApi_GFX_YUV_Get(GFX_YuvInfo* pYuvInfo);
extern DLL_PUBLIC void MApi_GFX_RectFrame(GFX_RectFillInfo *pblock, GFX_DrawLineInfo *plinefmt);
extern DLL_PUBLIC GFX_Result MApi_GFX_SetDC_CSC_FMT(GFX_YUV_Rgb2Yuv mode, GFX_YUV_OutRange yuv_out_range, GFX_YUV_InRange uv_in_range, GFX_YUV_422 srcfmt, GFX_YUV_422 dstfmt);
extern DLL_PUBLIC GFX_Result MApi_GFX_SetPatchMode(MS_BOOL enable);
extern DLL_PUBLIC GFX_Result MApi_GFX_SetNearestMode(MS_BOOL enable);
extern DLL_PUBLIC GFX_Result MApi_GFX_GetBufferInfo(PGFX_BufferInfo srcbufInfo, PGFX_BufferInfo dstbufInfo);


extern DLL_PUBLIC GFX_Result MApi_GFX_ClearFrameBufferByWord(MS_PHYADDR StrAddr, MS_U32 length, MS_U32 ClearValue);
extern DLL_PUBLIC GFX_Result MApi_GFX_ClearFrameBuffer(MS_PHYADDR StrAddr, MS_U32 length, MS_U8 ClearValue);
extern DLL_PUBLIC GFX_Result MApi_GFX_SetAlpha_ARGB1555(MS_U8 coef);
extern DLL_PUBLIC GFX_Result MApi_GFX_GetAlpha_ARGB1555(MS_U8* coef);
extern DLL_PUBLIC GFX_Result MApi_GFX_SetTAGID(MS_U16 tagID);
extern DLL_PUBLIC GFX_Result MApi_GFX_GetTAGID(MS_U16 *tagID);
extern DLL_PUBLIC GFX_Result MApi_GFX_WaitForTAGID(MS_U16 tagID);
extern DLL_PUBLIC MS_U16      MApi_GFX_GetNextTAGID(MS_BOOL bStepTagBefore);
extern DLL_PUBLIC MS_U16      MApi_GFX_SetNextTAGID(void);
extern DLL_PUBLIC GFX_Result MApi_GFX_RegisterGetFontCB(MS_U32 (*fpGFX_CB)(MS_S8, GFX_FontInfo*)  );
extern DLL_PUBLIC GFX_Result MApi_GFX_RegisterGetBMPCB(MS_U32 (*fpGFX_CB)(MS_S16, GFX_BitmapInfo*)  );
extern DLL_PUBLIC GFX_Result MApi_GFX_EnableVCmdQueue(MS_U16 blEnable);
extern DLL_PUBLIC GFX_Result MApi_GFX_SetVCmdBuffer(MS_PHYADDR u32Addr, GFX_VcmqBufSize enBufSize);
extern DLL_PUBLIC GFX_Result MApi_GE_SetVCmd_W_Thread(MS_U8 u8W_Threshold);
extern DLL_PUBLIC GFX_Result MApi_GE_SetVCmd_R_Thread(MS_U8 u8R_Threshold);
extern DLL_PUBLIC GFX_Result MApi_GFX_SetAlphaCmp(MS_BOOL enable, GFX_ACmpOp eMode);
extern DLL_PUBLIC void MApi_GFX_SetDbgLevel(MS_U32 level);
extern DLL_PUBLIC GFX_Result MApi_GFX_FlushQueue(void) ;
extern DLL_PUBLIC GFX_Result MApi_GFX_SetStrBltSckType(GFX_StretchCKType type, GFX_RgbColor *color);
extern DLL_PUBLIC GFX_Result MApi_GFX_SetHK(MS_BOOL bIsHK) ;
extern DLL_PUBLIC GFX_Result MApi_GFX_GetHK(MS_BOOL *bIsHK) ;
extern DLL_PUBLIC GFX_Result MApi_GFX_DrawOval(GFX_OvalFillInfo *pOval);
extern DLL_PUBLIC GFX_Result MApi_GFX_GetStatus( MS_BOOL *pStatus );
extern DLL_PUBLIC GFX_Result MApi_GFX_GetLibVer(const MSIF_Version **ppVersion);
extern DLL_PUBLIC GFX_Result MApi_GFX_GetInfo( GFX_DbgInfo *dbg );
extern DLL_PUBLIC GFX_Result MApi_GFX_PowerOn(void);
extern DLL_PUBLIC GFX_Result MApi_GFX_PowerOff(void);
extern DLL_PUBLIC GFX_Result MApi_GFX_WriteProtect(MS_U8 miu,MS_U32 addr_low,MS_U32 addr_high,GFX_WPType eWPType);
extern DLL_PUBLIC GFX_Result MApi_GFX_GetAlignCaps(GFX_FmtAlignCapsInfo* pAlignCapsInfo);
extern DLL_PUBLIC GFX_Result MApi_GFX_GetGECaps(EN_GFX_CAPS eCapType, MS_U32* pRet, MS_U32 ret_size);

extern DLL_PUBLIC GFX_Result MApi_GFX_SetAlpha(MS_BOOL enable, GFX_BlendCoef coef, GFX_AlphaSrcFrom db_abl, MS_U8 abl_const);
extern DLL_PUBLIC GFX_Result MApi_GFX_SetPaletteOpt( GFX_PaletteEntry *pPalArray, MS_U16 u32PalStart, MS_U16 u32PalEnd);
extern DLL_PUBLIC void msAPI_GE_ClearFrameBufferByWord (MS_PHYADDR StrAddr, MS_U32 length, MS_U32 ClearValue);
extern DLL_PUBLIC GFX_Result MDrv_GE_EnableAlphaBlending(MS_BOOL enable);
extern DLL_PUBLIC GFX_Result MDrv_GE_SetAlphaBlending(GFX_BlendCoef blendcoef, MS_U8 u8ConstantAlpha);
extern DLL_PUBLIC void MDrv_GE_PE_SetIntensity(MS_U8 id, GFX_Buffer_Format fmt, MS_U32* pcolor);
