...
typedef enum
{
    ...
    E_INT_FIQ_INT_IN                    = E_INT_FIQ_0x30_START+10,
    ...
    E_INT_IRQ_EVD                       = E_INT_IRQ_0x80_START+0,   //Whisky
    E_INT_IRQ_SHA_RSA                   = E_INT_IRQ_0x80_START+1,   //Whisky
    E_INT_IRQ_SCDC_INT_PM               = E_INT_IRQ_0x80_START+2,   //Whisky
    E_INT_IRQ_PAS_PTS_COMBINE           = E_INT_IRQ_0x80_START+3,   //Whisky
    E_INT_IRQ_DISP_FE                   = E_INT_IRQ_0x80_START+4,   //Whisky
    E_INT_IRQ_D2B                       = E_INT_IRQ_0x80_START+5,   //Whisky
    E_INT_IRQ_LDM_DMA_DONE1             = E_INT_IRQ_0x80_START+6,   //Whisky
    E_INT_IRQ_DVI_HDMI_HDCP             = E_INT_IRQ_0x80_START+7,   //T3
    E_INT_IRQ_SECU_ERROR_RESP           = E_INT_IRQ_0x80_START+8,   //Whisky
    E_INT_IRQ_AESDMA                    = E_INT_IRQ_0x80_START+9,   //Whisky
    ...
    E_INT_FIQ_R2TOMCU_INT2              = E_INT_FIQ_0xC0_START+0,   //Whisky
    E_INT_FIQ_AU_DMA_BUF_INT            = E_INT_FIQ_0xC0_START+1,   //T3
    E_INT_FIQ_R2TOMCU_INT3              = E_INT_FIQ_0xC0_START+2,   //Whisky
    ...
    E_INT_FIQ_HST0TO1                   = E_INT_FIQ_0xD0_START+0,   //Whisky
    E_INT_FIQ_HST0TO2                   = E_INT_FIQ_0xD0_START+1,   //Whisky
    E_INT_FIQ_HST0TO3                   = E_INT_FIQ_0xD0_START+2,   //Whisky
    E_INT_FIQ_HST1TO0                   = E_INT_FIQ_0xD0_START+3,   //Whisky
    E_INT_FIQ_HST1TO2                   = E_INT_FIQ_0xD0_START+4,   //Whisky
    E_INT_FIQ_HST1TO3                   = E_INT_FIQ_0xD0_START+5,   //Whisky
    E_INT_FIQ_HST2TO0                   = E_INT_FIQ_0xD0_START+6,   //Whisky
    E_INT_FIQ_HST2TO1                   = E_INT_FIQ_0xD0_START+7,   //Whisky
    E_INT_FIQ_HST2TO3                   = E_INT_FIQ_0xD0_START+8,   //Whisky
    E_INT_FIQ_HST3TO0                   = E_INT_FIQ_0xD0_START+9,   //Whisky
    E_INT_FIQ_HST3TO1                   = E_INT_FIQ_0xD0_START+10,  //Whisky
    E_INT_FIQ_HST3TO2                   = E_INT_FIQ_0xD0_START+11,  //Whisky
    E_INT_FIQ_SECU_XIU_TIME_OUT = E_INT_FIQ_0xD0_START+12,  //Whisky
    E_INT_IRQ_MHL_ECBUS_INT        = E_INT_FIQ_0xD0_START+13,  //Whisky
    E_INT_FIQ_VE_VBI_F0                 = E_INT_FIQ_0xD0_START+14,  //Whisky
    E_INT_FIQ_VE_VBI_F1                 = E_INT_FIQ_0xD0_START+15,  //Whisky
