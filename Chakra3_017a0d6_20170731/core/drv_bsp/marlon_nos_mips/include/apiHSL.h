 ...
 *  This function is called to initialise the HSL controller.
 */
DLL_PUBLIC MS_BOOL FrHslInitialise(const MS_PHYADDR PhyAddr, const MS_U32 u32BufByteLen);
DLL_PUBLIC MS_BOOL FrHslInitialiseMulti(MS_U8 _ICount, MS_U32 *_params);
DLL_PUBLIC MS_BOOL FrHslDynamicLogPointEnable(const MS_U16 lgHdr);
DLL_PUBLIC MS_BOOL FrHslDynamicLogPointDisable(const MS_U16 lgHdr);
DLL_PUBLIC MS_BOOL FrHslDynamicLogPointEnableAll(void);
DLL_PUBLIC MS_BOOL FrHslDynamicLogPointDisableAll(void);
DLL_PUBLIC MS_BOOL FrHslDynamicLogGroupEnable(const MS_U16 groupId);
DLL_PUBLIC MS_BOOL FrHslDynamicLogGroupDisable(const MS_U16 groupId);
DLL_PUBLIC MS_BOOL FrHslDynamicLogGroupEnableAll(void);
DLL_PUBLIC MS_BOOL FrHslDynamicLogGroupDisableAll(void);
DLL_PUBLIC MS_BOOL FrHslV2ApplySingleLogPointFiltering(const MS_U16 lgHdr, const MS_BOOL enableState);
DLL_PUBLIC MS_BOOL FrHslV2ApplyMultipleLogPointsFilter(const MS_U16* lgHdr_p, const MS_BOOL* enableState_p, const MS_U16 sizeArray);
DLL_PUBLIC MS_BOOL FrHslV2InitialiseLogPointFiltering(void);
DLL_PUBLIC MS_BOOL FrHslV2InitialiseGroupIdFiltering(void);
DLL_PUBLIC MS_BOOL FrHslFinalize(void);
DLL_PUBLIC void KiTtiProcessSetsFilter(const KiSetsFilterMatrix * signalData);

DLL_PUBLIC MS_BOOL FrHslAddDynamicLibInfo(void* baseAddress, void* onLoadAddress, const char *libFileName);
DLL_PUBLIC MS_BOOL FrHslAddThreadInfo(const MS_U32 threadId, const char * threadName);
...
/** Write a 0 argument message to HSL (just a message header, no data).
  ...
  */
DLL_PUBLIC void M_FrHslPrintf0(const MS_U32 u32Id, const MS_U16 u16GId, const char* u8Fmt);
...
/** Write a 1 argument message to HSL (just a message header, no data).
  ...
  */
DLL_PUBLIC void M_FrHslPrintf1(const MS_U32 u32Id, const MS_U16 u16GId, const char* u8Fmt, const MS_U16 u16Arg1);
...
/** Write a 2 argument message to HSL (just a message header, no data).
  ...
  */
DLL_PUBLIC void M_FrHslPrintf2(const MS_U32 u32Id, const MS_U16 u16GId, const char* u8Fmt, const MS_U16 u16Arg1, const MS_U16 u16Arg2);
...
/** Write a 3 argument message to HSL (just a message header, no data).
  ...
  */
DLL_PUBLIC void M_FrHslPrintf3(const MS_U32 u32Id, const MS_U16 u16GId, const char* u8Fmt, const MS_U16 u16Arg1, const MS_U16 u16Arg2,const MS_U16 u16Arg3);
...
/** Write a 4 argument message to HSL (just a message header, no data).
  ...
  */
DLL_PUBLIC void M_FrHslPrintf4(const MS_U32 u32Id, const MS_U16 u16GId, const char* u8Fmt, const MS_U16 u16Arg1, const MS_U16 u16Arg2, const MS_U16 u16Arg3, const MS_U16 u16Arg4);
...
/** Write a 5 argument message to HSL (just a message header, no data).
  ...
  */
DLL_PUBLIC void M_FrHslPrintf5(const MS_U32 u32Id, const MS_U16 u16GId, const char* u8Fmt, const MS_U16 u16Arg1, const MS_U16 u16Arg2, const MS_U16 u16Arg3, const MS_U16 u16Arg4, const MS_U16 u16Arg5);
...
/** Write a 6 argument message to HSL (just a message header, no data).
  ...
  */
DLL_PUBLIC void M_FrHslPrintf6(MS_U32 u32Id, MS_U16 u16GId, const char* u8Fmt, const MS_U16 u16Arg1 , const MS_U16 u16Arg2, const MS_U16 u16Arg3, const MS_U16 u16Arg4, const MS_U16 u16Arg5, const MS_U16 u16Arg6);
...
/** Write a 7 argument message to HSL (just a message header, no data).
  ...
  */
DLL_PUBLIC void M_FrHslPrintf7(MS_U32 u32Id, MS_U16 u16GId, const char* u8Fmt, const MS_U16 u16Arg1, const MS_U16 u16Arg2, const MS_U16 u16Arg3, const MS_U16 u16Arg4, const MS_U16 u16Arg5,
...
/** Write a 8 argument message to HSL (just a message header, no data).
  ...
  */
DLL_PUBLIC void M_FrHslPrintf8(MS_U32 u32Id, MS_U16 u16GId, const char* u8Fmt, const MS_U16 u16Arg1, const MS_U16 u16Arg2, const MS_U16 u16Arg3, const MS_U16 u16Arg4, const MS_U16 u16Arg5,
...
/** Write a 9 argument message to HSL (just a message header, no data).
  ...
  */
DLL_PUBLIC void M_FrHslPrintf9(MS_U32 u32Id, MS_U16 u16GId, const char* u8Fmt, const MS_U16 u16Arg1, const MS_U16 u16Arg2, const MS_U16 u16Arg3, const MS_U16 u16Arg4, const MS_U16 u16Arg5,
...
/** Write a 10 argument message to HSL (just a message header, no data).
  ...
  */
DLL_PUBLIC void M_FrHslPrintf10(MS_U32 u32Id, MS_U16 u16GId, const char* u8Fmt, const MS_U16 u16Arg1, const MS_U16 u16Arg2, const MS_U16 u16Arg3, const MS_U16 u16Arg4, const MS_U16 u16Arg5,
...
/** Write a 11 argument message to HSL (just a message header, no data).
  ...
  */
DLL_PUBLIC void M_FrHslPrintf11(MS_U32 u32Id, MS_U16 u16GId, const char* u8Fmt, const MS_U16 u16Arg1, const MS_U16 u16Arg2, const MS_U16 u16Arg3, const MS_U16 u16Arg4, const MS_U16 u16Arg5,
                                    const MS_U16 u16Arg6, const MS_U16 u16Arg7 , const MS_U16 u16Arg8, const MS_U16 u16Arg9, const MS_U16 u16Arg10,
...
/** Write a 12 argument message to HSL (just a message header, no data).
  ...
  */
DLL_PUBLIC void M_FrHslPrintf12(MS_U32 u32Id, MS_U16 u16GId, const char* u8Fmt, const MS_U16 u16Arg1, const MS_U16 u16Arg2, const MS_U16 u16Arg3, const MS_U16 u16Arg4, const MS_U16 u16Arg5,
                                    const MS_U16 u16Arg6, const MS_U16 u16Arg7 , const MS_U16 u16Arg8, const MS_U16 u16Arg9, const MS_U16 u16Arg10,
...
/** Write a 13 argument message to HSL (just a message header, no data).
  ...
  */
DLL_PUBLIC void M_FrHslPrintf13(MS_U32 u32Id, MS_U16 u16GId, const char* u8Fmt, const MS_U16 u16Arg1, const MS_U16 u16Arg2, const MS_U16 u16Arg3, const MS_U16 u16Arg4, const MS_U16 u16Arg5,
                                    const MS_U16 u16Arg6, const MS_U16 u16Arg7 , const MS_U16 u16Arg8, const MS_U16 u16Arg9, const MS_U16 u16Arg10,
...
/** Write a 14 argument message to HSL (just a message header, no data).
  ...
  */
DLL_PUBLIC void M_FrHslPrintf14(MS_U32 u32Id, MS_U16 u16GId, const char* u8Fmt, const MS_U16 u16Arg1, const MS_U16 u16Arg2, const MS_U16 u16Arg3, const MS_U16 u16Arg4, const MS_U16 u16Arg5,
                                    const MS_U16 u16Arg6, const MS_U16 u16Arg7 , const MS_U16 u16Arg8, const MS_U16 u16Arg9, const MS_U16 u16Arg10,
...
/** Write a 15 argument message to HSL (just a message header, no data).
  ...
  */
DLL_PUBLIC void M_FrHslPrintf15(MS_U32 u32Id, MS_U16 u16GId, const char* u8Fmt, const MS_U16 u16Arg1, const MS_U16 u16Arg2, const MS_U16 u16Arg3, const MS_U16 u16Arg4, const MS_U16 u16Arg5,
                                    const MS_U16 u16Arg6, const MS_U16 u16Arg7 , const MS_U16 u16Arg8, const MS_U16 u16Arg9, const MS_U16 u16Arg10,
...
/** Write a 16 argument message to HSL (just a message header, no data).
  ...
  */
DLL_PUBLIC void M_FrHslPrintf16(MS_U32 u32Id, MS_U16 u16GId, const char* u8Fmt, const MS_U16 u16Arg1, const MS_U16 u16Arg2, const MS_U16 u16Arg3, const MS_U16 u16Arg4, const MS_U16 u16Arg5,
                                    const MS_U16 u16Arg6, const MS_U16 u16Arg7 , const MS_U16 u16Arg8, const MS_U16 u16Arg9, const MS_U16 u16Arg10,
 ...
 */
DLL_PUBLIC void M_FrHslString(const MS_U16 u16Id, const MS_U16 u16GId, const char* u8fmt, const void* pArray);
 ...
 *  \param MS_U16 *pDATA = Array of lENGTH MS_U16s.
 */
DLL_PUBLIC void M_FrHslArray16(const MS_U16 u16Id, const MS_U16 u16GId, const char* u8Fmt, const MS_U16 u16Length, const void* pArray);
 ...
 */
DLL_PUBLIC void M_FrHslArray32(const MS_U16 u16Id, const MS_U16 u16GId, const char* u8Fmt, const MS_U16 u16Length, const void* pArray, const MS_BOOL bLastWordEmpty);
...
DLL_PUBLIC void FrHslTypedefCall(const MS_U16 u16Id, const MS_U16 u16GId, const MS_U16 u16Length, const void* pArray, const MS_BOOL bOddBytePresent);
