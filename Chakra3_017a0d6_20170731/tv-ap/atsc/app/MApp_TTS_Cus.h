...
/*                            Header Files                                    */
/******************************************************************************/
#ifndef _MAPP_TTS_CUS_H_
#define _MAPP_TTS_CUS_H_
...
void MApp_TTS_Cus_Add_Str_By_StrId(U16 u16ID);
void MApp_TTS_Cus_Add_Str_By_HWndID(U16 u16ID, EN_TTS_SPEAK enSpeakFormat);


//void MApp_TTSControlSetInputText(U16* str, U16 len);
#define MApp_TTSControlSetInputText(str, len)                   MApp_TTS_Cus_AddUniString(str)
#define MApp_TTS_Cus_Set_InputText_Format(str,enSpeakFormat)    MApp_TTS_Cus_Add_UniStr_Format(str,enSpeakFormat)

//-----------------------------------------------------------------------------------------------

void MApp_TTS_Cus_Say(void);

//#define MApp_TTSControlSetOn(enable)    do { PRINT_CURRENT_LINE(); MApp_TTS_Cus_Say(); } while(0)
#define MApp_TTSControlSetOn(enable)    MApp_TTS_Cus_Say()

//-----------------------------------------------------------------------------------------------
U8* MApp_TTS_Cus_Get_String_UTF8(U16* pu16BufSize);

U8 MApp_TTS_Cus_ConvertSysLang2DriverLang(U16 u16Lang);
