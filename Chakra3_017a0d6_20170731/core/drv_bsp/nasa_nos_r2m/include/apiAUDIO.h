...
typedef enum
{
    ...
    MSAPI_AUD_SIF_CMD2_ADC_VIA_SIF_PIN = 0x02    
} En_AUD_SIF_CmdType;
...
DLL_PUBLIC MS_BOOL MApi_AUDIO_SetAnalogConfig(AnalogConfig_t *pConfig);
DLL_PUBLIC MS_BOOL MApi_AUDIO_GetAnalogConfig(AnalogConfig_t *pConfig);
