...
#ifndef __LPL19_WXGA_H
#define __LPL19_WXGA_H

///////////////////////////////////////////////
// Common setting
///////////////////////////////////////////////
#define PANEL_NAME          "LPL_LM190WX1"
#define PANEL_DOT_WIDTH         285     // unit: um
#define PANEL_DOT_HEIGHT        285     // unit: um
...
#define PANEL_SWAP_LVDS_POL     1//0
#define PANEL_SWAP_LVDS_CH      1//0
...
#define PANEL_ON_TIMING2        520 // time between data & back light while turn on power
#define PANEL_OFF_TIMING1       220 // time between back light & data while turn off power
#define PANEL_OFF_TIMING2       20  // time between data & panel while turn off power

// DE only, H blank spec 30 ~ 240 (pulse width + back porch + fornt porch)
#define PANEL_HSYNC_WIDTH       32
#define PANEL_HSYNC_BACK_PORCH  80

// DE only, V blank spec 5~150 (pulse width + back porch + fornt porch)
#define PANEL_VSYNC_WIDTH       6
#define PANEL_VSYNC_BACK_PORCH  17
...
#define PANEL_MAX_VTOTAL        933
#define PANEL_MIN_VTOTAL        905

#define PANEL_MAX_HTOTAL        1920
#define PANEL_MIN_HTOTAL        1500
#define PANEL_DCLK              (((DWORD)PANEL_HTOTAL*PANEL_VTOTAL*60)/1000000)
#define PANEL_MAX_DCLK          112
#define PANEL_MIN_DCLK          80

#define PANEL_OUT_VFREQ_MIN     56  // min. not avaliable, copy from CMO19
