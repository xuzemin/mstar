...
#include "ZUI_FMRADIO_tables_c.inl"
#include "ZUI_FMRADIO_alphatable_c.inl"
#include "ZUI_GAME_LIST_tables_c.inl"
#include "ZUI_GAME_LIST_alphatable_c.inl"
#include "ZUI_DMP_MINI_MENU_tables_c.inl"
#include "ZUI_DMP_MINI_MENU_alphatable_c.inl"
...
OSDPAGETABLE code OsdTables [] =
{
    ...
    {HWND_DESIGN_MENU_MAX, _GUI_WindowList_Zui_Design_Menu,
         ...
         CLRKEY_LO_R, CLRKEY_LO_G, CLRKEY_LO_B, CLRKEY_HI_R, CLRKEY_HI_G, CLRKEY_HI_B,
         0 },
    {HWND_FMRADIO_MAX, _GUI_WindowList_Zui_Fmradio,
         //_GUI_WindowsDrawStyleList_Zui_Fmradio,
         _GUI_WindowsAlphaList_Zui_Fmradio,
         NULL,
         E_OSD_GWIN0, ZUI_FMRADIO_XSTART, ZUI_FMRADIO_YSTART, ZUI_FMRADIO_WIDTH, ZUI_FMRADIO_HEIGHT, 0, 63, 1,
         CLRKEY_LO_R, CLRKEY_LO_G, CLRKEY_LO_B, CLRKEY_HI_R, CLRKEY_HI_G, CLRKEY_HI_B,
         0 },
    {HWND_GAME_LIST_MAX, _GUI_WindowList_Zui_Game_List,
         //_GUI_WindowsDrawStyleList_Zui_Game_List,
         _GUI_WindowsAlphaList_Zui_Game_List,
         NULL,
         E_OSD_GWIN0, ZUI_GAME_LIST_XSTART, ZUI_GAME_LIST_YSTART, ZUI_GAME_LIST_WIDTH, ZUI_GAME_LIST_HEIGHT, 0, 56, 1,
         CLRKEY_LO_R, CLRKEY_LO_G, CLRKEY_LO_B, CLRKEY_HI_R, CLRKEY_HI_G, CLRKEY_HI_B,
         0 },
    {HWND_DMP_MINI_MENU_MAX, _GUI_WindowList_Zui_Dmp_Mini_Menu,
         //_GUI_WindowsDrawStyleList_Zui_Dmp_Mini_Menu,
         _GUI_WindowsAlphaList_Zui_Dmp_Mini_Menu,
         NULL,
         E_OSD_GWIN0, ZUI_DMP_MINI_MENU_XSTART, ZUI_DMP_MINI_MENU_YSTART, ZUI_DMP_MINI_MENU_WIDTH, ZUI_DMP_MINI_MENU_HEIGHT, 0, 44, 1,
         CLRKEY_LO_R, CLRKEY_LO_G, CLRKEY_LO_B, CLRKEY_HI_R, CLRKEY_HI_G, CLRKEY_HI_B,
         0 },
};
