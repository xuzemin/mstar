...
//-------------------------------------------------------------------------------------------------
/// Set Using Average Luma
// @param  bEnableUsingAverageLuma             \b IN: Using DLC average luma or not
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC void MApi_DLC_SetUsingAverageLuma(MS_BOOL bEnableUsingAverageLuma);
