...
#include "./SiI1292/API/si_1292regs.h"

#define REGIO_SLAVE_PAGE_0          (0xD4)		// Main
...
#define REGIO_SLAVE_PAGE_8          (0xC4)      // CEC
#define REGIO_SLAVE_PAGE_9          (0xA0)      // EDID
#define REGIO_SLAVE_PAGE_A          (0x64)      
#define REGIO_SLAVE_PAGE_B			(0x90)      
#define REGIO_SLAVE_PAGE_C          (0xCC)      // CBUS
#define REGIO_SLAVE_PAGE_D          (0xD4)      
