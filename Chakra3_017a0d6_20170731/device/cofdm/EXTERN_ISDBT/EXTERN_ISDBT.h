...
**********************************************************************/
#ifndef _EXTERN_ISDBT_H_
#define _EXTERN_ISDBT_H_

#ifdef _EXTERN_ISDBT_C_
#define EXTSEL
#else
...
#define     DEMOD_DYNAMIC_SLAVE_ID_EXTERN_ISDB_1          0x01
#define     DEMOD_DYNAMIC_SLAVE_EXTERN_ISDB_ID_2          0x02
#define     DEMOD_DYNAMIC_SLAVE_EXTERN_ISDB_ID_3          0x03
#define     DEMOD_DYNAMIC_SLAVE_EXTERN_ISDB_ID_4          0xD2
...
typedef struct _EXTERN_isdbt_func
{
    BOOLEAN (*WriteBytes)(U8,U8*,U16,U8*);
    BOOLEAN (*ReadBytes)(U8,U8*,U16,U8*);
}S_EXTERN_isdbt_func, *pS_EXTERN_isdbt_func;
...
EXTSEL BOOLEAN EXTERN_ISDBT_Power_On_Initialization(void);
EXTSEL BOOLEAN EXTERN_ISDBT_Lock(COFDM_LOCK_STATUS eStatus);
EXTSEL BOOLEAN EXTERN_ISDBT_Config(RF_CHANNEL_BANDWIDTH BW, BOOLEAN bSerialTS, BOOLEAN bPalBG, BOOLEAN bLPSel);
EXTSEL BOOLEAN EXTERN_ISDBT_Active(BOOLEAN bEnable);
EXTSEL BOOLEAN EXTERN_ISDBT_Serial_Control(BOOLEAN bEnable);
EXTSEL float EXTERN_ISDBT_GetSNR(void);
EXTSEL FUNCTION_RESULT EXTERN_ISDBT_GetSignalStrength(WORD *strength);
EXTSEL FUNCTION_RESULT EXTERN_ISDBT_GetSignalQuality(WORD *quality);
EXTSEL BOOLEAN EXTERN_ISDBT_WriteReg(MS_U16 RegAddr, MS_U8 u8Data);
EXTSEL BOOLEAN EXTERN_ISDBT_ReadReg(MS_U16 RegAddr, MS_U8* pu8Data);
EXTSEL BOOLEAN EXTERN_ISDBT_Exit ( void );
EXTSEL void EXTERN_ISDBT_Power_ON_OFF(MS_U8 bPowerOn);
EXTSEL BOOLEAN EXTERN_ISDBT_Power_Save(void);
EXTSEL void EXTERN_ISDBT_PAD_TS1_Enable(BOOLEAN flag);
