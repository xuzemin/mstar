...
DLL_PUBLIC DMX_FILTER_STATUS MApi_DMX_MMFI_SetPcr2(DMX_MMFI_PATH ePath, MS_U32 u32pcr2);
DLL_PUBLIC DMX_FILTER_STATUS MApi_DMX_MMFI_GetPcr2(DMX_MMFI_PATH ePath, MS_U32 *pu32pcr2);
...
#if 0
DLL_PUBLIC DMX_FILTER_STATUS MApi_DMX_ResetFileinTimestamp(void)
#endif
