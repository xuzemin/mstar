 ...
 *   Modified    : $Date: 2013/04/15 $ By $Author: $
...
static const sony_ascot3_adjust_param_t g_param_table_Rx23x[SONY_ASCOT3_TV_SYSTEM_NUM] = {
    ...
    OUTLMT    IF_BPF_GC  IFOVLD_DET_LV      BW             BW_OFFSET         IF_OUT_SEL
      ...
      |     |    |     |        |   |       |      |          |          |      |      |          */
    {0x00, AUTO, 0x05, 0x00, 0x00, 0x00, BW_6,  OFFSET(0),  OFFSET(1),  PORT2, PORT2, 0x00}, /**< SONY_ASCOT3_TV_SYSTEM_UNKNOWN */
    /* Analog */
    {0x00, AUTO, 0x05, 0x00, 0x00, 0x00, BW_6,  OFFSET(0),  OFFSET(1),  PORT2, PORT2, 0x00}, /**< SONY_ASCOT3_ATV_MN_EIAJ   (System-M (Japan)) */
    {0x00, AUTO, 0x05, 0x00, 0x00, 0x00, BW_6,  OFFSET(0),  OFFSET(1),  PORT2, PORT2, 0x00}, /**< SONY_ASCOT3_ATV_MN_SAP    (System-M (US)) */
    {0x00, AUTO, 0x05, 0x00, 0x00, 0x00, BW_6,  OFFSET(3),  OFFSET(1),  PORT2, PORT2, 0x00}, /**< SONY_ASCOT3_ATV_MN_A2     (System-M (Korea)) */
    {0x00, AUTO, 0x05, 0x00, 0x00, 0x00, BW_7,  OFFSET(11), OFFSET(5),  PORT2, PORT2, 0x00}, /**< SONY_ASCOT3_ATV_BG        (System-B/G) */
    {0x00, AUTO, 0x05, 0x00, 0x00, 0x00, BW_8,  OFFSET(2),  OFFSET(-3), PORT2, PORT2, 0x00}, /**< SONY_ASCOT3_ATV_I         (System-I) */
    {0x00, AUTO, 0x05, 0x00, 0x00, 0x00, BW_8,  OFFSET(2),  OFFSET(-3), PORT2, PORT2, 0x00}, /**< SONY_ASCOT3_ATV_DK        (System-D/K) */
    {0x00, AUTO, 0x03, 0x01, 0x03, 0x00, BW_8,  OFFSET(2),  OFFSET(-3), PORT2, PORT2, 0x00}, /**< SONY_ASCOT3_ATV_L         (System-L) */
    {0x00, AUTO, 0x03, 0x01, 0x03, 0x00, BW_8,  OFFSET(-1), OFFSET(4),  PORT2, PORT2, 0x00}, /**< SONY_ASCOT3_ATV_L_DASH    (System-L DASH) */
    /* Digital */
    {0x00, AUTO, 0x09, 0x0A, 0x00, 0x00, BW_6,  OFFSET(-6), OFFSET(-3), PORT2, PORT2, 0x00}, /**< SONY_ASCOT3_DTV_8VSB      (ATSC 8VSB) */
    {0x00, AUTO, 0x09, 0x0A, 0x00, 0x00, BW_6,  OFFSET(-6), OFFSET(-3), PORT2, PORT2, 0x00}, /**< SONY_ASCOT3_DTV_QAM       (US QAM) */
    {0x00, AUTO, 0x09, 0x0A, 0x00, 0x00, BW_6,  OFFSET(-9), OFFSET(-5), PORT2, PORT2, 0x00}, /**< SONY_ASCOT3_DTV_ISDBT_6   (ISDB-T 6MHzBW) */
    {0x00, AUTO, 0x09, 0x0A, 0x00, 0x00, BW_7,  OFFSET(-7), OFFSET(-6), PORT2, PORT2, 0x00}, /**< SONY_ASCOT3_DTV_ISDBT_7   (ISDB-T 7MHzBW) */
    {0x00, AUTO, 0x09, 0x0A, 0x00, 0x00, BW_8,  OFFSET(-5), OFFSET(-7), PORT2, PORT2, 0x00}, /**< SONY_ASCOT3_DTV_ISDBT_8   (ISDB-T 8MHzBW) */
    {0x00, AUTO, 0x09, 0x0A, 0x00, 0x00, BW_6,  OFFSET(-8), OFFSET(-3), PORT2, PORT2, 0x00}, /**< SONY_ASCOT3_DTV_DVBT_5    (DVB-T 5MHzBW) */
    {0x00, AUTO, 0x09, 0x0A, 0x00, 0x00, BW_6,  OFFSET(-8), OFFSET(-3), PORT2, PORT2, 0x00}, /**< SONY_ASCOT3_DTV_DVBT_6    (DVB-T 6MHzBW) */
    {0x00, AUTO, 0x09, 0x0A, 0x00, 0x00, BW_7,  OFFSET(-6), OFFSET(-5), PORT2, PORT2, 0x00}, /**< SONY_ASCOT3_DTV_DVBT_7    (DVB-T 7MHzBW) */
    {0x00, AUTO, 0x09, 0x0A, 0x00, 0x00, BW_8,  OFFSET(-4), OFFSET(-6), PORT2, PORT2, 0x00}, /**< SONY_ASCOT3_DTV_DVBT_8    (DVB-T 8MHzBW) */
    {0x00, AUTO, 0x09, 0x0A, 0x00, 0x00, BW_1_7,OFFSET(-10),OFFSET(-10),PORT2, PORT2, 0x00}, /**< SONY_ASCOT3_DTV_DVBT2_1_7 (DVB-T2 1.7MHzBW) */
    {0x00, AUTO, 0x09, 0x0A, 0x00, 0x00, BW_6,  OFFSET(-8), OFFSET(-3), PORT2, PORT2, 0x00}, /**< SONY_ASCOT3_DTV_DVBT2_5   (DVB-T2 5MHzBW) */
    {0x00, AUTO, 0x09, 0x0A, 0x00, 0x00, BW_6,  OFFSET(-8), OFFSET(-3), PORT2, PORT2, 0x00}, /**< SONY_ASCOT3_DTV_DVBT2_6   (DVB-T2 6MHzBW) */
    {0x00, AUTO, 0x09, 0x0A, 0x00, 0x00, BW_7,  OFFSET(-6), OFFSET(-5), PORT2, PORT2, 0x00}, /**< SONY_ASCOT3_DTV_DVBT2_7   (DVB-T2 7MHzBW) */
    {0x00, AUTO, 0x09, 0x0A, 0x00, 0x00, BW_8,  OFFSET(-4), OFFSET(-6), PORT2, PORT2, 0x00}, /**< SONY_ASCOT3_DTV_DVBT2_8   (DVB-T2 8MHzBW) */
    {0x00, AUTO, 0x05, 0x00, 0x00, 0x00, BW_8,  OFFSET(-2), OFFSET(-3), PORT2, PORT2, 0x00}, /**< SONY_ASCOT3_DTV_DVBC      (DVB-C) */
    {0x00, AUTO, 0x03, 0x08, 0x00, 0x00, BW_6,  OFFSET(-6), OFFSET(-2), PORT2, PORT2, 0x00}, /**< SONY_ASCOT3_DTV_DVBC2_6   (DVB-C2 6MHzBW) */
    {0x00, AUTO, 0x03, 0x08, 0x00, 0x00, BW_8,  OFFSET(-2), OFFSET(0),  PORT2, PORT2, 0x00}, /**< SONY_ASCOT3_DTV_DVBC2_8   (DVB-C2 8MHzBW) */
    {0x00, AUTO, 0x04, 0x0A, 0x00, 0x00, BW_8,  OFFSET(2),  OFFSET(1),  PORT2, PORT2, 0x00}  /**< SONY_ASCOT3_DTV_DTMB      (DTMB) */
};
...
static INT16 tuner_calcRSSI(UINT16 reg){
    ...
    iic_read( tuner_block_id, 0x70, t_data, 3 );
    freq = (UINT32)(t_data[0] & 0xff)
         + ((UINT32)(t_data[1] & 0xff) <<  8)
         + ((UINT32)(t_data[2] & 0x0f) << 16); 

    if     (  freq > 800000                        ) { coef_x100 = 120; ofs_x100 = 2050; }
    else if(( freq > 600000 ) && ( freq <= 800000 )) { coef_x100 = 122; ofs_x100 = 2200; }
    else if(( freq > 464000 ) && ( freq <= 600000 )) { coef_x100 = 122; ofs_x100 = 2000; }
    else if(( freq > 460000 ) && ( freq <= 464000 )) { coef_x100 = 125; ofs_x100 = 2000; }
    else if(( freq > 350000 ) && ( freq <= 460000 )) { coef_x100 = 125; ofs_x100 = 2500; }
    else if(( freq > 215000 ) && ( freq <= 350000 )) { coef_x100 = 125; ofs_x100 = 2400; }
    else if(( freq > 170000 ) && ( freq <= 215000 )) { coef_x100 = 125; ofs_x100 = 2200; }
    else if(( freq >  86000 ) && ( freq <= 170000 )) { coef_x100 = 125; ofs_x100 = 2400; }
    else                                             { coef_x100 = 125; ofs_x100 = 2250; }
...
UINT8 mdev_TunerSetPllData_SUT(MS_U32 u32FreqInKHz, IF_FREQ eIF_Freq)
{
    ...
    if (u32FreqInKHz < 40250 || u32FreqInKHz > 883250)
    {
         printf("ERROR : frequency is Illegal, 40250KHz ~ 883250KHz, freq=%ld\n",u32FreqInKHz);
         return 0;
    }
 ...
 *                   supported & adjusted RSSI params.
 ******************************************************************************/
