...
//
////////////////////////////////////////////////////////////////////////////////
#ifndef _DRVVIFINITIAL_MST_MARLON_H_
#define _DRVVIFINITIAL_MST_MARLON_H_
...
#if (VIF_TUNER_TYPE == 0)
#ifndef VIF_SAW_ARCH
#define VIF_SAW_ARCH                    1                   // 0: Dual SAW; 1: external Single SAW; 2:silicon tuner; 3: no saw (not support); 4: internal single SAW (not support)
#endif
#else
#ifndef VIF_SAW_ARCH
...
#define VIF_TOP              	        5  		            // [3:0], Take Over Point (TOP) adjustment (range 0~15) //berlin 20090918
#else
...
#if(VIF_SAW_ARCH == 1 || VIF_SAW_ARCH==2)
#define VIF_AGC_REF_NEGATIVE   	       0x50// Need to be finetune. 0x70                // [7:0], AGC reference level for negative modulation
#else
...
#define VIF_PEAKING_FILTER_B_VHF_L            5                   // [7:0], 0: (null) peaking filter; 1: 1dB peaking filter; 2: 2dB peaking filter; 3: 3dB peaking filter; 4: 4dB peaking filter; 5: (VSB) 3dB peaking filter; 6: (VSB) 4dB peaking filter; 7: (VSB) 5dB peaking filter; 0x80: User define SOS21 filter
...
#define VIF_PEAKING_FILTER_GH_VHF_L           5                   // [7:0], 0: (null) peaking filter; 1: 1dB peaking filter; 2: 2dB peaking filter; 3: 3dB peaking filter; 4: 4dB peaking filter; 5: (VSB) 3dB peaking filter; 6: (VSB) 4dB peaking filter; 7: (VSB) 5dB peaking filter; 0x80: User define SOS21 filter
...
#define VIF_PEAKING_FILTER_B_VHF_H            5                   // [7:0], 0: (null) peaking filter; 1: 1dB peaking filter; 2: 2dB peaking filter; 3: 3dB peaking filter; 4: 4dB peaking filter; 5: (VSB) 3dB peaking filter; 6: (VSB) 4dB peaking filter; 7: (VSB) 5dB peaking filter; 0x80: User define SOS21 filter
...
#define VIF_PEAKING_FILTER_GH_VHF_H           5                   // [7:0], 0: (null) peaking filter; 1: 1dB peaking filter; 2: 2dB peaking filter; 3: 3dB peaking filter; 4: 4dB peaking filter; 5: (VSB) 3dB peaking filter; 6: (VSB) 4dB peaking filter; 7: (VSB) 5dB peaking filter; 0x80: User define SOS21 filter
...
#define VIF_PEAKING_FILTER_B_UHF            5                   // [7:0], 0: (null) peaking filter; 1: 1dB peaking filter; 2: 2dB peaking filter; 3: 3dB peaking filter; 4: 4dB peaking filter; 5: (VSB) 3dB peaking filter; 6: (VSB) 4dB peaking filter; 7: (VSB) 5dB peaking filter; 0x80: User define SOS21 filter
...
#define VIF_PEAKING_FILTER_GH_UHF           5                   // [7:0], 0: (null) peaking filter; 1: 1dB peaking filter; 2: 2dB peaking filter; 3: 3dB peaking filter; 4: 4dB peaking filter; 5: (VSB) 3dB peaking filter; 6: (VSB) 4dB peaking filter; 7: (VSB) 5dB peaking filter; 0x80: User define SOS21 filter
...
#define VIF_ACI_DETECTOR                     0                  // 0:Not detect ACI ; 1:detect ACI
#define VIF_ACI_AGC_REF                               0x30
#define VIF_ADC_OVERFLOW_AGC_REF           0x20
#define VIF_CHANEL_SCAN_AGC_REF              0x60
#define VIF_SERIOUS_ACI_DETECTION		   0
#define VIF_ACIDET_THR1                  0x16
#define VIF_ACIDET_THR2                  0x0A
#define VIF_ACIDET_THR3                  0x08
#define VIF_ACIDET_THR4                  0x03
...
#if (FRONTEND_TUNER_TYPE==NXP_TDA18272_TUNER || FRONTEND_TUNER_TYPE==NUTUNE_FK1602_TUNER || FRONTEND_TUNER_TYPE==NXP_TDA18273_TUNER)
#define VIF_CR_RATE_B                   0x00097B42//0x00024079          // [21:0], CR_RATE for 6.4 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_B                 0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_GH                  0x000A0000//0x00024079          // [21:0], CR_RATE for 6.75 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_GH                0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_DK                  0x000A25ED//0x00024079          // [21:0], CR_RATE for 6.85 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_DK                0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_I                   0x000ABDA1//0x00024079          // [21:0], CR_RATE for 7.25 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_I                 0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_L                   0x000A0000//0x00024079          // [21:0], CR_RATE for 6.75 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_L                 0                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_LL                  0x0001DA12          // [21:0], CR_RATE for 1.25 MHz, HEX((xxx/43.2) * (2^22))
#define VIF_CR_INVERT_LL                1                   // Video carrier position; 0: high side; 1:low side
#define VIF_CR_RATE_MN                  0x00080000          // [21:0], CR_RATE for 5.4 MHz, HEX((xxx/43.2) * (2^22))
...
#endif //_DRVVIFINITIAL_MST_A1_H_
