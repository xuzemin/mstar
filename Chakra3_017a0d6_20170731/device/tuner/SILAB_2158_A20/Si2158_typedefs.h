...
/* _additional_definitions_point */
#ifndef __SPURSHIFTINGTABLE_STRUCT__
#define __SPURSHIFTINGTABLE_STRUCT__
typedef struct  {
    unsigned long ChannelFreq;
	unsigned char DebugSampleFreq;
} spurshiftingtable_struct;
#endif /* __SPURSHIFTINGTABLE_STRUCT__ */
