...
// 1920
// Whisky
// 10/20/2016  4:34:43 PM
// 42663.6907755
//****************************************************

#ifndef _WHISKY_MAIN_H_
#define _WHISKY_MAIN_H_

#define PQ_IP_NUM_Main 180
...
typedef enum
{
    ...
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_SD_interlace_Main, //123
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_SD_progressive_Main, //124
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_SD_progressive_24hz_Main, //125
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_HD_interlace_Main, //126
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_HD_progressive_Main, //127
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_HD_progressive_24hz_Main, //128
    #endif
    #if PQ_QM_MM_PHOTO
    QM_Multimedia_photo_SD_progressive_Main, //129
    #endif
    #if PQ_QM_MM_PHOTO
    QM_Multimedia_photo_HD_progressive_Main, //130
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_SD_interlace_Main, //131
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_SD_progressive_Main, //132
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_SD_progressive_24hz_Main, //133
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_HD_interlace_Main, //134
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_HD_progressive_Main, //135
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_HD_progressive_24hz_Main, //136
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_SD_interlace_Main, //137
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_SD_progressive_Main, //138
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_HD_interlace_Main, //139
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_HD_progressive_Main, //140
    #endif
    #if PQ_QM_3D
    QM_3D_Video_interlace_Main, //141
    #endif
    #if PQ_QM_3D
    QM_3D_Video_progressive_Main, //142
    #endif
    QM_INPUTTYPE_NUM_Main, // 143
...
PQ_IP_DNR_Y_Main,  //22
PQ_IP_DNR_C_Main,  //23
PQ_IP_DNR_sticky_solver_Main,  //24
PQ_IP_PostCCS_Main,  //25
PQ_IP_PostCCS_NP_Main,  //26
PQ_IP_DHD_Main,  //27
PQ_IP_420CUP_Main,  //28
PQ_IP_BWS_Main,  //29
PQ_IP_MADi_Main,  //30
PQ_IP_MADi_Motion_Main,  //31
PQ_IP_MADi_ADP3x3_Main,  //32
PQ_IP_MADi_MORPHO_Main,  //33
PQ_IP_MADi_DFK_Main,  //34
PQ_IP_MADi_SST_Main,  //35
PQ_IP_MADi_EODiW_Main,  //36
PQ_IP_MADi_Force_Main,  //37
PQ_IP_EODi_Main,  //38
PQ_IP_Film_Main,  //39
PQ_IP_Film32_Main,  //40
PQ_IP_Film22_Main,  //41
PQ_IP_Film_any_Main,  //42
PQ_IP_UCNR_Main,  //43
PQ_IP_UCDi_Main,  //44
PQ_IP_UC_CTL_Main,  //45
PQ_IP_DIPF_Main,  //46
PQ_IP_VCLPF_Main,  //47
PQ_IP_SPF_Main,  //48
PQ_IP_Spike_NR_Main,  //49
PQ_IP_SPF_DBK_Main,  //50
PQ_IP_SPF_DBK_MR_Main,  //51
PQ_IP_SPF_DBK_BKN_Main,  //52
PQ_IP_SPF_SNR_Main,  //53
PQ_IP_SPF_SNR_MR_Main,  //54
PQ_IP_SPF_MR_LPF_Main,  //55
PQ_IP_SPF_NMR_Y_Main,  //56
PQ_IP_SPF_NMR_Y_MR_Main,  //57
PQ_IP_DMS_Main,  //58
PQ_IP_DMS_H_Main,  //59
PQ_IP_VSP_Y_Main,  //60
PQ_IP_VSP_C_Main,  //61
PQ_IP_VSP_CoRing_Main,  //62
PQ_IP_VSP_Dither_Main,  //63
PQ_IP_VSP_PreVBound_Main,  //64
PQ_IP_422To444_Main,  //65
PQ_IP_PreCTI_Main,  //66
PQ_IP_HSP_Y_Main,  //67
PQ_IP_HSP_C_Main,  //68
PQ_IP_HSP_CoRing_Main,  //69
PQ_IP_HSP_Dither_Main,  //70
PQ_IP_HnonLinear_Main,  //71
PQ_IP_SRAM1_Main,  //72
PQ_IP_SRAM2_Main,  //73
PQ_IP_SRAM3_Main,  //74
PQ_IP_SRAM4_Main,  //75
PQ_IP_C_SRAM1_Main,  //76
PQ_IP_C_SRAM2_Main,  //77
PQ_IP_C_SRAM3_Main,  //78
PQ_IP_C_SRAM4_Main,  //79
PQ_IP_VIP_Main,  //80
PQ_IP_VIP_pseudo_Main,  //81
PQ_IP_VIP_CSC_Main,  //82
PQ_IP_VIP_CSC_dither_Main,  //83
PQ_IP_VIP_Post_YC_delay_Main,  //84
PQ_IP_VIP_HNMR_Y_Main,  //85
PQ_IP_VIP_HNMR_ad_C_Main,  //86
PQ_IP_VIP_HNMR_ad_C_gain_Main,  //87
PQ_IP_VIP_HNMR_C_win1_Main,  //88
PQ_IP_VIP_Pre_Yoffset_Main,  //89
PQ_IP_VIP_Pre_Ygain_Main,  //90
PQ_IP_VIP_Pre_Ygain_dither_Main,  //91
PQ_IP_VIP_HLPF_Main,  //92
PQ_IP_VIP_HLPF_dither_Main,  //93
PQ_IP_VIP_VNMR_Main,  //94
PQ_IP_VIP_VLPF_coef1_Main,  //95
PQ_IP_VIP_VLPF_coef2_Main,  //96
PQ_IP_VIP_VLPF_dither_Main,  //97
PQ_IP_VIP_Peaking_Main,  //98
PQ_IP_VIP_Peaking_band_Main,  //99
PQ_IP_VIP_Peaking_Pcoring_Main,  //100
PQ_IP_VIP_Peaking_Pcoring_ad_C_Main,  //101
PQ_IP_VIP_Peaking_gain_Main,  //102
PQ_IP_VIP_Peaking_gain_ad_C_Main,  //103
PQ_IP_VIP_Post_SNR_Main,  //104
PQ_IP_VIP_Post_CTI_Main,  //105
PQ_IP_VIP_Post_CTI_coef_Main,  //106
PQ_IP_VIP_Post_CTI_gray_Main,  //107
PQ_IP_VIP_FCC_full_range_Main,  //108
PQ_IP_VIP_FCC_bdry_dist_Main,  //109
PQ_IP_VIP_FCC_T1_Main,  //110
PQ_IP_VIP_FCC_T2_Main,  //111
PQ_IP_VIP_FCC_T3_Main,  //112
PQ_IP_VIP_FCC_T4_Main,  //113
PQ_IP_VIP_FCC_T5_Main,  //114
PQ_IP_VIP_FCC_T6_Main,  //115
PQ_IP_VIP_FCC_T7_Main,  //116
PQ_IP_VIP_FCC_T8_Main,  //117
PQ_IP_VIP_FCC_T9_Main,  //118
PQ_IP_VIP_IHC_Main,  //119
PQ_IP_VIP_IHC_Ymode_Main,  //120
PQ_IP_VIP_IHC_dither_Main,  //121
PQ_IP_VIP_IHC_CRD_SRAM_Main,  //122
PQ_IP_VIP_IHC_SETTING_Main,  //123
PQ_IP_VIP_ICC_Main,  //124
PQ_IP_VIP_ICC_Ymode_Main,  //125
PQ_IP_VIP_ICC_dither_Main,  //126
PQ_IP_VIP_ICC_CRD_SRAM_Main,  //127
PQ_IP_VIP_ICC_SETTING_Main,  //128
PQ_IP_VIP_Ymode_Yvalue_ALL_Main,  //129
PQ_IP_VIP_Ymode_Yvalue_SETTING_Main,  //130
PQ_IP_VIP_IBC_Main,  //131
PQ_IP_VIP_IBC_dither_Main,  //132
PQ_IP_VIP_IBC_SETTING_Main,  //133
PQ_IP_VIP_DLC_Main,  //134
PQ_IP_VIP_DLC_ad_C_Main,  //135
PQ_IP_VIP_DLC_dither_Main,  //136
PQ_IP_VIP_DLC_His_range_Main,  //137
PQ_IP_VIP_DLC_His_rangeH_Main,  //138
PQ_IP_VIP_DLC_His_rangeV_Main,  //139
PQ_IP_VIP_DLC_PC_Main,  //140
PQ_IP_VIP_BWLE_Main,  //141
PQ_IP_VIP_BLE_Main,  //142
PQ_IP_VIP_WLE_Main,  //143
PQ_IP_VIP_BWLE_dither_Main,  //144
PQ_IP_VIP_UVC_Main,  //145
PQ_IP_VIP_Post_Yoffset_Main,  //146
PQ_IP_VIP_Post_Ygain_Main,  //147
PQ_IP_VIP_Post_Cgain_Main,  //148
PQ_IP_VIP_Hcoring_Y_Main,  //149
PQ_IP_VIP_Hcoring_C_Main,  //150
PQ_IP_VIP_Hcoring_dither_Main,  //151
PQ_IP_VIP_YCbCr_Clip_Main,  //152
PQ_IP_SwDriver_Main,  //153
PQ_IP_3x3_Main,  //154
PQ_IP_RGB_Offset_Main,  //155
PQ_IP_RGB_Clip_Main,  //156
PQ_IP_xvYCC_bypass_Main,  //157
PQ_IP_xvYCC_de_gamma_Main,  //158
PQ_IP_XVYCC_DE_GAMMA_SRAM_Main,  //159
PQ_IP_xvYCC_de_gamma_dither_Main,  //160
PQ_IP_xvYCC_3x3_Main,  //161
PQ_IP_xvYCC_Comp_Main,  //162
PQ_IP_xvYCC_Comp_dither_Main,  //163
PQ_IP_xvYCC_Clip_Main,  //164
PQ_IP_xvYCC_gamma_Main,  //165
PQ_IP_XVYCC_GAMMA_SRAM_Main,  //166
PQ_IP_xvYCC_gamma_dither_Main,  //167
PQ_IP_HBC_Main,  //168
PQ_IP_Pre_CON_BRI_Main,  //169
PQ_IP_Blue_Stretch_Main,  //170
PQ_IP_Blue_Stretch_dither_Main,  //171
PQ_IP_Gamma_Main,  //172
PQ_IP_Gamma_dither_Main,  //173
PQ_IP_Post_CON_BRI_Main,  //174
PQ_IP_Clone_main_no_comm_Main,  //175
PQ_IP_Clone_sub_no_comm_Main,  //176
PQ_IP_MWE_diff_no_comm_Main,  //177
PQ_IP_3DSettingForLBL_no_comm_Main,  //178
PQ_IP_SettingFor2LineMode_no_comm_Main,  //179
 }   PQ_IPTYPE_Main;
...
PQ_IP_DNR_Y_COM_Main,  //22
PQ_IP_DNR_C_COM_Main,  //23
PQ_IP_DNR_sticky_solver_COM_Main,  //24
PQ_IP_PostCCS_COM_Main,  //25
PQ_IP_PostCCS_NP_COM_Main,  //26
PQ_IP_DHD_COM_Main,  //27
PQ_IP_420CUP_COM_Main,  //28
PQ_IP_BWS_COM_Main,  //29
PQ_IP_MADi_COM_Main,  //30
PQ_IP_MADi_Motion_COM_Main,  //31
PQ_IP_MADi_ADP3x3_COM_Main,  //32
PQ_IP_MADi_MORPHO_COM_Main,  //33
PQ_IP_MADi_DFK_COM_Main,  //34
PQ_IP_MADi_SST_COM_Main,  //35
PQ_IP_MADi_EODiW_COM_Main,  //36
PQ_IP_MADi_Force_COM_Main,  //37
PQ_IP_EODi_COM_Main,  //38
PQ_IP_Film_COM_Main,  //39
PQ_IP_Film32_COM_Main,  //40
PQ_IP_Film22_COM_Main,  //41
PQ_IP_Film_any_COM_Main,  //42
PQ_IP_UCNR_COM_Main,  //43
PQ_IP_UCDi_COM_Main,  //44
PQ_IP_UC_CTL_COM_Main,  //45
PQ_IP_DIPF_COM_Main,  //46
PQ_IP_VCLPF_COM_Main,  //47
PQ_IP_SPF_COM_Main,  //48
PQ_IP_Spike_NR_COM_Main,  //49
PQ_IP_SPF_DBK_COM_Main,  //50
PQ_IP_SPF_DBK_MR_COM_Main,  //51
PQ_IP_SPF_DBK_BKN_COM_Main,  //52
PQ_IP_SPF_SNR_COM_Main,  //53
PQ_IP_SPF_SNR_MR_COM_Main,  //54
PQ_IP_SPF_MR_LPF_COM_Main,  //55
PQ_IP_SPF_NMR_Y_COM_Main,  //56
PQ_IP_SPF_NMR_Y_MR_COM_Main,  //57
PQ_IP_DMS_COM_Main,  //58
PQ_IP_DMS_H_COM_Main,  //59
PQ_IP_VSP_Y_COM_Main,  //60
PQ_IP_VSP_C_COM_Main,  //61
PQ_IP_VSP_CoRing_COM_Main,  //62
PQ_IP_VSP_Dither_COM_Main,  //63
PQ_IP_VSP_PreVBound_COM_Main,  //64
PQ_IP_422To444_COM_Main,  //65
PQ_IP_PreCTI_COM_Main,  //66
PQ_IP_HSP_Y_COM_Main,  //67
PQ_IP_HSP_C_COM_Main,  //68
PQ_IP_HSP_CoRing_COM_Main,  //69
PQ_IP_HSP_Dither_COM_Main,  //70
PQ_IP_HnonLinear_COM_Main,  //71
PQ_IP_SRAM1_COM_Main,  //72
PQ_IP_SRAM2_COM_Main,  //73
PQ_IP_SRAM3_COM_Main,  //74
PQ_IP_SRAM4_COM_Main,  //75
PQ_IP_C_SRAM1_COM_Main,  //76
PQ_IP_C_SRAM2_COM_Main,  //77
PQ_IP_C_SRAM3_COM_Main,  //78
PQ_IP_C_SRAM4_COM_Main,  //79
PQ_IP_VIP_COM_Main,  //80
PQ_IP_VIP_pseudo_COM_Main,  //81
PQ_IP_VIP_CSC_COM_Main,  //82
PQ_IP_VIP_CSC_dither_COM_Main,  //83
PQ_IP_VIP_Post_YC_delay_COM_Main,  //84
PQ_IP_VIP_HNMR_Y_COM_Main,  //85
PQ_IP_VIP_HNMR_ad_C_COM_Main,  //86
PQ_IP_VIP_HNMR_ad_C_gain_COM_Main,  //87
PQ_IP_VIP_HNMR_C_win1_COM_Main,  //88
PQ_IP_VIP_Pre_Yoffset_COM_Main,  //89
PQ_IP_VIP_Pre_Ygain_COM_Main,  //90
PQ_IP_VIP_Pre_Ygain_dither_COM_Main,  //91
PQ_IP_VIP_HLPF_COM_Main,  //92
PQ_IP_VIP_HLPF_dither_COM_Main,  //93
PQ_IP_VIP_VNMR_COM_Main,  //94
PQ_IP_VIP_VLPF_coef1_COM_Main,  //95
PQ_IP_VIP_VLPF_coef2_COM_Main,  //96
PQ_IP_VIP_VLPF_dither_COM_Main,  //97
PQ_IP_VIP_Peaking_COM_Main,  //98
PQ_IP_VIP_Peaking_band_COM_Main,  //99
PQ_IP_VIP_Peaking_Pcoring_COM_Main,  //100
PQ_IP_VIP_Peaking_Pcoring_ad_C_COM_Main,  //101
PQ_IP_VIP_Peaking_gain_COM_Main,  //102
PQ_IP_VIP_Peaking_gain_ad_C_COM_Main,  //103
PQ_IP_VIP_Post_SNR_COM_Main,  //104
PQ_IP_VIP_Post_CTI_COM_Main,  //105
PQ_IP_VIP_Post_CTI_coef_COM_Main,  //106
PQ_IP_VIP_Post_CTI_gray_COM_Main,  //107
PQ_IP_VIP_FCC_full_range_COM_Main,  //108
PQ_IP_VIP_FCC_bdry_dist_COM_Main,  //109
PQ_IP_VIP_FCC_T1_COM_Main,  //110
PQ_IP_VIP_FCC_T2_COM_Main,  //111
PQ_IP_VIP_FCC_T3_COM_Main,  //112
PQ_IP_VIP_FCC_T4_COM_Main,  //113
PQ_IP_VIP_FCC_T5_COM_Main,  //114
PQ_IP_VIP_FCC_T6_COM_Main,  //115
PQ_IP_VIP_FCC_T7_COM_Main,  //116
PQ_IP_VIP_FCC_T8_COM_Main,  //117
PQ_IP_VIP_FCC_T9_COM_Main,  //118
PQ_IP_VIP_IHC_COM_Main,  //119
PQ_IP_VIP_IHC_Ymode_COM_Main,  //120
PQ_IP_VIP_IHC_dither_COM_Main,  //121
PQ_IP_VIP_IHC_CRD_SRAM_COM_Main,  //122
PQ_IP_VIP_IHC_SETTING_COM_Main,  //123
PQ_IP_VIP_ICC_COM_Main,  //124
PQ_IP_VIP_ICC_Ymode_COM_Main,  //125
PQ_IP_VIP_ICC_dither_COM_Main,  //126
PQ_IP_VIP_ICC_CRD_SRAM_COM_Main,  //127
PQ_IP_VIP_ICC_SETTING_COM_Main,  //128
PQ_IP_VIP_Ymode_Yvalue_ALL_COM_Main,  //129
PQ_IP_VIP_Ymode_Yvalue_SETTING_COM_Main,  //130
PQ_IP_VIP_IBC_COM_Main,  //131
PQ_IP_VIP_IBC_dither_COM_Main,  //132
PQ_IP_VIP_IBC_SETTING_COM_Main,  //133
PQ_IP_VIP_DLC_COM_Main,  //134
PQ_IP_VIP_DLC_ad_C_COM_Main,  //135
PQ_IP_VIP_DLC_dither_COM_Main,  //136
PQ_IP_VIP_DLC_His_range_COM_Main,  //137
PQ_IP_VIP_DLC_His_rangeH_COM_Main,  //138
PQ_IP_VIP_DLC_His_rangeV_COM_Main,  //139
PQ_IP_VIP_DLC_PC_COM_Main,  //140
PQ_IP_VIP_BWLE_COM_Main,  //141
PQ_IP_VIP_BLE_COM_Main,  //142
PQ_IP_VIP_WLE_COM_Main,  //143
PQ_IP_VIP_BWLE_dither_COM_Main,  //144
PQ_IP_VIP_UVC_COM_Main,  //145
PQ_IP_VIP_Post_Yoffset_COM_Main,  //146
PQ_IP_VIP_Post_Ygain_COM_Main,  //147
PQ_IP_VIP_Post_Cgain_COM_Main,  //148
PQ_IP_VIP_Hcoring_Y_COM_Main,  //149
PQ_IP_VIP_Hcoring_C_COM_Main,  //150
PQ_IP_VIP_Hcoring_dither_COM_Main,  //151
PQ_IP_VIP_YCbCr_Clip_COM_Main,  //152
PQ_IP_SwDriver_COM_Main,  //153
PQ_IP_3x3_COM_Main,  //154
PQ_IP_RGB_Offset_COM_Main,  //155
PQ_IP_RGB_Clip_COM_Main,  //156
PQ_IP_xvYCC_bypass_COM_Main,  //157
PQ_IP_xvYCC_de_gamma_COM_Main,  //158
PQ_IP_XVYCC_DE_GAMMA_SRAM_COM_Main,  //159
PQ_IP_xvYCC_de_gamma_dither_COM_Main,  //160
PQ_IP_xvYCC_3x3_COM_Main,  //161
PQ_IP_xvYCC_Comp_COM_Main,  //162
PQ_IP_xvYCC_Comp_dither_COM_Main,  //163
PQ_IP_xvYCC_Clip_COM_Main,  //164
PQ_IP_xvYCC_gamma_COM_Main,  //165
PQ_IP_XVYCC_GAMMA_SRAM_COM_Main,  //166
PQ_IP_xvYCC_gamma_dither_COM_Main,  //167
PQ_IP_HBC_COM_Main,  //168
PQ_IP_Pre_CON_BRI_COM_Main,  //169
PQ_IP_Blue_Stretch_COM_Main,  //170
PQ_IP_Blue_Stretch_dither_COM_Main,  //171
PQ_IP_Gamma_COM_Main,  //172
PQ_IP_Gamma_dither_COM_Main,  //173
PQ_IP_Post_CON_BRI_COM_Main,  //174
PQ_IP_Clone_main_no_comm_COM_Main,  //175
PQ_IP_Clone_sub_no_comm_COM_Main,  //176
PQ_IP_MWE_diff_no_comm_COM_Main,  //177
PQ_IP_3DSettingForLBL_no_comm_COM_Main,  //178
PQ_IP_SettingFor2LineMode_no_comm_COM_Main,  //179
PQ_IP_COM_NUMS_Main
...
PQ_IP_UC_CTL_ON_New_Main,
PQ_IP_UC_CTL_ON_DHD_New_Main,
PQ_IP_UC_CTL_ON_UCNR_New_Main,
...
extern code U8 QMAP_1920_32M_Main[QM_INPUTTYPE_NUM_Main][PQ_IP_NUM_Main];
extern code U8 QMAP_1366_Main[QM_INPUTTYPE_NUM_Main][PQ_IP_NUM_Main];
extern code U8 QMAP_1366_32M_Main[QM_INPUTTYPE_NUM_Main][PQ_IP_NUM_Main];
