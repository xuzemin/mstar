...
void msAPI_sha1_finish( sha1_context *ctx, unsigned char output[20] )
{
    ...
    msAPI_sha1_update( ctx, (unsigned char *) sha1_padding, padn );
    msAPI_sha1_update( ctx, msglen, 8 );
...
void msAPI_sha1( unsigned char *input, int ilen, unsigned char output[20] )
{
    ...
    msAPI_sha1_starts( &ctx );
    msAPI_sha1_update( &ctx, input, ilen );
    msAPI_sha1_finish( &ctx, output );
...
int msAPI_sha1_file( char *path, unsigned char output[20] )
{
    ...
    while( ( n = fread( buf, 1, sizeof( buf ), f ) ) > 0 )
        msAPI_sha1_update( &ctx, buf, (int) n );
...
void msAPI_sha1_hmac_starts( sha1_context *ctx, unsigned char *key, int keylen )
{
    ...
    msAPI_sha1_starts( ctx );
    msAPI_sha1_update( ctx, ctx->ipad, 64 );
...
void msAPI_sha1_hmac_finish( sha1_context *ctx, unsigned char output[20] )
{
    ...
    msAPI_sha1_finish( ctx, tmpbuf );
    msAPI_sha1_starts( ctx );
    msAPI_sha1_update( ctx, ctx->opad, 64 );
    msAPI_sha1_update( ctx, tmpbuf, 20 );
    msAPI_sha1_finish( ctx, output );
                ...
                unsigned char output[20] )
{
    ...
    msAPI_sha1_hmac_starts( &ctx, key, keylen );
    msAPI_sha1_hmac_update( &ctx, input, ilen );
    msAPI_sha1_hmac_finish( &ctx, output );
