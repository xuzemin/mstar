...
// Public functions.
//****************************************************************************
INTERFACE DLL_PUBLIC void DRV_VIF_Version(void);
INTERFACE DLL_PUBLIC void DRV_VIF_SetClock(BOOL bEnable);
INTERFACE DLL_PUBLIC void DRV_VIF_Init(VIFInitialIn * pVIF_InitData, DWORD u32InitDataLen);
INTERFACE DLL_PUBLIC void DRV_VIF_Exit(void);
INTERFACE DLL_PUBLIC void DRV_VIF_Reset(void);
INTERFACE DLL_PUBLIC void DRV_VIF_Handler(BOOL bAutoScan);
INTERFACE DLL_PUBLIC void DRV_VIF_SetSoundSystem(VIFSoundSystem ucSoundSystem);
INTERFACE DLL_PUBLIC void DRV_VIF_SetIfFreq(IfFrequencyType u16IfFreq);
INTERFACE DLL_PUBLIC U8 DRV_VIF_Read_CR_FOE(void);
INTERFACE DLL_PUBLIC U8 DRV_VIF_Read_CR_LOCK_STATUS(void);
INTERFACE DLL_PUBLIC void DRV_VIF_BypassDBBAudioFilter(BOOL bEnable);
INTERFACE DLL_PUBLIC void DRV_VIF_SetFreqBand(FrequencyBand u8FreqBand);
INTERFACE DLL_PUBLIC BOOL DRV_VIF_GetInputLevelIndicator(void);
INTERFACE DLL_PUBLIC BOOL DRV_VIF_SetParameter(VIF_PARA_GROUP paraGroup, void * pVIF_Para, DWORD u32DataLen);
INTERFACE DLL_PUBLIC void DRV_VIF_ShiftClk(BYTE VifShiftClk);
INTERFACE DLL_PUBLIC MS_U32 MDrv_VIF_SetPowerState(EN_POWER_MODE u16PowerState);
INTERFACE DLL_PUBLIC void DRV_VIF_WriteByte(U32 u32Reg, U8 u8Val );
INTERFACE DLL_PUBLIC U8 DRV_VIF_ReadByte(U32 u32Reg );
#undef INTERFACE
