...
#ifndef TCL_F17CT_6N_E_C
#define TCL_F17CT_6N_E_C
...
void devTunerSetPLLData(WORD wPLLData, RFBAND eBand)
{
    ...
    cTunerData[2] = 0x8E;  // 0xce;
    #elif ( TN_FREQ_STEP == FREQ_STEP_31_25KHz )
    cTunerData[2] = 0x8A;  //0xca;
    #else  //default 50Khz
    cTunerData[2] = 0x88;  //0xC8;
    #endif
