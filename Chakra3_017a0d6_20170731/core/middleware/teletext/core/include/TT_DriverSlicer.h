 ...
 * FILE       : TT_DriverSlicer.h
 * COPYRIGHT  : TARA Systems GmbH
 * DESCRIPTION:
 *   header file
 ***********************************************************************/

#ifndef _TT_DRIVER_SLICER_H_
#define _TT_DRIVER_SLICER_H_
...
typedef enum
{
    TT_DRIVER_SLICER_ATV = 0,
    TT_DRIVER_SLICER_DTV = 1
} TT_DRIVER_SLICER_SOURCE;

/*---------------------------------------------------------------------------*/
/* global functions                                                                                                            */
/*---------------------------------------------------------------------------*/
PUBLIC TT_BOOL TT_DriverSlicerCreate(void);
