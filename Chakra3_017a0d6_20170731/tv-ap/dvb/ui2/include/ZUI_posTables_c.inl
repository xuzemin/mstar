...
//NOTE: when you add new OSD page, you need to add here!
            ...
            #include "../res1366x768x565/OSDWndPosTbl_c.inl"
#elif (UI_SKIN_SEL==UI_SKIN_960X540X565)
#if 0 //(( MEMORY_MAP == MMAP_32MB )&&(ENABLE_ATSC))
#include "../res960x540x565_atsc/OSDWndPosTbl_c.inl"
#else
#include "../res960x540x565/OSDWndPosTbl_c.inl"
#endif
#elif (UI_SKIN_SEL==UI_SKIN_960X540XI8)
#include "../res960x540xI8/OSDWndPosTbl_c.inl"
#elif (UI_SKIN_SEL==UI_SKIN_1920X1080X565)
#include "../res1920x1080x565/OSDWndPosTbl_c.inl"
#else
    #error
#endif
