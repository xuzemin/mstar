#ifndef _LED_PQ_INNO_65INCH_16X1_C_
#define _LED_PQ_INNO_65INCH_16X1_C_
...
StuDrvLdPQInfo s_DrvLdPQInfo_INNO65_16X1 =
{
    ...
    16, 1, // U8 u8LSFWidth, u8LSFHeight; // LSF width & height
