#ifndef _LED_PQ_LGE_INX_58INCH_DIRECT_60_C_
#define _LED_PQ_LGE_INX_58INCH_DIRECT_60_C_

#include "compen/Tbl_LD_Compensation_Gamma22.c"
#include "edge2d/Tbl_LD_Edge2D_LGE_INX58inch_Direct60.c"
#include "gamma/Tbl_LD_Gamma_LGE_INX58inch_Direct60.c"

StuDrvLdPQInfo s_DrvLdPQInfo_LGE_INX58 =
{
    HAL_LD_EDGE_TB_TYPE, // EnuLD_LED_TYPE eLEDType;

    // PANEL
    32, 48, // U8 u8LDFWidth, u8LDFHeight; // Statistic width & height  24,48,
    16, 1, // U8 u8LEDWidth, u8LEDHeight; // LED width & height
    ...
    Tbl_LD_Edge2D_LGE_INX58inch_Direct60, // const U8* pu8Edge2DTable; // Edge2D table  SIZE=(u8LEDWidth*u8LEDHeight)*(u8LDFWidth*u8LDFHeight)
